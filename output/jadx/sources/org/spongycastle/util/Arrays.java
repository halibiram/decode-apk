...
public final class Arrays {
    ...
    private static int getLength(int i, int i2) {
        ...
        throw new IllegalArgumentException(AbstractC0362x4440ab85.m2929x9738a56c(i2, " > "));
    }
    ...
    public static BigInteger[] copyOf(BigInteger[] bigIntegerArr, int i) {
        ...
        System.arraycopy(bigIntegerArr, 0, bigIntegerArr2, 0, Math.min(i, bigIntegerArr.length));
