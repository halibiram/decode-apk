...
/* renamed from: 듼땠딠뒼땋딀뒨땮뒷뎰땔딄뒀듟듽뎰둥듰돶땦땔돛둡땀됫땧땔딨뒨뒵돼땯들됩땹땐뒾뎰땮딤뎰뎻돼돛땬둔땟땜둬땄뒐뒀땳돷뒷땵듨딐땯딌된둥땍땅땟듻뎹뎠둣뒝땍뎹땰딌뒤딤딝땜뒵땦돼뎠딁땵딟땬땠뎡딎딟땨땜돸뒘뒙둬둔듻뒷둥뒵드딌딜땦땀뒝듔둡땨돠딤듟도둣땰따딎땳드뒾땻땮돴딠땣뒹땃뒨됴, reason: contains not printable characters */
/* loaded from: classes.dex */
public abstract /* synthetic */ class AbstractC0878x546518ba {
    static {
        int i = ImageOutputConfig.INVALID_ROTATION;
    }

    /* renamed from: 뎠둠땪듼뎠딅땲둔듽됫딞돰둡딞듼뎨뎨듔땡딝땨땃땀뒻딤딹돝되땳땲딸뒾뎨땱땥돶뒛뒷들뒨땋돠뎡둔된돤든됫딹돳돴돛땍땸뒵둑돳땨땝득땮땠땨딀딄뒨뒀땀땋듽됫딹땵딨뒵듸땵뎬뒻돤땨두듰땫땻뒋돶두땣뎡뎡듐땫땰뒉뎹땩땱둑딄돳듸뒤뎻땮딜땻됨뎸뒼딃됫돸땮땮돨뒨땡땲딨돷되땋둘돠땪뒷뒙땅뎸, reason: contains not printable characters */
    public static int m3443xfbe0c504(ImageOutputConfig imageOutputConfig, int i) {
    ...
    public static List m3444x3271d0aa(ImageOutputConfig imageOutputConfig) {
    ...
    public static List m3445x1378447b(ImageOutputConfig imageOutputConfig, List list) {
    ...
    public static Size m3446x75d576dc(ImageOutputConfig imageOutputConfig) {
    ...
    public static Size m3447x9738a56c(ImageOutputConfig imageOutputConfig, Size size) {
    ...
    public static Size m3448x9e171bf9(ImageOutputConfig imageOutputConfig) {
    ...
    public static Size m3449x34271fae(ImageOutputConfig imageOutputConfig, Size size) {
    ...
    public static int m3450x95f25580(ImageOutputConfig imageOutputConfig, int i) {
    ...
    public static ResolutionSelector m3451x3db60231(ImageOutputConfig imageOutputConfig) {
    ...
    public static ResolutionSelector m3452x9d12c1f4(ImageOutputConfig imageOutputConfig, ResolutionSelector resolutionSelector) {
    ...
    public static List m3453x1db10c9d(ImageOutputConfig imageOutputConfig) {
    ...
    public static List m3454xd2bcb0cf(ImageOutputConfig imageOutputConfig, List list) {
    ...
    public static int m3455x8c6fc18a(ImageOutputConfig imageOutputConfig) {
    ...
    public static Size m3456x1aebc6d9(ImageOutputConfig imageOutputConfig) {
    ...
    public static Size m3457xab142723(ImageOutputConfig imageOutputConfig, Size size) {
    ...
    public static int m3458x85f0360e(ImageOutputConfig imageOutputConfig) {
    ...
    public static int m3459xad53da1a(ImageOutputConfig imageOutputConfig, int i) {
    ...
    public static boolean m3460x952a0a9e(ImageOutputConfig imageOutputConfig) {
    ...
    public static void m3461xc20437a5(ImageOutputConfig imageOutputConfig) {
        boolean z;
