...
public final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public AndroidCertificateChainCleaner(@NotNull X509TrustManager trustManager, @NotNull X509TrustManagerExtensions x509TrustManagerExtensions) {
        ...
        this.f3425xfbe0c504 = trustManager;
        this.f3426x3271d0aa = x509TrustManagerExtensions;
    }
    ...
    public List<Certificate> clean(@NotNull List<? extends Certificate> chain, @NotNull String hostname) {
        ...
        try {
            List<X509Certificate> checkServerTrusted = this.f3426x3271d0aa.checkServerTrusted((X509Certificate[]) chain.toArray(new X509Certificate[0]), "RSA", hostname);
    ...
    public boolean equals(@Nullable Object other) {
        if ((other instanceof AndroidCertificateChainCleaner) && ((AndroidCertificateChainCleaner) other).f3425xfbe0c504 == this.f3425xfbe0c504) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return System.identityHashCode(this.f3425xfbe0c504);
    }
}
