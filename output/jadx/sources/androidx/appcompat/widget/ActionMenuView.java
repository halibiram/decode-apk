    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i17 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int measureChildForCells = measureChildForCells(childAt, i15, i9, childMeasureSpec, paddingBottom);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (childAt4.getVisibility() != 8 && !layoutParams3.isOverflowButton) {
                ...
                paddingLeft = AbstractC0362x4440ab85.m2926x3271d0aa(measuredWidth4, ((LinearLayout.LayoutParams) layoutParams3).rightMargin, max, i20);
            }
        }
    }
