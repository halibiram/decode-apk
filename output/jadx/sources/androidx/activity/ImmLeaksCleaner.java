...
public final class ImmLeaksCleaner implements LifecycleEventObserver {
    ...
    @NotNull
    private static final Lazy<Cleaner> cleaner$delegate = AbstractC0919x86d1e2e2.lazy(new Function0<Cleaner>() { // from class: androidx.activity.ImmLeaksCleaner$Companion$cleaner$2
