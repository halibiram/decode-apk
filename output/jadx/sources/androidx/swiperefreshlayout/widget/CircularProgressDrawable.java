...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public static class Ring {
        ...
        public void drawTriangle(Canvas canvas, float f, float f2, RectF rectF) {
            if (this.mShowArrow) {
                ...
                this.mArrow.offset((rectF.centerX() + min) - f3, (this.mStrokeWidth / 2.0f) + rectF.centerY());
                this.mArrow.close();
    ...
    private void applyFinishTranslation(float f, Ring ring) {
        ...
        ring.setStartTrim(AbstractC0362x4440ab85.m2925xfbe0c504(ring.getStartingEndTrim() - MIN_PROGRESS_ARC, ring.getStartingStartTrim(), f, ring.getStartingStartTrim()));
        ring.setEndTrim(ring.getStartingEndTrim());
        ring.setRotation(AbstractC0362x4440ab85.m2925xfbe0c504(floor, ring.getStartingRotation(), f, ring.getStartingRotation()));
    }
