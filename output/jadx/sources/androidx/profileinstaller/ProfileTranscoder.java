...
public class ProfileTranscoder {
    ...
    private static byte[] createCompressibleBody(@NonNull DexProfileData[] dexProfileDataArr, @NonNull byte[] bArr) {
        ...
        for (DexProfileData dexProfileData : dexProfileDataArr) {
            i2 += (dexProfileData.classSetSize * 2) + Encoding.utf8Length(generateDexKey(dexProfileData.apkName, dexProfileData.dexName, bArr)) + 16 + dexProfileData.hotMethodRegionSize + getMethodBitmapStorageSize(dexProfileData.numMethodIds);
        }
    ...
    private static byte[] createMethodBitmapRegionForS(int i, @NonNull DexProfileData dexProfileData) {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        try {
    ...
    private static String generateDexKey(@NonNull String str, @NonNull String str2, @NonNull byte[] bArr) {
        ...
        if (!str2.contains("!") && !str2.contains(":")) {
            ...
            m3341xc20437a5.append(ProfileVersion.dexKeySeparator(bArr));
    ...
    private static int methodFlagBitmapIndex(int i, int i2, int i3) {
        if (i != 1) {
            if (i != 2) {
                ...
                throw Encoding.error(AbstractC0362x4440ab85.m2929x9738a56c(i, "Unexpected flag: "));
            }
            return i2;
        }
    ...
    @NonNull
    public static DexProfileData[] readMetadata001(@NonNull InputStream inputStream, @NonNull byte[] bArr, DexProfileData[] dexProfileDataArr) {
        if (Arrays.equals(bArr, ProfileVersion.METADATA_V001_N)) {
    ...
    @NonNull
    public static DexProfileData[] readMetadataV002(@NonNull InputStream inputStream, @NonNull byte[] bArr, DexProfileData[] dexProfileDataArr) {
        int readUInt16 = Encoding.readUInt16(inputStream);
        byte[] readCompressed = Encoding.readCompressed(inputStream, (int) Encoding.readUInt32(inputStream), (int) Encoding.readUInt32(inputStream));
        if (inputStream.read() <= 0) {
            ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(readCompressed);
        ...
        if (i == dexProfileDataArr.length) {
            for (int i2 = 0; i2 < i; i2++) {
                ...
                if (findByDexName != null) {
                    ...
                    throw Encoding.error(AbstractC0362x4440ab85.m2952x5ac5058d("Missing profile key: ", readString));
                }
            }
            return dexProfileDataArr;
        }
    ...
    @NonNull
    public static DexProfileData[] readProfile(@NonNull InputStream inputStream, @NonNull byte[] bArr, @NonNull String str) {
    ...
    public static boolean transcodeAndWriteBody(@NonNull OutputStream outputStream, @NonNull byte[] bArr, @NonNull DexProfileData[] dexProfileDataArr) {
    ...
    public static void writeHeader(@NonNull OutputStream outputStream, byte[] bArr) {
    ...
    private static void writeMethodBitmapForS(@NonNull OutputStream outputStream, int i, @NonNull DexProfileData dexProfileData) {
