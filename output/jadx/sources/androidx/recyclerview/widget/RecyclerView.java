...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class LayoutManager {
            ...
            if (!childViewHolderInt.wasReturnedFromScrap() && !childViewHolderInt.isScrap()) {
                if (view.getParent() == this.mRecyclerView) {
                    ...
                    if (indexOfChild != -1) {
                        ...
                        throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this.mRecyclerView, sb));
                    }
                } else {
        ...
        */
        ...
        public void ignoreView(@NonNull View view) {
            ...
            throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(this.mRecyclerView, new StringBuilder("View should be fully attached to be ignored")));
        }
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            if (childViewHolderInt != null) {
                ...
                StringBuilder m2937x8c6fc18a = AbstractC0362x4440ab85.m2937x8c6fc18a(i, findPositionOffset, "Inconsistency detected. Invalid item position ", "(offset:", ").state:");
                m2937x8c6fc18a.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, m2937x8c6fc18a));
            }
            throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
        }
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            StringBuilder m2939xab142723 = AbstractC0362x4440ab85.m2939xab142723(i, "invalid position ", ". State item count is ");
            m2939xab142723.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, m2939xab142723));
        }
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            if (!z && (findHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i)) != null) {
                ...
                throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, sb));
            }
            int size2 = this.mCachedViews.size();
                ...
                if (!viewHolder.isTmpDetached()) {
                    if (!viewHolder.shouldIgnore()) {
                        ...
                        if (RecyclerView.sDebugAssertionsEnabled && this.mCachedViews.contains(viewHolder)) {
                            ...
                            throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, sb));
                        }
                    ...
                    throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
                }
                StringBuilder sb2 = new StringBuilder("Tmp detached view should be removed from RecyclerView before it can be recycled: ");
                sb2.append(viewHolder);
                throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, sb2));
            }
            StringBuilder sb3 = new StringBuilder("Scrapped or attached views may not be recycled. isScrap:");
            sb3.append(viewHolder.isScrap());
            sb3.append(" isAttached:");
            if (viewHolder.itemView.getParent() != null) {
                z3 = true;
            }
            sb3.append(z3);
            throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, sb3));
        }
        ...
        public void scrapView(View view) {
            ...
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !RecyclerView.this.mAdapter.hasStableIds()) {
                throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        ...
        */
        public ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
                        ...
                        if (viewHolder == null) {
                            ...
                            if (findPositionOffset >= 0 && findPositionOffset < RecyclerView.this.mAdapter.getItemCount()) {
                                ...
                                if (viewHolder == null && (viewCacheExtension = this.mViewCacheExtension) != null && (viewForPositionAndType = viewCacheExtension.getViewForPositionAndType(this, i, itemViewType)) != null) {
                                    ...
                                    if (viewHolder != null) {
                                        if (viewHolder.shouldIgnore()) {
                                            throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, new StringBuilder("getViewForPositionAndType returned a view that is ignored. You must call stopIgnoring before returning this view.")));
                                        }
                                    } else {
                                        throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, new StringBuilder("getViewForPositionAndType returned a view which does not have a ViewHolder")));
                                    }
                                }
                                if (viewHolder == null) {
                                    int i2 = RecyclerView.HORIZONTAL;
            ...
            StringBuilder m2937x8c6fc18a2 = AbstractC0362x4440ab85.m2937x8c6fc18a(i, i, "Invalid item position ", "(", "). Item count:");
            m2937x8c6fc18a2.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, m2937x8c6fc18a2));
        }
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder viewHolder) {
            if (viewHolder.isRemoved()) {
                if (RecyclerView.sDebugAssertionsEnabled && !RecyclerView.this.mState.isPreLayout()) {
                    throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, new StringBuilder("should not receive a removed view unless it is pre layout")));
                }
            ...
            sb.append(viewHolder);
            throw new IndexOutOfBoundsException(AbstractC0749x8313616e.m3331x3db60231(RecyclerView.this, sb));
        }
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            ...
            StringBuilder m2943xc20437a5 = AbstractC0362x4440ab85.m2943xc20437a5(simpleName, "{");
            m2943xc20437a5.append(Integer.toHexString(hashCode()));
            m2943xc20437a5.append(" position=");
            m2943xc20437a5.append(this.mPosition);
            m2943xc20437a5.append(" id=");
            m2943xc20437a5.append(this.mItemId);
            m2943xc20437a5.append(", oldPos=");
            m2943xc20437a5.append(this.mOldPosition);
            m2943xc20437a5.append(", pLpos:");
            m2943xc20437a5.append(this.mPreLayoutPosition);
            StringBuilder sb = new StringBuilder(m2943xc20437a5.toString());
            if (isScrap()) {
                sb.append(" scrap ");
    ...
    private int consumeFlingInStretch(int i, EdgeEffect edgeEffect, EdgeEffect edgeEffect2, int i2) {
        if (i > 0 && edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != 0.0f) {
            int round = Math.round(EdgeEffectCompat.onPullDistance(edgeEffect, ((-i) * FLING_DESTRETCH_FACTOR) / i2, 0.5f) * ((-i2) / FLING_DESTRETCH_FACTOR));
            if (round != i) {
                edgeEffect.finish();
            }
            return i - round;
        ...
        if (i < 0 && edgeEffect2 != null && EdgeEffectCompat.getDistance(edgeEffect2) != 0.0f) {
            float f = i2;
            int round2 = Math.round(EdgeEffectCompat.onPullDistance(edgeEffect2, (i * FLING_DESTRETCH_FACTOR) / f, 0.5f) * (f / FLING_DESTRETCH_FACTOR));
            if (round2 != i) {
                edgeEffect2.finish();
            }
            return i - round2;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter != null && adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this, sb));
                }
                ...
                sb2.append(" \n View Holder 2:");
                sb2.append(viewHolder);
                throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this, sb2));
            }
        }
                ...
                if (i != 17) {
                    if (i != 33) {
                        if (i != 66) {
                            ...
                            sb.append(i);
                            throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(this, sb));
                        }
                        if (i3 <= 0) {
                            return false;
                        }
    ...
    */
    ...
    public void assertInLayoutOrScroll(String str) {
        if (!isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this, new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this, AbstractC0749x8313616e.m3341xc20437a5(str)));
        }
    }
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this, new StringBuilder("Cannot call this method while RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(str);
        }
        if (this.mDispatchScrollCounter > 0) {
            new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this, new StringBuilder("")));
        }
    }
    ...
    */
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this, new StringBuilder("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(this, new StringBuilder("Trying to set fast scroller without both required drawables.")));
    }
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:36:0x0066, code lost:
        ...
        if (r13.mLayout.canScrollHorizontally() != false) goto L29;
     */
        ...
        if (this.mLayout != null && !this.mLayoutSuppressed && motionEvent.getAction() == 8) {
            ...
            if ((motionEvent.getSource() & 2) != 0) {
                ...
                if (this.mLayout.canScrollHorizontally()) {
                    ...
                    axisValue = 0.0f;
                    z = false;
                    int i22 = (int) (f2 * this.mScaledVerticalScrollFactor);
                    int i32 = (int) (axisValue * this.mScaledHorizontalScrollFactor);
                    if (!z) {
                    }
                    if (i != 0) {
                        this.mDifferentialMotionFlingController.onMotionEvent(motionEvent, i);
                ...
                if ((motionEvent.getSource() & 4194304) != 0) {
                    ...
                    int i222 = (int) (f2 * this.mScaledVerticalScrollFactor);
                    int i322 = (int) (axisValue * this.mScaledHorizontalScrollFactor);
                    if (!z) {
                    }
                    if (i != 0) {
                    }
                ...
                axisValue = 0.0f;
                z = false;
                int i2222 = (int) (f2 * this.mScaledVerticalScrollFactor);
                int i3222 = (int) (axisValue * this.mScaledHorizontalScrollFactor);
                if (!z) {
                }
                if (i != 0) {
                }
    ...
    */
            ...
            if (actionMasked != 1) {
                if (actionMasked != 2) {
                    ...
                    if (this.mScrollState == 1) {
                        ...
                        GapWorker gapWorker = this.mGapWorker;
                        if (gapWorker != null && (releaseHorizontalGlow != 0 || i8 != 0)) {
                            gapWorker.postFromTraversal(this, releaseHorizontalGlow, i8);
                        }
                    }
                }
            } else {
    ...
    public void removeDetachedView(View view, boolean z) {
        ...
        if (childViewHolderInt != null) {
            ...
            StringBuilder sb2 = new StringBuilder("No ViewHolder found for child: ");
            sb2.append(view);
            throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(this, sb2));
        }
        view.clearAnimation();
    ...
    public void saveOldPositions() {
        ...
        for (int i = 0; i < unfilteredChildCount; i++) {
            ...
            if (sDebugAssertionsEnabled && childViewHolderInt.mPosition == -1 && !childViewHolderInt.isRemoved()) {
                throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this, new StringBuilder("view holder cannot have position -1 unless it is removed")));
            }
            if (!childViewHolderInt.shouldIgnore()) {
    ...
    public void setLayoutManager(@Nullable LayoutManager layoutManager) {
        ...
        if (layoutManager != null) {
            if (layoutManager.mRecyclerView == null) {
                ...
                throw new IllegalArgumentException(AbstractC0749x8313616e.m3331x3db60231(layoutManager.mRecyclerView, sb));
            }
        }
        this.mRecycler.updateViewCacheSize();
        requestLayout();
    ...
    public void stopInterceptRequestLayout(boolean z) {
        if (this.mInterceptRequestLayoutDepth < 1) {
            if (!sDebugAssertionsEnabled) {
                ...
                throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this, new StringBuilder("stopInterceptRequestLayout was called more times than startInterceptRequestLayout.")));
            }
        }
    ...
    public void onExitLayoutOrScroll(boolean z) {
        ...
        if (i < 1) {
            if (sDebugAssertionsEnabled && i < 0) {
                throw new IllegalStateException(AbstractC0749x8313616e.m3331x3db60231(this, new StringBuilder("layout or scroll counter cannot go below zero.Some calls are not matching")));
            }
            this.mLayoutOrScrollCounter = 0;
            if (z) {
