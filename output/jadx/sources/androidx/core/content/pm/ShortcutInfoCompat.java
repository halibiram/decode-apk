...
public class ShortcutInfoCompat {
                    ...
                    if (this.mCapabilityBindingParams != null) {
                        ...
                        for (String str : this.mCapabilityBindingParams.keySet()) {
                            ...
                            for (String str2 : map.keySet()) {
                                ...
                                String m2953x742e2fda = AbstractC0362x4440ab85.m2953x742e2fda(str, "/", str2);
                                if (list == null) {
                                    strArr = new String[0];
                                } else {
                                    strArr = (String[]) list.toArray(new String[0]);
                                }
                                persistableBundle.putStringArray(m2953x742e2fda, strArr);
                            }
                        }
                    }
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, AbstractC0694x8816fcc2.m3287x95f25580(it.next())).build());
        }
        return arrayList;
    }
    ...
    public static boolean getLongLivedFromExtra(PersistableBundle persistableBundle) {
        ...
        if (persistableBundle != null && persistableBundle.containsKey(EXTRA_LONG_LIVED)) {
            z = persistableBundle.getBoolean("extraLongLived");
            return z;
        }
        return false;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        ShortcutInfo build;
        AbstractC0694x8816fcc2.m3294xab142723();
        shortLabel = AbstractC0694x8816fcc2.m3283x75d576dc(this.mContext, this.mId).setShortLabel(this.mLabel);
