...
import defpackage.AbstractC1160xdd00543f;
...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl30 extends Impl {
        ...
        public static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation m3891x1db10c9d = AbstractC1160xdd00543f.m3891x1db10c9d(list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(m3891x1db10c9d);
                    fraction = m3891x1db10c9d.getFraction();
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            AbstractC1160xdd00543f.m3894x1aebc6d9();
            return AbstractC1160xdd00543f.m3889x3db60231(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
        ...
        public Impl30(int i, Interpolator interpolator, long j) {
            this(AbstractC1160xdd00543f.m3890x9d12c1f4(i, interpolator, j));
        }
    }
