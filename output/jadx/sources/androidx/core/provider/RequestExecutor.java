...
class RequestExecutor {
    ...
    public static ThreadPoolExecutor createDefaultExecutor(String str, int i, @IntRange(from = 0) int i2) {
    ...
    public static <T> T submit(ExecutorService executorService, Callable<T> callable, @IntRange(from = 0) int i) {
        try {
