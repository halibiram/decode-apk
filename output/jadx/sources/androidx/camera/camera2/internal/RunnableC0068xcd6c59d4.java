...
public final /* synthetic */ class RunnableC0068xcd6c59d4 implements Runnable {
    ...
    public final void run() {
        switch (this.f166xfbe0c504) {
            case 0:
                this.f167x3271d0aa.lambda$setZoomRatio$0(this.f168x1378447b, this.f169x75d576dc);
                return;
            default:
                this.f167x3271d0aa.lambda$setLinearZoom$2(this.f168x1378447b, this.f169x75d576dc);
                return;
        }
    }
}
