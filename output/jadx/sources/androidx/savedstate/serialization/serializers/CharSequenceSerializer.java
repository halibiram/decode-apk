...
public final class CharSequenceSerializer implements KSerializer<CharSequence> {
    ...
    public CharSequence deserialize(@NotNull Decoder decoder) {
        ...
        if (decoder instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m701getCharSequenceimpl(SavedStateReader.m684constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
        }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull CharSequence value) {
        ...
        if (encoder instanceof SavedStateEncoder) {
            ...
            SavedStateWriter.m781putCharSequenceimpl(SavedStateWriter.m771constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
            return;
        }
