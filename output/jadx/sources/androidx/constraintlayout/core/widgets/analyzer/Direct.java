                        ...
                        while (!z7) {
                            if (constraintWidget7.getVisibility() == 8) {
                                if (i == 0) {
                                    ...
                                    horizontalSolvingPass(r2, constraintWidget7, constraintWidgetContainer.getMeasurer(), isRtl);
                                } else {
                                    constraintWidget7.setFinalVertical(i11, i11);
                                    verticalSolvingPass(r2, constraintWidget7, constraintWidgetContainer.getMeasurer());
                                }
