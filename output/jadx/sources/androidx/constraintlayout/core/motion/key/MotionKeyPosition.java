...
import defpackage.AbstractC1258xb36897e2;
...
public class MotionKeyPosition extends MotionKey {
    ...
    private void calcCartesianPosition(float f, float f2, float f3, float f4) {
        ...
        this.mCalculatedPositionX = (int) ((f10 * f9) + (f5 * f8) + f);
        this.mCalculatedPositionY = (int) ((f9 * f7) + (f8 * f6) + f2);
    }
    ...
    public int getId(String str) {
        return AbstractC1258xb36897e2.m4022xfbe0c504(str);
    }
