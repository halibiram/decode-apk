...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public void draw(Canvas canvas, Matrix matrix, int i, @Nullable DropShadow dropShadow) {
        ...
        if (L.isTraceEnabled()) {
            L.beginSection(new ObfuscatedString(new long[]{8967512750526255796L, -2299364775688410068L, -4899484527717250382L, -2787106611734624832L}).toString());
        }
        this.path.reset();
        ...
        if (L.isTraceEnabled()) {
            L.endSection(new ObfuscatedString(new long[]{-6133601315317854147L, -8108686185218933312L, 3251222833420383726L, 5336836409989936290L}).toString());
        }
    }
