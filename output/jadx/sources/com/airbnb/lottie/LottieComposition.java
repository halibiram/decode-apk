...
public class LottieComposition {
    ...
    public static class Factory {
        ...
        public static LottieComposition fromInputStreamSync(InputStream inputStream, boolean z) {
            if (z) {
                Logger.warning(new ObfuscatedString(new long[]{3447790526167196111L, -5786766944584105213L, -4720434347422683307L, 8655633576509743210L, -4937459960591216087L, -6909244533058166067L}).toString());
            }
            return LottieCompositionFactory.fromJsonInputStreamSync(inputStream, null).getValue();
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder(new ObfuscatedString(new long[]{-7444897570095951609L, -2203770378755875448L, 3779475707064149777L, -4956977456442184895L}).toString());
        Iterator<Layer> it = this.layers.iterator();
        while (it.hasNext()) {
            sb.append(it.next().toString(new ObfuscatedString(new long[]{4323473024978832794L, 4839410723725220578L}).toString()));
        }
        return sb.toString();
    }
}
