...
public abstract class AxisBase extends ComponentBase {
    ...
    public void addLimitLine(LimitLine limitLine) {
        ...
        if (this.mLimitLines.size() > 6) {
            new ObfuscatedString(new long[]{-6374644943055568600L, -7023719128469223115L, 7530813393751491611L}).toString();
            new ObfuscatedString(new long[]{2526874410584510519L, 861253136165860159L, -1483316524765939138L, 6681261370079167721L, 3718295956564485356L, 6437358179034204347L, -7868013939260138447L, 2133908035475532406L, 1452825623475211797L, -720245017129717341L, -6150953641031293811L}).toString();
        }
    }
    ...
    public String getFormattedLabel(int i) {
        ...
        return new ObfuscatedString(new long[]{6285693689883569736L}).toString();
    }
    ...
    public String getLongestLabel() {
        String obfuscatedString = new ObfuscatedString(new long[]{8395898396436700328L}).toString();
        for (int i = 0; i < this.mEntries.length; i++) {
            String formattedLabel = getFormattedLabel(i);
            if (formattedLabel != null && obfuscatedString.length() < formattedLabel.length()) {
                obfuscatedString = formattedLabel;
            }
        }
