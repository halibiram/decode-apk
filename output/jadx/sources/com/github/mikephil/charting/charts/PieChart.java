...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public PieChart(Context context) {
        ...
        this.mCenterText = new ObfuscatedString(new long[]{-4185606243117806440L}).toString();
    ...
    public float[] getMarkerPosition(Highlight highlight) {
        ...
        double d = f2;
        float cos = (float) ((Math.cos(Math.toRadians(this.mAnimator.getPhaseY() * ((this.mAbsoluteAngles[r11] + rotationAngle) - f3))) * d) + centerCircleBox.x);
        float sin = (float) ((Math.sin(Math.toRadians(this.mAnimator.getPhaseY() * ((rotationAngle + this.mAbsoluteAngles[r11]) - f3))) * d) + centerCircleBox.y);
    ...
    public XAxis getXAxis() {
        throw new RuntimeException(new ObfuscatedString(new long[]{-1608017411588000529L, -2764706810042915850L, 4245814572214537055L, -1928364780802033962L}).toString());
    }
    ...
    public void setCenterText(CharSequence charSequence) {
        if (charSequence == null) {
            this.mCenterText = new ObfuscatedString(new long[]{652955473635934769L}).toString();
        } else {
    ...
    public PieChart(Context context, AttributeSet attributeSet) {
        ...
        this.mUsePercentValues = false;
        this.mDrawRoundedSlices = false;
        this.mCenterText = new ObfuscatedString(new long[]{-6872247074194790783L}).toString();
        this.mCenterTextOffset = MPPointF.getInstance(0.0f, 0.0f);
        this.mHoleRadiusPercent = 50.0f;
        this.mTransparentCircleRadiusPercent = 55.0f;
        this.mDrawCenterText = true;
    ...
    public PieChart(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUsePercentValues = false;
        this.mDrawRoundedSlices = false;
        this.mCenterText = new ObfuscatedString(new long[]{8871532777421440610L}).toString();
        this.mCenterTextOffset = MPPointF.getInstance(0.0f, 0.0f);
        this.mHoleRadiusPercent = 50.0f;
        this.mTransparentCircleRadiusPercent = 55.0f;
        this.mDrawCenterText = true;
