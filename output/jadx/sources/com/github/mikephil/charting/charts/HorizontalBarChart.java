...
public class HorizontalBarChart extends BarChart {
    ...
    public void calculateOffsets() {
        ...
        if (this.mLogEnabled) {
            new ObfuscatedString(new long[]{75950284272324384L, 5108469987606594869L, -1619555078188360509L}).toString();
            new ObfuscatedString(new long[]{4442501238868806866L, 154140330248967064L, 7891329547927751157L}).toString();
            new ObfuscatedString(new long[]{991716883899685797L, 6795795480490181456L, -2745322242390524813L}).toString();
            new ObfuscatedString(new long[]{-5807482783961465262L, 1432466526257812267L, 7535531032447373675L}).toString();
            new ObfuscatedString(new long[]{3837102718800429976L, -8045225541367724872L, 1199559307306666744L}).toString();
            new ObfuscatedString(new long[]{882451112408976787L, -3912952741044255106L, -4221806022767703584L}).toString();
            new ObfuscatedString(new long[]{2957350927312827356L, -7258240091849098430L, 9109484006358323878L}).toString();
    ...
    public Highlight getHighlightByTouchPoint(float f, float f2) {
        if (this.mData == 0) {
            if (this.mLogEnabled) {
                new ObfuscatedString(new long[]{-6631905980581239054L, -7331618402415989655L, 7185825098459502810L}).toString();
                new ObfuscatedString(new long[]{6262855289161577121L, -5324661318852710109L, 7857669961229486235L, -3282514176060146489L, -8353712409755615391L, 1612445593517757242L}).toString();
                return null;
            }
            return null;
        }
