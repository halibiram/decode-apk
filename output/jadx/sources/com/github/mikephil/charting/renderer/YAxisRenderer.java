...
public class YAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            float yOffset = this.mYAxis.getYOffset() + (Utils.calcTextHeight(this.mAxisLabelPaint, new ObfuscatedString(new long[]{7037067435683828085L, -382992765108142621L}).toString()) / 2.5f);
        ...
        if (limitLines != null && limitLines.size() > 0) {
            ...
            for (int i = 0; i < limitLines.size(); i++) {
                ...
                if (limitLine.isEnabled()) {
                    ...
                    if (label != null && !label.equals(new ObfuscatedString(new long[]{-4181391267190896297L}).toString())) {
