...
public final class StaticTree {
    ...
    static {
        ...
        static_dtree = sArr2;
        static_l_desc = new StaticTree(sArr, Tree.extra_lbits, 257, L_CODES, 15);
        static_d_desc = new StaticTree(sArr2, Tree.extra_dbits, 0, 30, 15);
    }

    private StaticTree(short[] sArr, int[] iArr, int i, int i2, int i3) {
