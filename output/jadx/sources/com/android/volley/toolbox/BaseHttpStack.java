...
public abstract class BaseHttpStack implements HttpStack {
    ...
    public final org.apache.http.HttpResponse performRequest(Request<?> request, Map<String, String> map) {
        ...
        BasicHttpResponse basicHttpResponse = new BasicHttpResponse(new BasicStatusLine(new ProtocolVersion(new ObfuscatedString(new long[]{-823824484048964599L, -1155514180787540178L}).toString(), 1, 1), executeRequest.getStatusCode(), new ObfuscatedString(new long[]{1965492876820304073L}).toString()));
