...
public class ImageLoader {
    ...
    private static String getCacheKey(String str, int i, int i2, ImageView.ScaleType scaleType) {
        ...
        sb.append(new ObfuscatedString(new long[]{-7550245707419371365L, 32540398748304292L}).toString());
        sb.append(i);
        sb.append(new ObfuscatedString(new long[]{-790884166221578312L, -9027947316033180119L}).toString());
        sb.append(i2);
        sb.append(new ObfuscatedString(new long[]{-923316615421621103L, -4829465281477117353L}).toString());
