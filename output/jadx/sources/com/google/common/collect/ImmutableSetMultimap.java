...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    public static final class SetFieldSettersHolder {
        static final Serialization.FieldSetter<ImmutableSetMultimap> EMPTY_SET_FIELD_SETTER = Serialization.getFieldSetter(ImmutableSetMultimap.class, new ObfuscatedString(new long[]{-1560696028758273864L, 5950324920178378246L}).toString());
    ...
    private void readObject(ObjectInputStream objectInputStream) {
            ...
            for (int i2 = 0; i2 < readInt; i2++) {
                ...
                if (readInt2 > 0) {
                    ...
                    if (build.size() == readInt2) {
                        ...
                        throw new InvalidObjectException(AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{6549148992785176229L, 8655571442240179047L, 8114929815431512562L, 6864415252727095535L, -4076871205941536399L, -5495847229156674039L}), new StringBuilder(valueOf.length() + 40), valueOf));
                    }
                } else {
                    throw new InvalidObjectException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-5205404065523084847L, -2556376302876298856L, 1216410356915025924L, -4931485127609843304L}), new StringBuilder(31), readInt2));
                }
            }
            try {
        ...
        throw new InvalidObjectException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-6124345792989354218L, -5683681060465650977L, -6974700838483158441L, -1529559711427789812L}), new StringBuilder(29), readInt));
    }
