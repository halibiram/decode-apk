...
public abstract class ImmutableList<E> extends ImmutableCollection<E> implements List<E>, RandomAccess {
    ...
    public static <E> Builder<E> builderWithExpectedSize(int i) {
        CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{-7820799346102970698L, -2994132067615766225L, 908911725070574814L}).toString());
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        throw new InvalidObjectException(new ObfuscatedString(new long[]{7675728832764160729L, -6528932954122960716L, -1137851238038709588L, 48368836100438279L}).toString());
    }
    ...
    public static <E> ImmutableList<E> of(E e, E e2, E e3, E e4, E e5, E e6, E e7, E e8, E e9, E e10, E e11, E e12, E... eArr) {
        Preconditions.checkArgument(eArr.length <= 2147483635, new ObfuscatedString(new long[]{-5249048866048097019L, 155766173605839179L, -7512900026480415644L, -7512323039318527580L, -5893177099146151329L, 1546004696044506033L, -9017517372487795205L}).toString());
