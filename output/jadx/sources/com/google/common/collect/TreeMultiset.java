...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        Serialization.getFieldSetter(AbstractSortedMultiset.class, new ObfuscatedString(new long[]{-1067285050992179714L, 2199770698227350617L, -6510748947373575897L}).toString()).set((Serialization.FieldSetter) this, (Object) comparator);
        Serialization.getFieldSetter(TreeMultiset.class, new ObfuscatedString(new long[]{1250203105496404611L, -8809535980064308087L}).toString()).set((Serialization.FieldSetter) this, (Object) GeneralRange.all(comparator));
        Serialization.getFieldSetter(TreeMultiset.class, new ObfuscatedString(new long[]{-6988874367496774210L, -6751413714905028843L, -5858002741431642481L}).toString()).set((Serialization.FieldSetter) this, (Object) new Reference());
        AvlNode avlNode = new AvlNode();
        Serialization.getFieldSetter(TreeMultiset.class, new ObfuscatedString(new long[]{-3458337983280895506L, 5688800027716618671L}).toString()).set((Serialization.FieldSetter) this, (Object) avlNode);
    ...
    public int add(@ParametricNullness E e, int i) {
        CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{-1215087303716691944L, 285792172853359643L, 4581145496437723411L}).toString());
        if (i == 0) {
            return count(e);
        }
    ...
    public Iterator<Multiset.Entry<E>> descendingEntryIterator() {
        return new Iterator<Multiset.Entry<E>>() { // from class: com.google.common.collect.TreeMultiset.3
            ...
            public void remove() {
                ...
                Preconditions.checkState(z, new ObfuscatedString(new long[]{6815409359455950407L, -3651125763586274575L, 6730380007476477365L, -2966642197205021932L, -94735173930547625L, -8084008109614212056L, 8710665018892749075L, -1286696293981358678L}).toString());
    ...
    public Iterator<Multiset.Entry<E>> entryIterator() {
        return new Iterator<Multiset.Entry<E>>() { // from class: com.google.common.collect.TreeMultiset.2
            ...
            public void remove() {
                ...
                Preconditions.checkState(z, new ObfuscatedString(new long[]{6345211334265673380L, -7962271421849895046L, -2912675201651568137L, -8421683460979195110L, 5750778838713855759L, 4792097275216174746L, 4468267841647484967L, 2335359521625032930L}).toString());
                TreeMultiset.this.setCount(this.prevEntry.getElement(), 0);
                this.prevEntry = null;
            }
    ...
    public int remove(@CheckForNull Object obj, int i) {
        CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{3504188408014578456L, 5880569856901671502L, -139284255472216253L}).toString());
        if (i == 0) {
            return count(obj);
        }
        AvlNode<E> avlNode = this.rootReference.get();
    ...
    public int setCount(@ParametricNullness E e, int i) {
        CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{6102480889745687169L, 5954979683773440555L}).toString());
    ...
    public boolean setCount(@ParametricNullness E e, int i, int i2) {
        CollectPreconditions.checkNonnegative(i2, new ObfuscatedString(new long[]{-148095017723379450L, -5278475963864896971L}).toString());
        CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{9016015549204742580L, 7517275348281444611L}).toString());
        Preconditions.checkArgument(this.range.contains(e));
        AvlNode<E> avlNode = this.rootReference.get();
        if (avlNode != null) {
            int[] iArr = new int[1];
