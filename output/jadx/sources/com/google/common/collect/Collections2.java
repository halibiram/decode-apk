...
public final class Collections2 {
    ...
    public static final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public String toString() {
            ...
            sb.append(new ObfuscatedString(new long[]{-158713623121663355L, -5110512596691987582L, 3756608708474148704L, -6926489217205289418L, 2132039526439095266L}).toString());
            sb.append(valueOf);
            return AbstractC0749x8313616e.m3332x9d12c1f4(new ObfuscatedString(new long[]{-5512451353147174347L, -4771871915856806890L}), sb);
        }
    }
    ...
    public static final class OrderedPermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        public int findNextL(int i) {
            ...
            throw new AssertionError(new ObfuscatedString(new long[]{-3775037374191826103L, 8458094574520246555L, -9099340339680317283L, -3317099994273344422L, 9207932469713766987L, -7082993576308042674L}).toString());
        }
    ...
    public static final class PermutationCollection<E> extends AbstractCollection<List<E>> {
        ...
        public String toString() {
            ...
            sb.append(new ObfuscatedString(new long[]{-2654953665782680596L, 4415363809546506231L, 7586767429315052542L}).toString());
            sb.append(valueOf);
            return AbstractC0749x8313616e.m3332x9d12c1f4(new ObfuscatedString(new long[]{8988518747530186220L, 7698198246665705030L}), sb);
        }
    }
    ...
    public static StringBuilder newStringBuilderForCollection(int i) {
        CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{3554498647406546789L, 4401596291652630546L}).toString());
    ...
    public static String toStringImpl(Collection<?> collection) {
        ...
        for (Object obj : collection) {
            if (!z) {
                newStringBuilderForCollection.append(new ObfuscatedString(new long[]{7480417673519412231L, 6812411948082973404L}).toString());
            }
            if (obj == collection) {
                newStringBuilderForCollection.append(new ObfuscatedString(new long[]{1077211025426647364L, 4724473332062168551L, -5866107659974130344L, -926247341582020180L}).toString());
            } else {
