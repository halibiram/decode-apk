...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
    ...
    public class QueueIterator implements Iterator<E> {
        ...
        public E next() {
            ...
            throw new NoSuchElementException(new ObfuscatedString(new long[]{4161476320370373906L, -2151065929366995142L, -66226714003262770L, -6627084729542223503L, -7378829322261679911L, -7744067110994602627L, 1466624336748816275L}).toString());
        }
    ...
    public static boolean isEvenLevel(int i) {
        ...
        Preconditions.checkState(z, new ObfuscatedString(new long[]{-7088756784806436380L, -6236553732521546242L, -3749929003098454063L}).toString());
