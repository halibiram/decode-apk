...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        throw new InvalidObjectException(new ObfuscatedString(new long[]{2648540699482177272L, 56429982180494988L, -3910114344564339700L, 4456113714239641677L, 1967441631162876963L}).toString());
    }
    ...
    public Node<K, V> find(K k, boolean z) {
        ...
        if (node3 == null) {
            if (comparator == NATURAL_ORDER && !(k instanceof Comparable)) {
                ...
                throw new ClassCastException(AbstractC0749x8313616e.m3332x9d12c1f4(new ObfuscatedString(new long[]{8970365835420638758L, -8542666658484151834L, -4054913652780882818L, -4423194597663516039L}), sb));
            }
    ...
    public V put(K k, V v) {
        if (k != null) {
            if (v == null && !this.allowNullValues) {
                throw new NullPointerException(new ObfuscatedString(new long[]{-1284888999196457271L, -1468949755138995117L, 8495173000233239890L}).toString());
            }
        ...
        throw new NullPointerException(new ObfuscatedString(new long[]{8519467977959353841L, 1896726433709662461L, -2225691472872837041L}).toString());
    }
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public V setValue(V v) {
            if (v == null && !this.allowNullValue) {
                throw new NullPointerException(new ObfuscatedString(new long[]{-7248025957812337402L, -6985106713405287220L, 8546469833423686193L}).toString());
            }
            V v2 = this.value;
            this.value = v;
            return v2;
        ...
        public String toString() {
            return this.key + new ObfuscatedString(new long[]{-1700298185400149026L, 2757443166554460132L}).toString() + this.value;
        }
