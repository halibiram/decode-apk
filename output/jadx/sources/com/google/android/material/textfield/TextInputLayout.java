...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private static final String LOG_TAG = new ObfuscatedString(new long[]{7480124624560506698L, -1941244215232153589L, -4557185100900760652L}).toString();
    ...
    public static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull View view, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            ...
            if (!isEmpty2) {
                obfuscatedString = hint.toString();
            } else {
                obfuscatedString = new ObfuscatedString(new long[]{8990372509799096294L}).toString();
            }
            this.layout.startLayout.setupAccessibilityNodeInfo(accessibilityNodeInfoCompat);
            if (!isEmpty) {
                accessibilityNodeInfoCompat.setText(charSequence);
            } else if (!TextUtils.isEmpty(obfuscatedString)) {
                accessibilityNodeInfoCompat.setText(obfuscatedString);
                if (!isHintExpanded && placeholderText != null) {
                    ...
                    m3341xc20437a5.append(new ObfuscatedString(new long[]{1137827517957373391L, -5876819623864144923L}).toString());
                    m3341xc20437a5.append((Object) placeholderText);
                    accessibilityNodeInfoCompat.setText(m3341xc20437a5.toString());
                }
            ...
            if (!TextUtils.isEmpty(obfuscatedString)) {
                if (Build.VERSION.SDK_INT >= 26) {
                    accessibilityNodeInfoCompat.setHintText(obfuscatedString);
                } else {
                    if (!isEmpty) {
                        StringBuilder sb = new StringBuilder();
                        sb.append((Object) charSequence);
                        obfuscatedString = AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{-7766023798323965604L, 4222537721120400297L}), sb, obfuscatedString);
                    }
                    accessibilityNodeInfoCompat.setText(obfuscatedString);
                }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append(new ObfuscatedString(new long[]{-3233280107984914209L, 8692736398874030197L, -5227876716516118622L, -4006921385186978351L, -6427445027842619447L}).toString());
            sb.append(Integer.toHexString(System.identityHashCode(this)));
            sb.append(new ObfuscatedString(new long[]{5031323033105882852L, 1756175991388669078L}).toString());
            sb.append((Object) this.error);
            return AbstractC0749x8313616e.m3332x9d12c1f4(new ObfuscatedString(new long[]{6133406158112010246L, 6929184472527615983L}), sb);
        }
    ...
    private void assignBoxBackgroundByMode() {
        ...
        if (i != 0) {
            if (i != 1) {
                ...
                throw new IllegalArgumentException(AbstractC0749x8313616e.m3332x9d12c1f4(new ObfuscatedString(new long[]{-7164328052038910105L, 5027830498861267858L, -5516307656733943228L, 3173962756831621453L, 8409994247457488184L, -3281404500901503699L, -2302362508128968798L, -5458236192389130198L, -3428931477731160459L}), sb));
            }
            this.boxBackground = new MaterialShapeDrawable(this.shapeAppearanceModel);
    ...
    private static Drawable getOutlinedBoxBackgroundWithRipple(Context context, MaterialShapeDrawable materialShapeDrawable, int i, int[][] iArr) {
        int color = MaterialColors.getColor(context, R.attr.colorSurface, new ObfuscatedString(new long[]{5434163310639510967L, 6153218891540399932L, 7465403715626223708L}).toString());
    ...
    private void setEditText(EditText editText) {
        if (this.editText == null) {
            if (getEndIconMode() != 3 && !(editText instanceof TextInputEditText)) {
                new ObfuscatedString(new long[]{-7099998746425816980L, -6752211384194893379L, -7609534018956356412L}).toString();
                new ObfuscatedString(new long[]{9001285141470398178L, 3555845548120639340L, -842475623993232180L, -769343349764334353L, 5923429980168026899L, -7657420767742369971L, -5813090977717019323L, -8592239647997243034L, -8462867311483157813L, -3174185780417107388L, 172425220037665302L, -6967243812018359665L}).toString();
            }
            ...
            this.editText.addTextChangedListener(new TextWatcher(editText) { // from class: com.google.android.material.textfield.TextInputLayout.1
                ...
                public void afterTextChanged(@NonNull Editable editable) {
                    ...
                    if (lineCount != i4) {
                        if (lineCount < i4) {
                            int minimumHeight = ViewCompat.getMinimumHeight(this.val$editText);
                            int i22 = TextInputLayout.this.originalEditTextMinimumHeight;
                            if (minimumHeight != i22) {
                                this.val$editText.setMinimumHeight(i22);
                            }
                        }
                        this.previousLineCount = lineCount;
                    }
        ...
        throw new IllegalArgumentException(new ObfuscatedString(new long[]{-9044896964230982931L, 1286339344334154571L, 4630850369421741707L, 5712627771025418887L, 9125675377522613580L, 8091929684654929820L, 8580016535343931830L}).toString());
    }
    ...
    public static /* synthetic */ int m1255x3271d0aa(Editable editable) {
        return lambda$new$0(editable);
    }
    ...
    public void onGlobalLayout() {
        ...
        if (updateEditTextHeightBasedOnIcon || updateDummyDrawables) {
            this.editText.post(new RunnableC1044x8c43c726(this, 10));
        }
    }
    ...
    */
    public TextInputLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.lengthCounter = new C0370x5ac5058d(24);
        ...
        TintTypedArray obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, iArr, i, i2, i3, i4, i5, i6, i7);
        ...
        if (obtainTintedStyledAttributes.hasValue(i8)) {
            setMinEms(obtainTintedStyledAttributes.getInt(i8, -1));
        } else {
        ...
        if (obtainTintedStyledAttributes.hasValue(i10)) {
            setMaxEms(obtainTintedStyledAttributes.getInt(i10, -1));
        } else {
            int i11 = R.styleable.TextInputLayout_android_maxWidth;
            if (obtainTintedStyledAttributes.hasValue(i11)) {
                setMaxWidth(obtainTintedStyledAttributes.getDimensionPixelSize(i11, -1));
            }
        }
        ...
        if (obtainTintedStyledAttributes.getResourceId(i7, -1) != -1) {
            setHintTextAppearance(obtainTintedStyledAttributes.getResourceId(i7, 0));
        }
        ...
        int resourceId = obtainTintedStyledAttributes.getResourceId(i5, 0);
        CharSequence text = obtainTintedStyledAttributes.getText(R.styleable.TextInputLayout_errorContentDescription);
        int i15 = obtainTintedStyledAttributes.getInt(R.styleable.TextInputLayout_errorAccessibilityLiveRegion, 1);
        boolean z = obtainTintedStyledAttributes.getBoolean(R.styleable.TextInputLayout_errorEnabled, false);
        int resourceId2 = obtainTintedStyledAttributes.getResourceId(i6, 0);
        ...
        this.counterTextAppearance = obtainTintedStyledAttributes.getResourceId(i3, 0);
        this.counterOverflowTextAppearance = obtainTintedStyledAttributes.getResourceId(i4, 0);
