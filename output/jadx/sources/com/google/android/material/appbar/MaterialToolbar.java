...
public class MaterialToolbar extends Toolbar {
    ...
    */
    public MaterialToolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int i4 = obtainStyledAttributes.getInt(R.styleable.MaterialToolbar_logoScaleType, -1);
        if (i4 >= 0) {
        ...
        if (obtainStyledAttributes.hasValue(i5)) {
            this.logoAdjustViewBounds = Boolean.valueOf(obtainStyledAttributes.getBoolean(i5, false));
        }
