    ...
    public static FitModeEvaluator get(int i, boolean z, RectF rectF, RectF rectF2) {
        if (i != 0) {
            if (i != 1) {
                ...
                throw new IllegalArgumentException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-902946006665928364L, -7766805101286572521L, 1242176390548796586L, 318073951118694913L}), new StringBuilder(), i));
            }
            return WIDTH;
        }
