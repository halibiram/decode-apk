...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (badgeDrawable != null && badgeDrawable.isVisible()) {
            ...
            accessibilityNodeInfo.setContentDescription(((Object) title) + new ObfuscatedString(new long[]{4976045293459892739L, -4432777164508633127L}).toString() + ((Object) this.badgeDrawable.getContentDescription()));
        }
    ...
    public void setBadge(@NonNull BadgeDrawable badgeDrawable) {
        ...
        if (hasBadge() && this.icon != null) {
            new ObfuscatedString(new long[]{-2782230634462793701L, 4156571455936826273L, 8990604380929151545L}).toString();
            new ObfuscatedString(new long[]{994499723868205161L, -1745305450875642589L, 6549801429123880073L, 6805923261797474146L, 658737324327639977L, -6637508594756885321L, -2617342736074726655L, -4396164669657056348L}).toString();
            tryRemoveBadgeFromAnchor(this.icon);
        }
