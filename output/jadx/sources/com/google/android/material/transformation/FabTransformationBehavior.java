...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float f, float f2, boolean z, @NonNull FabTransformationSpec fabTransformationSpec) {
        ...
        if (f != 0.0f && f2 != 0.0f) {
            if ((z && f2 < 0.0f) || (!z && f2 > 0.0f)) {
                timing = fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{-1629668128017922464L, -6828042279134028393L, 4731013140469401362L, 2141343213145346753L}).toString());
                timing2 = fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{-1641463132006088588L, 5679145230957945556L, -4461336101067577169L, -4812042440592385193L}).toString());
            } else {
                timing = fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{-5333838867329173732L, -3490788326843126746L, -7892127722360343970L, -2170848879432223192L, -4279346753895409916L}).toString());
                timing2 = fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{5139589128613577842L, -1235833214652869743L, -6624449654161112079L, 65448261385384947L, -487470945159623877L}).toString());
            }
        } else {
            timing = fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{4398282164484570664L, 5141774350481321603L, -8040126263581507408L, -7288508013971256865L}).toString());
            timing2 = fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{1976353228376179441L, -2240538275566558368L, -9005464492822098203L, 8119222852577077710L}).toString());
        }
    ...
    private float calculateValueOfAnimationAtEndOfExpansion(@NonNull FabTransformationSpec fabTransformationSpec, @NonNull MotionTiming motionTiming, float f, float f2) {
        ...
        MotionTiming timing = fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{-2715118748867975284L, 2966841990399276490L, -6098905122071532779L}).toString());
    ...
    private void createChildrenFadeAnimation(View view, View view2, boolean z, boolean z2, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{5935819863541765885L, 4654431921518922327L, -3459051495628244873L}).toString()).apply(ofFloat);
        list.add(ofFloat);
    }
    ...
    private void createColorAnimation(@NonNull View view, View view2, boolean z, boolean z2, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{4584364095449304857L, -7459635316534004815L}).toString()).apply(ofInt);
        list.add(ofInt);
    }
    ...
    private void createElevationAnimation(View view, @NonNull View view2, boolean z, boolean z2, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{2256120019866610348L, 6153366661439795060L, -4365889951587936214L}).toString()).apply(ofFloat);
        list.add(ofFloat);
    }
    ...
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z, boolean z2, @NonNull FabTransformationSpec fabTransformationSpec, float f, float f2, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ...
        MotionTiming timing = fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{-8051654513957026767L, -5019313076350112745L, -6503918318308780768L}).toString());
        if (z) {
            if (!z2) {
    ...
    private void createIconFadeAnimation(View view, final View view2, boolean z, boolean z2, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ...
        if ((view2 instanceof CircularRevealWidget) && (view instanceof ImageView)) {
            ...
            fabTransformationSpec.timings.getTiming(new ObfuscatedString(new long[]{1132631703461686925L, -1640273507041945894L}).toString()).apply(ofInt);
            list.add(ofInt);
    ...
    public boolean layoutDependsOn(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, @NonNull View view2) {
        ...
        throw new IllegalStateException(new ObfuscatedString(new long[]{-887257476512008491L, 954127291127548955L, 3205457293922821874L, -6710355570152071002L, -2197086380607817204L, 1065117078751655399L, -370195477830096541L, 4494747506046204924L, 9207936757924936052L, -8613633658952654487L, -5831812681042150424L, 1796524051002289743L}).toString());
    }
