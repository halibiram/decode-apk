            ...
            if (i != 0) {
                if (i != 1) {
                    if (i == 2) {
                        ...
                        throw new IllegalStateException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{1773398792867541266L, 742837044427771914L, 1725189104668877763L, -8730554464736820734L}), new StringBuilder(), i));
                    }
                } else {
