...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private void drawCompatShadow(@NonNull Canvas canvas) {
        if (this.containsIncompatibleShadowOp.cardinality() > 0) {
            new ObfuscatedString(new long[]{-5510155183364552640L, 2346203271596700421L, 4367609509432527843L, 7746149421121134777L, -268315341668837858L, -1879057491628180378L, 5670146713362763835L, -2425872256380726683L, -7125630557215303372L, -4909137899895883227L, -2169102893974115119L, 6313492166502749109L}).toString();
        }
    ...
    private void maybeDrawCompatShadow(@NonNull Canvas canvas) {
        ...
        throw new IllegalStateException(new ObfuscatedString(new long[]{1763466765296741695L, 5186386667804027887L, 7261166477496299650L, 4685745190152876425L, 3015388072204584899L, -5166281050076392445L, -7726082186133954523L, 4097472672032362619L, -4435978415228279762L, 8661859209935955871L}).toString());
    }
