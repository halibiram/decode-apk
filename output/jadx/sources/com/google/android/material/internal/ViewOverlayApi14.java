...
public class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        static {
            try {
                String obfuscatedString = new ObfuscatedString(new long[]{2087077490962169132L, 2789929945292271884L, -331585257741513341L, 1720610939911445928L, 7193487593052640177L}).toString();
                Class cls = Integer.TYPE;
                invalidateChildInParentFastMethod = ViewGroup.class.getDeclaredMethod(obfuscatedString, cls, cls, Rect.class);
        ...
        private void assertNotDisposed() {
            if (!this.disposed) {
                ...
                throw new IllegalStateException(new ObfuscatedString(new long[]{5443748800841325489L, 6642328799401581979L, 8468266178873055923L, -966952491707386284L, -761457337135399442L, 6032143682041784433L, 6518022732196574552L, -8303186696750710359L, 8030866146342944594L, -7857195421414564821L, -7753269541090719933L, -8854938594398875154L}).toString());
            }
        }
