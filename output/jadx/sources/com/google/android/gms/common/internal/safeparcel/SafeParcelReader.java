...
public class SafeParcelReader {
    ...
    public static class ParseException extends RuntimeException {
        ...
        */
        public ParseException(@NonNull String str, @NonNull Parcel parcel) {
            super(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{3238944027869715837L, -307209046787430685L}), r4, r5));
            int dataPosition = parcel.dataPosition();
            int dataSize = parcel.dataSize();
            StringBuilder m3341xc20437a5 = AbstractC0749x8313616e.m3341xc20437a5(str);
            m3341xc20437a5.append(new ObfuscatedString(new long[]{6583356463622854664L, 5501715094788016717L, 5060726079793764696L}).toString());
            m3341xc20437a5.append(dataPosition);
        }
    }
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        ...
        throw new ParseException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{7821127918771401964L, 690212454520572590L, -4350084467249466L, 3946539739088742063L, -7348964677821522982L}), new StringBuilder(), i), parcel);
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (fieldId == 20293) {
            ...
            sb.append(new ObfuscatedString(new long[]{3181869401336740376L, 7486409468697873865L, -277893145530010930L, 7639959593880717820L, -654041131505712634L}).toString());
            sb.append(dataPosition);
            throw new ParseException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-7795067382933432874L, -8427121629675689808L}), sb, i), parcel);
        }
        throw new ParseException(new ObfuscatedString(new long[]{9041212146143243936L, -9090883718709029926L, -807430997641298139L, 3836346027107469973L, -980231652830290305L}).toString().concat(String.valueOf(Integer.toHexString(readHeader))), parcel);
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(new ObfuscatedString(new long[]{3262967343945958149L, 6428765258902170273L, 5417543697811301366L}).toString());
        sb.append(i3);
        sb.append(new ObfuscatedString(new long[]{1303485980345099508L, -6862115579099743129L}).toString());
        sb.append(i2);
        sb.append(new ObfuscatedString(new long[]{-6168964121057280784L, -7199260475028059043L}).toString());
        sb.append(hexString);
        throw new ParseException(AbstractC0749x8313616e.m3332x9d12c1f4(new ObfuscatedString(new long[]{3507622811669738851L, 7843629468771405642L}), sb), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append(new ObfuscatedString(new long[]{4695402661889007770L, 1914736601078154890L, 4599757607657422532L}).toString());
        sb.append(i2);
        sb.append(new ObfuscatedString(new long[]{-5788466510072211667L, -8204675538944659006L}).toString());
        sb.append(readSize);
        sb.append(new ObfuscatedString(new long[]{-5115966887414813652L, -3295025105742000456L}).toString());
        sb.append(hexString);
        throw new ParseException(AbstractC0749x8313616e.m3332x9d12c1f4(new ObfuscatedString(new long[]{1850774852664555268L, 8616825975606392043L}), sb), parcel);
    }
}
