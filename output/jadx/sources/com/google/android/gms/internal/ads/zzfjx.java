...
public final class zzfjx {
    ...
    public final /* synthetic */ ListenableFuture zzb(zzfjp zzfjpVar, zzfiv zzfivVar, zzfjq zzfjqVar, zzfje zzfjeVar) {
        synchronized (this) {
            try {
                this.zzd = true;
    ...
    public final /* synthetic */ ListenableFuture zzc(zzfjp zzfjpVar, Exception exc) {
        synchronized (this) {
            this.zzd = true;
            throw exc;
        }
