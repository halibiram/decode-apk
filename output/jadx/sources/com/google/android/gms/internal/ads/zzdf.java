...
public class zzdf {
    ...
    public final zzdf zze(Context context) {
        ...
        if ((zzfy.zza >= 23 || Looper.myLooper() != null) && (captioningManager = (CaptioningManager) context.getSystemService(new ObfuscatedString(new long[]{588992999605126588L, 5311126808618966950L, 1253748935098061974L}).toString())) != null && captioningManager.isEnabled()) {
            this.zzo = 1088;
