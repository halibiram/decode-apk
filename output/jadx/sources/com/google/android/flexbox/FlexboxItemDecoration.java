...
public class FlexboxItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private boolean isFirstItemInLine(int i, List<FlexLine> list, FlexboxLayoutManager flexboxLayoutManager) {
        ...
        if (list.size() != 0 && ((FlexLine) AbstractC0362x4440ab85.m2928x75d576dc(1, list)).mLastIndex == i - 1) {
            return true;
        }
        return false;
    }
    ...
    public void setDrawable(Drawable drawable) {
        ...
        throw new IllegalArgumentException(new ObfuscatedString(new long[]{1519521868258261220L, -323064527328168738L, -8295644798971280737L, -5889128470213305194L}).toString());
    }
