...
public final class State {
    ...
    public State appendFLGn(int i) {
        ...
        if (i < 0) {
            ...
            throw new IllegalArgumentException(new ObfuscatedString(new long[]{-6210732841548674047L, 6287512843058464301L, 5746281217858278200L, 8776841678675555839L, -4753796452258531924L, -8492059591875591072L}).toString());
        }
    ...
    public String toString() {
        return String.format(new ObfuscatedString(new long[]{1302361775594666461L, -8610335706779196363L, 376393421800281519L, 5082021723873532598L}).toString(), HighLevelEncoder.MODE_NAMES[this.mode], Integer.valueOf(this.bitCount), Integer.valueOf(this.binaryShiftByteCount));
    }
}
