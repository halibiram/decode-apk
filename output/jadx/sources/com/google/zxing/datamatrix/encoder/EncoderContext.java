...
final class EncoderContext {
    ...
    public EncoderContext(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (c == '?' && str.charAt(i) != '?') {
                throw new IllegalArgumentException(new ObfuscatedString(new long[]{-3872035025114698522L, -6339009379114184516L, 2873074140173746394L, 4270876489918596780L, -4710509524984672352L, 3702447858322494761L, 3378938794200148731L, 3026188789504515499L}).toString());
            }
            sb.append(c);
        }
