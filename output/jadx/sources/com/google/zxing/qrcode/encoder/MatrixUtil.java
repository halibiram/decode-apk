...
public final class MatrixUtil {
    ...
    public static int calculateBCHCode(int i, int i2) {
        ...
        throw new IllegalArgumentException(new ObfuscatedString(new long[]{-4651075204548980662L, -1487351840105693745L, -6967234669609296827L}).toString());
    }
    ...
    public static void embedDataBits(BitArray bitArray, int i, ByteMatrix byteMatrix) {
        ...
        throw new WriterException(new ObfuscatedString(new long[]{19963599765532808L, 2839334977177195028L, -7366549562625696511L, 7634213859940169202L}).toString() + i2 + '/' + bitArray.getSize());
    }
    ...
    public static void makeTypeInfoBits(ErrorCorrectionLevel errorCorrectionLevel, int i, BitArray bitArray) {
        if (QRCode.isValidMaskPattern(i)) {
            ...
            throw new WriterException(new ObfuscatedString(new long[]{5543502439832696608L, 7194479172875239354L, -3630557678728219276L, 4260438774287808788L, -8295849678769787546L}).toString() + bitArray.getSize());
        }
        throw new WriterException(new ObfuscatedString(new long[]{8256977022942208233L, 2948535844995419107L, -855768429266814495L, -2547773606647884441L}).toString());
    }
    ...
    public static void makeVersionInfoBits(Version version, BitArray bitArray) {
        ...
        throw new WriterException(new ObfuscatedString(new long[]{-5439057907161857609L, -7576977276208580222L, -5420018650097671224L, -7348715769244648626L, 8478370734971344900L}).toString() + bitArray.getSize());
    }
