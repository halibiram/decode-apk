    ...
    private DecodedChar decodeAlphanumeric(int i) {
        ...
        switch (extractNumericValueFromBitArray2) {
            ...
            case 62:
                ...
                break;
            default:
                throw new IllegalStateException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{7072213246607668140L, -7048502924394845698L, -4364230160368324903L, -9115622838072792763L, 758432106482742672L, -6829920262138344315L}), new StringBuilder(), extractNumericValueFromBitArray2));
        }
