...
public final class InflaterSource implements Source {
    ...
    public long read(@NotNull Buffer sink, long byteCount) {
        ...
        do {
            ...
            Inflater inflater = this.f3622x3271d0aa;
            if (inflater.finished() || inflater.needsDictionary()) {
                return -1L;
            }
        } while (!this.f3621xfbe0c504.exhausted());
        ...
        if (byteCount >= 0) {
            if (!this.f3624x75d576dc) {
                ...
                try {
                    ...
                    int i = this.f3623x1378447b;
                    if (i != 0) {
                        int remaining = i - inflater.getRemaining();
                        this.f3623x1378447b -= remaining;
                        this.f3621xfbe0c504.skip(remaining);
                    }
                    if (inflate > 0) {
    ...
    public final boolean refill() {
        ...
        BufferedSource bufferedSource = this.f3621xfbe0c504;
    ...
    public Timeout getF3568xfbe0c504() {
        return this.f3621xfbe0c504.getF3568xfbe0c504();
    }
