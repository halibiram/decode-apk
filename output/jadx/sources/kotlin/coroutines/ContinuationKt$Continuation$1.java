...
public final class ContinuationKt$Continuation$1 implements Continuation<Object> {
    ...
    public final /* synthetic */ CoroutineContext f1350xfbe0c504;

    /* renamed from: 뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫, reason: contains not printable characters */
    public final /* synthetic */ Function1 f1351x3271d0aa;

    public ContinuationKt$Continuation$1(CoroutineContext coroutineContext, Function1<? super Result<Object>, Unit> function1) {
        this.f1350xfbe0c504 = coroutineContext;
        this.f1351x3271d0aa = function1;
    }

    @Override // kotlin.coroutines.Continuation
    /* renamed from: getContext, reason: from getter */
    public CoroutineContext getF1350xfbe0c504() {
        return this.f1350xfbe0c504;
    }

    @Override // kotlin.coroutines.Continuation
    public void resumeWith(Object result) {
        this.f1351x3271d0aa.invoke(Result.m1763boximpl(result));
    }
}
