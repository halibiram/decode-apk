...
public final class Handshake {
    ...
    public Handshake(@NotNull TlsVersion tlsVersion, @NotNull CipherSuite cipherSuite, @NotNull List<? extends Certificate> localCertificates, @NotNull Function0<? extends List<? extends Certificate>> peerCertificatesFn) {
        ...
        this.peerCertificates = AbstractC0919x86d1e2e2.lazy(new C0635x2b917e10(peerCertificatesFn, 1));
    }
    ...
    public final List<Certificate> m2475deprecated_localCertificates() {
    ...
    public final Principal m2476deprecated_localPrincipal() {
    ...
    public final List<Certificate> m2477deprecated_peerCertificates() {
    ...
    public final Principal m2478deprecated_peerPrincipal() {
    ...
    public String toString() {
        ...
        ArrayList arrayList2 = new ArrayList(AbstractC0587xb7546d05.collectionSizeOrDefault(list, 10));
    ...
    public static final class Companion {
        ...
        public final Handshake m2480deprecated_get(@NotNull SSLSession sslSession) {
                ...
                if (!(Intrinsics.areEqual(cipherSuite, "TLS_NULL_WITH_NULL_NULL") ? true : Intrinsics.areEqual(cipherSuite, "SSL_NULL_WITH_NULL_NULL"))) {
                    ...
                    if (protocol != null) {
                        if (!Intrinsics.areEqual("NONE", protocol)) {
                            ...
                            return new Handshake(forJavaName2, forJavaName, emptyList2, new C0337x34271fae(emptyList));
                        }
        ...
        public final Handshake get(@NotNull TlsVersion tlsVersion, @NotNull CipherSuite cipherSuite, @NotNull List<? extends Certificate> peerCertificates, @NotNull List<? extends Certificate> localCertificates) {
            ...
            Intrinsics.checkNotNullParameter(localCertificates, "localCertificates");
            return new Handshake(tlsVersion, cipherSuite, _UtilJvmKt.toImmutableList(localCertificates), new C0336x9e171bf9(_UtilJvmKt.toImmutableList(peerCertificates)));
        }
    }
}
