...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    private static final String STATE_HIERARCHY = new ObfuscatedString(new long[]{6483638024045309394L, -5236511644177906180L, -5966613454383104767L, 4781851439266698889L}).toString();
    private static final String STATE_ADAPTER = new ObfuscatedString(new long[]{6536281270635128309L, 3209201396756390676L, -8545109424191965119L, 2262307024889394733L}).toString();
    private static final String STATE_HEADER = new ObfuscatedString(new long[]{1223216457523665037L, 2400145330739920538L, 8598051941989022135L, 2261369004458974864L}).toString();
    ...
    public class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private static final String STATE_CHECKED_ITEM = new ObfuscatedString(new long[]{1592262248988734613L, -1145206036329986270L, -3479551216924192723L, -5714734004623982207L}).toString();
        private static final String STATE_ACTION_VIEWS = new ObfuscatedString(new long[]{1760171392255001213L, -810256255972291637L, -2942240257635202506L, -3561343611040661413L, 2400491325709834567L}).toString();
        ...
        public Bundle createInstanceState() {
            ...
            if (this.checkedItem != null) {
                bundle.putInt(new ObfuscatedString(new long[]{-5866911500568007855L, 6126423549580035076L, -2299082064391084347L, 553095185519018971L}).toString(), this.checkedItem.getItemId());
            }
            ...
            bundle.putSparseParcelableArray(new ObfuscatedString(new long[]{-4252683230760172695L, -7358765218110700147L, 8355272152560588095L, -8473919210425683890L, -3865460141848419721L}).toString(), sparseArray);
            return bundle;
        }
        ...
        public int getItemViewType(int i) {
            ...
            throw new RuntimeException(new ObfuscatedString(new long[]{8828240089333165273L, -1221274625533762900L, 4172287200934052995L, -1257855226055891400L}).toString());
        }
        ...
        public void restoreInstanceState(@NonNull Bundle bundle) {
            ...
            int i = bundle.getInt(new ObfuscatedString(new long[]{-2564420450838193559L, -5507093320450725099L, -3511625687876256151L, 1390597916419638720L}).toString(), 0);
            if (i != 0) {
                this.updateSuspended = true;
                int size = this.items.size();
                int i2 = 0;
            ...
            SparseArray sparseParcelableArray = bundle.getSparseParcelableArray(new ObfuscatedString(new long[]{4860412397229688695L, -6607190225732999032L, -8378784299933738225L, 3521719693007498036L, -6043348705394359800L}).toString());
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        if (parcelable instanceof Bundle) {
            ...
            SparseArray<Parcelable> sparseParcelableArray = bundle.getSparseParcelableArray(new ObfuscatedString(new long[]{-7142147159096320314L, 7554722099068081120L, 1119457425952795350L, 5773272376035878951L}).toString());
            if (sparseParcelableArray != null) {
                this.menuView.restoreHierarchyState(sparseParcelableArray);
            }
            Bundle bundle2 = bundle.getBundle(new ObfuscatedString(new long[]{-1823037023932648751L, 8702758009644366517L, 6611654845867356739L, 2685040331334389677L}).toString());
            if (bundle2 != null) {
                this.adapter.restoreInstanceState(bundle2);
            }
            SparseArray<Parcelable> sparseParcelableArray2 = bundle.getSparseParcelableArray(new ObfuscatedString(new long[]{3161789386871520921L, 8913549431202402435L, 3646463524621665473L, 8687945675093087748L}).toString());
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (this.menuView != null) {
            ...
            bundle.putSparseParcelableArray(new ObfuscatedString(new long[]{240409429716074591L, 6267151355246671883L, 958633140484701504L, -105151636569990615L}).toString(), sparseArray);
        }
        if (this.adapter != null) {
            bundle.putBundle(new ObfuscatedString(new long[]{6026597770963418972L, -8428253902746793246L, 5622967022964922538L, -196415013634104288L}).toString(), this.adapter.createInstanceState());
        }
        if (this.headerLayout != null) {
            SparseArray<Parcelable> sparseArray2 = new SparseArray<>();
            this.headerLayout.saveHierarchyState(sparseArray2);
            bundle.putSparseParcelableArray(new ObfuscatedString(new long[]{-7193594475291092865L, 504335479903515374L, 4102984906550541969L, -7584243321167455125L}).toString(), sparseArray2);
        }
        return bundle;
    }
