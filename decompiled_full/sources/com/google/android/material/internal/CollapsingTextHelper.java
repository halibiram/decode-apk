...
public final class CollapsingTextHelper {
    ...
    private static final String TAG = new ObfuscatedString(new long[]{-1350805991905573641L, 2109131938877275490L, -4188891710057745609L, 1522333192273283309L}).toString();
    private static final String ELLIPSIS_NORMAL = new ObfuscatedString(new long[]{-7533695654633888157L, -3315931118777522574L}).toString();
    ...
    private float calculateFadeModeThresholdFraction() {
        ...
        return AbstractC0362x4440ab85.m2925xfbe0c504(1.0f, f, 0.5f, f);
    }
    ...
    private StaticLayout createStaticLayout(int i, float f, boolean z) {
        ...
        try {
            ...
            new ObfuscatedString(new long[]{9105654555622175566L, 916560372503442336L, 1192843004414150530L, -4268806510549824521L}).toString();
    ...
    private void drawMultilineTransition(@NonNull Canvas canvas, float f, float f2) {
        ...
        if (!this.fadeModeEnabled) {
            ...
            if (trim.endsWith(new ObfuscatedString(new long[]{-2766468117041417790L, -5488562588209290269L}).toString())) {
