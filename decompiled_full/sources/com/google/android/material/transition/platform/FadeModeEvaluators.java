        ...
        if (i != 0) {
            if (i != 1) {
                if (i != 2) {
                    ...
                    throw new IllegalArgumentException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{594338577184028441L, 5152671392401721720L, -7449437985133820385L, 127331036492460912L}), new StringBuilder(), i));
                }
                return CROSS;
            }
            if (z) {
