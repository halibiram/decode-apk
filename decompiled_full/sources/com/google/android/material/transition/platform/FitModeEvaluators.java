    ...
    public static FitModeEvaluator get(int i, boolean z, RectF rectF, RectF rectF2) {
        if (i != 0) {
            if (i != 1) {
                ...
                throw new IllegalArgumentException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{5116766286865186546L, 5223573884471842386L, -8515721512268172089L, -281280598443771286L}), new StringBuilder(), i));
            }
            return WIDTH;
        }
