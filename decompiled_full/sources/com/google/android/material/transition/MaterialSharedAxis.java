    ...
    private static VisibilityAnimatorProvider createPrimaryAnimatorProvider(int i, boolean z) {
        ...
        if (i != 0) {
            if (i != 1) {
                ...
                throw new IllegalArgumentException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-80318358772548215L, 1208889497696573738L, 5578873946419312814L}), new StringBuilder(), i));
            }
            if (z) {
                i3 = 80;
            } else {
