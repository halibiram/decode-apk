...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final String PROP_BOUNDS = new ObfuscatedString(new long[]{7183084059038437654L, 6722580184381730921L, -5633420474725392445L, 6976831032911848405L, -8004558721355617598L, -7364365264244379535L}).toString();
    private static final String PROP_SHAPE_APPEARANCE = new ObfuscatedString(new long[]{-2062439554746735837L, -2598034544466280657L, 7777976561052282907L, -6259667714340202840L, 6967915448564186293L, -2471132569523957600L, 8468226769068626752L}).toString();
    private static final String TAG = "MaterialContainerTransform";
    private static final String[] TRANSITION_PROPS = {new ObfuscatedString(new long[]{-5393744845968773718L, -4927340249044091922L, -5322633393115806776L, -4174705292399720002L, 5803486219373635962L, -5867330543035701595L}).toString(), new ObfuscatedString(new long[]{6376094693717339918L, 6736651929915765491L, 554009341328907860L, -1964974829694010288L, 3947733512491285075L, 7684545062249508729L, 1807538825205511585L}).toString()};
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        public void setAlpha(int i) {
            throw new UnsupportedOperationException(new ObfuscatedString(new long[]{-9183641390550013961L, 3552492082336620449L, -3084594433610124753L, -848095723718611730L, 8369550920306036546L, 4910480982251632163L}).toString());
        }

        @Override // android.graphics.drawable.Drawable
        public void setColorFilter(@Nullable ColorFilter colorFilter) {
            throw new UnsupportedOperationException(new ObfuscatedString(new long[]{2852646744100408801L, 935830928178912483L, 2048072111742707966L, 5850364742345700318L, 8025342517725075016L, -3811044854520543451L}).toString());
        }
        ...
        private TransitionDrawable(PathMotion pathMotion, View view, RectF rectF, ShapeAppearanceModel shapeAppearanceModel, float f, View view2, RectF rectF2, ShapeAppearanceModel shapeAppearanceModel2, float f2, @ColorInt int i, @ColorInt int i2, @ColorInt int i3, int i4, boolean z, boolean z2, FadeModeEvaluator fadeModeEvaluator, FitModeEvaluator fitModeEvaluator, ProgressThresholdsGroup progressThresholdsGroup, boolean z3) {
            ...
            WindowManager windowManager = (WindowManager) view.getContext().getSystemService(new ObfuscatedString(new long[]{-914334234458889630L, 3101787649023649246L}).toString());
    ...
    private static void captureValues(@NonNull TransitionValues transitionValues, @Nullable View view, @IdRes int i, @Nullable ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (ViewCompat.isLaidOut(view4) || view4.getWidth() != 0 || view4.getHeight() != 0) {
            ...
            transitionValues.values.put(new ObfuscatedString(new long[]{2683740739241156497L, -5371026220100214560L, -3744866355876901352L, 4136360259445295274L, 6433317613581000477L, -3476239853669562926L}).toString(), locationOnScreen);
            transitionValues.values.put(new ObfuscatedString(new long[]{-8926453891517202162L, -4729238127067463876L, -6024691567978121824L, 7181422893151300599L, -1884439315062527978L, -6094461863385906343L, 6521069319051292706L}).toString(), captureShapeAppearance(view4, locationOnScreen, shapeAppearanceModel));
        }
    }
    ...
    private boolean isEntering(@NonNull RectF rectF, @NonNull RectF rectF2) {
        ...
        if (i != 0) {
            ...
            throw new IllegalArgumentException(new ObfuscatedString(new long[]{6506529410563850934L, 534803110304270929L, -6019421994280773165L, -6674923566956450541L, -6344532502671835307L}).toString() + this.transitionDirection);
        }
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            RectF rectF = (RectF) transitionValues.values.get(new ObfuscatedString(new long[]{-84040120932967122L, 7163007904908629559L, -1320892616616991795L, 3721258784285397307L, 5503560542144940749L, -8171873336239214269L}).toString());
            ShapeAppearanceModel shapeAppearanceModel = (ShapeAppearanceModel) transitionValues.values.get(new ObfuscatedString(new long[]{8483676718457176319L, -2283720148735011946L, 6494783050998796291L, 7524345931562341999L, 725138464979694382L, 6338779745871996144L, 6145915499340704703L}).toString());
            if (rectF != null && shapeAppearanceModel != null) {
                RectF rectF2 = (RectF) transitionValues2.values.get(new ObfuscatedString(new long[]{2740634516285738536L, -824353194757331838L, -6832868598680140224L, -1538235791414786323L, 505420587532031360L, 6797001303808337171L}).toString());
                ShapeAppearanceModel shapeAppearanceModel2 = (ShapeAppearanceModel) transitionValues2.values.get(new ObfuscatedString(new long[]{-8077716775233824242L, 3665617524424894969L, 2765243864670390880L, 6448355452407236313L, -2001413607488116527L, -7695111124579601247L, -7875453218293248342L}).toString());
                ...
                new ObfuscatedString(new long[]{3324340614165529072L, -3096251081205435346L, 1363811622781557179L, -7115743085648225380L, 8338845418054046212L, 5075691633438408175L, 328493957091527322L, 6305269568074856299L, 5404468597100199615L, -6547113166700661539L, 6264863041634474964L}).toString();
                return null;
            }
            new ObfuscatedString(new long[]{5179464483447486123L, -2245748447666810034L, -4903267887481251798L, 4873688219580564442L, 167315195470714095L, 4844978476651999392L, 2541149980485357159L, 5938218204598024766L, 1586406724466698002L, -6118304235165518601L, 8964855090677546102L}).toString();
        }
        return null;
    }
