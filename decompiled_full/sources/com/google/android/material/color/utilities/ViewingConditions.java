...
public final class ViewingConditions {
    ...
    public static ViewingConditions make(double[] dArr, double d, double d2, double d3, boolean z) {
        ...
        double d17 = 1.0d - d16;
        double cbrt = (Math.cbrt(d14) * 0.1d * d17 * d17) + (d16 * d);
        ...
        return new ViewingConditions(yFromLstar, ((dArr8[2] * 0.05d) + (dArr8[0] * 2.0d) + dArr8[1]) * pow, pow, pow, d13, d12, dArr6, cbrt, Math.pow(cbrt, 0.25d), sqrt);
    }
