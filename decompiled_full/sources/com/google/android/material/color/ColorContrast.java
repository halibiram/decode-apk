...
public class ColorContrast {
    ...
    public static class ColorContrastActivityLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
        ...
        public void onActivityDestroyed(@NonNull Activity activity) {
            ...
            UiModeManager uiModeManager = (UiModeManager) activity.getSystemService(new ObfuscatedString(new long[]{198902681625457635L, 8440318121813699987L}).toString());
        ...
        public void onActivityPreCreated(@NonNull Activity activity, @Nullable Bundle bundle) {
            UiModeManager uiModeManager = (UiModeManager) activity.getSystemService(new ObfuscatedString(new long[]{-3681053250177826568L, 8562045250752149034L}).toString());
    ...
    private static int getContrastThemeOverlayResourceId(Context context, ColorContrastOptions colorContrastOptions) {
        float contrast;
        UiModeManager uiModeManager = (UiModeManager) context.getSystemService(new ObfuscatedString(new long[]{7088194728186024536L, -8331449741136033498L}).toString());
