...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    private static final String LOG_TAG = new ObfuscatedString(new long[]{239312181825354268L, -78692447718580803L, 4045218591030707430L, -5413790854706984745L}).toString();
    private static final String EXPANDABLE_WIDGET_HELPER_KEY = new ObfuscatedString(new long[]{7771312349646483214L, 5381107659247139222L, -4964719194563007419L, 6449464167849562887L}).toString();
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.expandableWidgetHelper.onRestoreInstanceState((Bundle) Preconditions.checkNotNull(extendableSavedState.extendableStates.get(new ObfuscatedString(new long[]{6165067362460399931L, 6412165182495377855L, -3269973669105724010L, -6029224279892477244L}).toString())));
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        extendableSavedState.extendableStates.put(new ObfuscatedString(new long[]{-4316807283309482820L, 7598343184228836803L, -1919593183276621583L, 2645515934286732042L}).toString(), this.expandableWidgetHelper.onSaveInstanceState());
    ...
    public void setBackgroundColor(int i) {
        new ObfuscatedString(new long[]{7396264485693932216L, -4192324528063220994L, 2125216695915214576L, -6763156593412440482L}).toString();
        new ObfuscatedString(new long[]{-2008755825030034461L, -7296775742431044417L, 9174569366457618068L, 7042442662804635986L, -2707542043433837183L, 7130090193378363819L, -3569537791945131241L}).toString();
    }

    @Override // android.view.View
    public void setBackgroundDrawable(Drawable drawable) {
        new ObfuscatedString(new long[]{-8837231563201961830L, 6963685236881210669L, -5625197639960206512L, 5199587267997877309L}).toString();
        new ObfuscatedString(new long[]{-7749003707734575761L, 2147613128899563678L, 8616152788225420390L, 57513073068797376L, 3527414674153134449L, 8019738418556224826L, -3801111693244633927L}).toString();
    }

    @Override // android.view.View
    public void setBackgroundResource(int i) {
        new ObfuscatedString(new long[]{8844863526812770445L, -2241750763287806942L, -4521869703571285864L, -3573395536699729955L}).toString();
        new ObfuscatedString(new long[]{-3264799111764594694L, -6668342391386640262L, -7041029782234383877L, 3935422798013881822L, 4559699620758622959L, 4222115239987322064L, 4655929735195675235L}).toString();
    }
    ...
    public void setCustomSize(@Px int i) {
        ...
        throw new IllegalArgumentException(new ObfuscatedString(new long[]{1166522383381420508L, -3169071978292093346L, 4164348896429118353L, -7968545765565976044L, -2366737552304955242L}).toString());
    }
