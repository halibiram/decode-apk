...
public class EndCompoundLayout extends LinearLayout {
                ...
                if (i != 0) {
                    if (i != 1) {
                        if (i != 2) {
                            ...
                            throw new IllegalArgumentException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-5083985612308403720L, 1839285561574038018L, 7034578090999108846L, 4061055033536566422L}), new StringBuilder(), i));
                        }
    ...
    public EndCompoundLayout(TextInputLayout textInputLayout, TintTypedArray tintTypedArray) {
        ...
        this.accessibilityManager = (AccessibilityManager) getContext().getSystemService(new ObfuscatedString(new long[]{585052887995304375L, 4798886254103974267L, 289418055951765154L}).toString());
    ...
    public int getSuffixTextEndOffset() {
        ...
        return ViewCompat.getPaddingEnd(this.suffixTextView) + ViewCompat.getPaddingEnd(this) + measuredWidth;
    }
    ...
    public void setEndIconMinSize(@Px int i) {
        ...
        throw new IllegalArgumentException(new ObfuscatedString(new long[]{-1964144129566339279L, 4701029410381564348L, -2775892053370287194L, -5877614639883134537L, -2472722472691441316L, 4644887358428439389L}).toString());
    }
    ...
    public void setEndIconMode(int i) {
        ...
        sb.append(new ObfuscatedString(new long[]{6531714639635645525L, 444994456973075831L, 4315604316585888328L, -1208045588860680869L, 4110498306931570577L}).toString());
        sb.append(this.textInputLayout.getBoxBackgroundMode());
        throw new IllegalStateException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-4493364407939430822L, -6891046151856038989L, 5319174163792325256L, -325703120923394776L, -2202654889255285381L, -3749469406657787573L}), sb, i));
    }
