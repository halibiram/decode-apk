...
public final class zaao extends zaav {
    ...
    public final void zaa() {
        ...
        if (arrayList.isEmpty()) {
            ...
            while (i2 < size) {
                Api.Client client2 = (Api.Client) arrayList2.get(i2);
                context3 = this.zaa.zac;
                i = zalVar.zab(context3, client2);
                i2++;
                if (i == 0) {
                    break;
                }
            ...
            while (i2 < size2) {
                Api.Client client3 = (Api.Client) arrayList.get(i2);
                context = this.zaa.zac;
                i = zalVar.zab(context, client3);
                i2++;
                if (i != 0) {
                    break;
                }
