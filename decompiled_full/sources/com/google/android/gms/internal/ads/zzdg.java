...
public class zzdg {
    ...
    public int hashCode() {
        ...
        return this.zzE.hashCode() + ((this.zzD.hashCode() + ((((this.zzw.hashCode() + ((((this.zzu.hashCode() + ((((((this.zzq.hashCode() + ((this.zzo.hashCode() + (((((i * 31) + this.zzl) * 31) + this.zzm) * 31)) * 961)) * 961) + Integer.MAX_VALUE) * 31) + Integer.MAX_VALUE) * 31)) * 31) + 29791) * 31)) * 31) + this.zzx) * 887503681)) * 31);
    }
}
