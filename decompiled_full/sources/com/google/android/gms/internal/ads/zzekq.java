...
public final class zzekq implements zzein {
    ...
    public final /* synthetic */ ListenableFuture zzc(final zzfgm zzfgmVar, zzfgy zzfgyVar, zzdto zzdtoVar, Object obj) {
        zzbni zzbniVar;
        ...
        boolean z = this.zzh;
        final zzdjo zze = this.zzc.zze(zzcwxVar, new zzdjr(new zzekp(this.zza, this.zzf, zzceuVar, zzfgmVar, zza, zzfhhVar, z, this.zzg, this.zzi), zza));
        zzceuVar.zzc(zze);
