...
public final class Escapers {
    ...
    public static UnicodeEscaper asUnicodeEscaper(Escaper escaper) {
        ...
        String obfuscatedString = new ObfuscatedString(new long[]{-9045449567533155319L, 58025162658219572L, -4327252916364273896L, -7842112490548199299L, 1927487036219332864L, 883596047465700808L}).toString();
        String name = escaper.getClass().getName();
        if (name.length() != 0) {
            str = obfuscatedString.concat(name);
        } else {
