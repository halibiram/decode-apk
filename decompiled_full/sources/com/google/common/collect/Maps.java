...
public final class Maps {
    ...
    public static final class BiMapConverter<A, B> extends Converter<A, B> implements Serializable {
        ...
        private static <X, Y> Y convert(BiMap<X, Y> biMap, X x) {
            ...
            Preconditions.checkArgument(z, new ObfuscatedString(new long[]{5134504893971861061L, -1392860465428904266L, 5538909906379734501L, -5131565621576806148L, -3345354987068520614L, 6858285553735052960L, -6934560905642284762L}).toString(), x);
            return y;
        }
        ...
        public String toString() {
            ...
            sb.append(new ObfuscatedString(new long[]{-6612359062029933537L, -3896519420945911996L, 3675064903433952376L, -6906188880520873842L}).toString());
            sb.append(valueOf);
            return AbstractC0749x8313616e.m3332x9d12c1f4(new ObfuscatedString(new long[]{-834962397090223120L, 6739748271435124974L}), sb);
        }
    }
    ...
    public static class MapDifferenceImpl<K, V> implements MapDifference<K, V> {
        ...
        public String toString() {
            if (areEqual()) {
                return new ObfuscatedString(new long[]{7876692001745611778L, -7413211398959067793L}).toString();
            }
            StringBuilder sb = new StringBuilder(new ObfuscatedString(new long[]{8076939118467569395L, -8294489197683575679L, -7729506790707210270L}).toString());
            if (!this.onlyOnLeft.isEmpty()) {
                sb.append(new ObfuscatedString(new long[]{6254161443317361513L, -106909671614169910L, 8361071383542419212L}).toString());
                sb.append(this.onlyOnLeft);
            }
            if (!this.onlyOnRight.isEmpty()) {
                sb.append(new ObfuscatedString(new long[]{7887144095440066239L, 6757917377324595490L, 9183273625451427966L}).toString());
                sb.append(this.onlyOnRight);
            }
            if (!this.differences.isEmpty()) {
                sb.append(new ObfuscatedString(new long[]{3361023545457042287L, 64038758904806628L, -1152643175005072016L, 6042402766815931100L}).toString());
    ...
    public static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V> {
        ...
        public String toString() {
            ...
            sb.append(new ObfuscatedString(new long[]{-5363114595605662628L, -1995677175922765396L}).toString());
            sb.append(valueOf);
            sb.append(new ObfuscatedString(new long[]{9065400782190655787L, -4812286974581767438L}).toString());
            sb.append(valueOf2);
            return AbstractC0749x8313616e.m3332x9d12c1f4(new ObfuscatedString(new long[]{2090206819505198490L, -3207544859897138133L}), sb);
        }
    }
    ...
    public static int capacity(int i) {
        if (i < 3) {
            CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{172286844858708375L, -7948695660923319202L, -1763894978929092895L}).toString());
            return i + 1;
        }
        if (i < 1073741824) {
    ...
    private static <K, V> void doDifference(Map<? extends K, ? extends V> map, Map<? extends K, ? extends V> map2, Equivalence<? super V> equivalence, Map<K, V> map3, Map<K, V> map4, Map<K, V> map5, Map<K, MapDifference.ValueDifference<V>> map6) {
        for (Map.Entry<? extends K, ? extends V> entry : map.entrySet()) {
            ...
            if (map2.containsKey(key)) {
                R.array arrayVar = (Object) NullnessCasts.uncheckedCastNullableTToT(map4.remove(key));
                if (equivalence.equivalent(value, arrayVar)) {
                    map5.put(key, value);
                } else {
                    map6.put(key, ValueDifferenceImpl.create(value, arrayVar));
                }
            } else {
                map3.put(key, value);
            }
    ...
    public static ImmutableMap<String, String> fromProperties(Properties properties) {
        ...
        while (propertyNames.hasMoreElements()) {
            ...
            j$.util.Objects.requireNonNull(nextElement);
    ...
    public static <K extends Comparable<? super K>, V> NavigableMap<K, V> subMap(NavigableMap<K, V> navigableMap, Range<K> range) {
        ...
        if (navigableMap.comparator() != null && navigableMap.comparator() != Ordering.natural() && range.hasLowerBound() && range.hasUpperBound()) {
            ...
            Preconditions.checkArgument(z2, new ObfuscatedString(new long[]{216035238308918945L, 3979211721723443604L, 6425621910760735700L, 5161732393481741516L, 3370787526527792431L, 8720576137919963343L, 2774681504495141433L, -2941045550163817818L, 6086074099121142832L, 2343115320629366809L, -4916082812570288654L, -3122426677889993864L}).toString());
        }
    ...
    public static String toStringImpl(Map<?, ?> map) {
        ...
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            if (!z) {
                newStringBuilderForCollection.append(new ObfuscatedString(new long[]{5473186655841610837L, 484408496075905728L}).toString());
            }
    ...
    public static <K, V> ImmutableMap<K, V> uniqueIndex(Iterator<V> it, Function<? super V, K> function) {
        ...
        try {
            ...
            throw new IllegalArgumentException(String.valueOf(e.getMessage()).concat(new ObfuscatedString(new long[]{8725410517961502744L, -2666362192833015845L, -7007850822206380L, 1299996474586618790L, -6144858986014713617L, -3949130915421010548L, -3224226023969222894L, -1071585747396771676L, -7226570574423757923L}).toString()));
        }
    }
