...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
    ...
    public static class FieldSettersHolder {
        static final Serialization.FieldSetter<ImmutableMultimap> MAP_FIELD_SETTER = Serialization.getFieldSetter(ImmutableMultimap.class, new ObfuscatedString(new long[]{1098218491179634338L, -2070446435136933307L}).toString());
        static final Serialization.FieldSetter<ImmutableMultimap> SIZE_FIELD_SETTER = Serialization.getFieldSetter(ImmutableMultimap.class, new ObfuscatedString(new long[]{-7239665631648402569L, 5137592813213350537L}).toString());
    }
    ...
    public Map<K, Collection<V>> createAsMap() {
        throw new AssertionError(new ObfuscatedString(new long[]{7543415481735161555L, -6825930660639938249L, 662826472507301713L, -3725285083129172747L}).toString());
    }

    @Override // com.google.common.collect.AbstractMultimap
    public Set<K> createKeySet() {
        throw new AssertionError(new ObfuscatedString(new long[]{-2379980806672732262L, -1513793866998092149L, -6040290727842508896L}).toString());
    }
    ...
    public static class Builder<K, V> {
        ...
        public Builder<K, V> putAll(K k, Iterable<? extends V> iterable) {
            if (k == null) {
                String obfuscatedString = new ObfuscatedString(new long[]{-579079368553131142L, 8841634950783425965L, 8767912299933342154L, 6948731904703349980L}).toString();
                String valueOf = String.valueOf(Iterables.toString(iterable));
                throw new NullPointerException(valueOf.length() != 0 ? obfuscatedString.concat(valueOf) : new String(obfuscatedString));
            }
            Collection<V> collection = this.builderMap.get(k);
            if (collection != null) {
                for (V v : iterable) {
