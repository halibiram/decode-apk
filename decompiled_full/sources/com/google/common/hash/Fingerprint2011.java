...
final class Fingerprint2011 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        return shiftMix((shiftMix(((load648 + load646 + rotateRight4) * K0) + ((Long.rotateRight(load648, 31) + rotateRight5 + rotateRight7 + j) * K2)) * K0) + rotateRight4) * K2;
    }
    ...
    private static void weakHashLength32WithSeeds(byte[] bArr, int i, long j, long j2, long[] jArr) {
        ...
        long rotateRight = Long.rotateRight(j4, 23) + Long.rotateRight(j2 + j3 + load644, 51);
        jArr[0] = j4 + load644;
    ...
    public String toString() {
        return new ObfuscatedString(new long[]{-4792335955211749515L, -5675279044386199507L, 1494590752541593L, -7414919441975829315L, 783531787110161189L}).toString();
    }
}
