...
public class CycleDetectingLockFactory {
    ...
    public static class ExampleStackTrace extends IllegalStateException {
        ...
        */
        public ExampleStackTrace(LockGraphNode lockGraphNode, LockGraphNode lockGraphNode2) {
            super(AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{3204793029783811971L, 7772024258006743626L}), AbstractC0362x4440ab85.m2938x1aebc6d9(AbstractC1320xaf50c7e8.m4356x1378447b(AbstractC1320xaf50c7e8.m4356x1378447b(4, r4), r5), r4), r5));
    ...
    public static class LockGraphNode {
        ...
        public void checkAcquiredLock(Policy policy, LockGraphNode lockGraphNode) {
            ...
            Preconditions.checkState(z, new ObfuscatedString(new long[]{-4354673171352717943L, -5087428105500143535L, -1283477920611862417L, 3999527576094907448L, 645218809345540244L, -3268581122884445901L, -4539620044928731133L, -412009888426950671L, -189573020669010815L}).toString(), lockGraphNode.getLockName());
    ...
    public enum Policies implements Policy {
        ...
        WARN { // from class: com.google.common.util.concurrent.CycleDetectingLockFactory.Policies.2
            @Override // com.google.common.util.concurrent.CycleDetectingLockFactory.Policy
            public void handlePotentialDeadlock(PotentialDeadlockException potentialDeadlockException) {
                CycleDetectingLockFactory.logger.log(Level.SEVERE, new ObfuscatedString(new long[]{-7890207303096538835L, -5263763845870405416L, 859536001678978462L, -8849442380179239400L, 7580500619588054986L}).toString(), (Throwable) potentialDeadlockException);
            }
        },
    ...
    public static final class PotentialDeadlockException extends ExampleStackTrace {
        ...
        public String getMessage() {
            ...
            for (Throwable th = this.conflictingStackTrace; th != null; th = th.getCause()) {
                sb.append(new ObfuscatedString(new long[]{-8231193417642992617L, 7632471442823328128L}).toString());
    ...
    public static <E extends Enum<E>> Map<E, LockGraphNode> createNodes(Class<E> cls) {
        ...
        return DesugarCollections.unmodifiableMap(newEnumMap);
    }

    private static String getLockName(Enum<?> r3) {
        String simpleName = r3.getDeclaringClass().getSimpleName();
        String name = r3.name();
        return AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{7844807092722526974L, -5329647865739528926L}), AbstractC0362x4440ab85.m2938x1aebc6d9(AbstractC1320xaf50c7e8.m4356x1378447b(simpleName.length() + 1, name), simpleName), name);
    }
