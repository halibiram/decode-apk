...
public final class ExpandedProductParsedResult extends ParsedResult {
    public static final String KILOGRAM = new ObfuscatedString(new long[]{-5998983754209953439L, -1773780591522844219L}).toString();
    public static final String POUND = new ObfuscatedString(new long[]{4575268774632678742L, -8130498323582836823L}).toString();
