...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void computeSize() {
        ...
        float calcTextHeight = Utils.calcTextHeight(this.mAxisLabelPaint, new ObfuscatedString(new long[]{3653503127358632547L, -7810239665726876355L}).toString());
            ...
            if (this.mViewPortHandler.isInBoundsX(f3)) {
                ...
                if (this.mXAxis.isAvoidFirstLastClippingEnabled()) {
                    ...
                    if (i3 == i4 - 1 && i4 > 1) {
                        ...
                        f2 = (Utils.calcTextWidth(this.mAxisLabelPaint, formattedValue) / 2.0f) + f3;
    ...
    public void renderLimitLineLabel(Canvas canvas, LimitLine limitLine, float[] fArr, float f) {
        ...
        if (label != null && !label.equals(new ObfuscatedString(new long[]{7286208200260036643L}).toString())) {
            ...
            if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                ...
                canvas.drawText(label, fArr[0] + xOffset, this.mViewPortHandler.contentTop() + f + calcTextHeight, this.mLimitLinePaint);
