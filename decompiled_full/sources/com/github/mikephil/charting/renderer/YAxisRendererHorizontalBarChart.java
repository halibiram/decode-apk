...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            float calcTextHeight = Utils.calcTextHeight(this.mAxisLabelPaint, new ObfuscatedString(new long[]{9020282249846486637L, -2010356900470322455L}).toString());
        ...
        if (limitLines != null && limitLines.size() > 0) {
            ...
            while (i < limitLines.size()) {
                ...
                if (limitLine.isEnabled()) {
                    ...
                    if (label != null && !label.equals(new ObfuscatedString(new long[]{4047210874471528838L}).toString())) {
                        ...
                        if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                            ...
                            this.mLimitLinePaint.setTextAlign(Paint.Align.LEFT);
                            canvas.drawText(label, fArr[0] + xOffset, this.mViewPortHandler.contentTop() + yOffset + calcTextHeight, this.mLimitLinePaint);
