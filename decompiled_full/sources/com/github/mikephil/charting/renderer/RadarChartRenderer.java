        ...
        while (i4 < ((RadarData) this.mChart.getData()).getDataSetCount()) {
            ...
            if (!shouldDrawValues(dataSetByIndex)) {
                ...
                while (i5 < dataSetByIndex.getEntryCount()) {
                    ...
                    Utils.getPosition(centerOffsets, (radarEntry.getY() - this.mChart.getYChartMin()) * factor * phaseY, this.mChart.getRotationAngle() + f5, mPPointF4);
                    ...
                    if (radarEntry.getIcon() != null && iRadarDataSet.isDrawIconsEnabled()) {
                        ...
                        Utils.getPosition(centerOffsets, (radarEntry.getY() * factor * phaseY) + mPPointF2.y, this.mChart.getRotationAngle() + f5, mPPointF3);
