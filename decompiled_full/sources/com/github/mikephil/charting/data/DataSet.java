...
public abstract class DataSet<T extends Entry> extends BaseDataSet<T> {
    ...
    public void addEntryOrdered(T t) {
        ...
        calcMinMax(t);
        if (this.mValues.size() > 0 && ((Entry) AbstractC0362x4440ab85.m2928x75d576dc(1, this.mValues)).getX() > t.getX()) {
    ...
    public String toSimpleString() {
        ...
        sb.append(new ObfuscatedString(new long[]{-7085088789939911556L, -6339531350403296727L, 6006921865157286166L}).toString());
        if (getLabel() == null) {
            label = new ObfuscatedString(new long[]{4850553258427277821L}).toString();
        } else {
            label = getLabel();
        }
        sb.append(label);
        sb.append(new ObfuscatedString(new long[]{3544168065137685314L, 6386317543368282572L, 8269790907720932869L}).toString());
        sb.append(this.mValues.size());
        sb.append(new ObfuscatedString(new long[]{5501639222080482511L, 6408409062844547882L}).toString());
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.mValues.size(); i++) {
            stringBuffer.append(this.mValues.get(i).toString() + new ObfuscatedString(new long[]{6312859545704005834L, -4607637036594847366L}).toString());
        }
        return stringBuffer.toString();
    }
