...
import defpackage.AbstractC0353x1db10c9d;
import defpackage.AbstractC0362x4440ab85;
import defpackage.AbstractC0402xbaf08e36;
...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m529clone() {
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static IconCompat asIconCompat(Parcelable parcelable) {
            if (parcelable != null) {
                if (Build.VERSION.SDK_INT >= 23 && AbstractC0402xbaf08e36.m3041xf0a984b7(parcelable)) {
                    return IconCompat.createFromIcon(AbstractC0402xbaf08e36.m3026x1db10c9d(parcelable));
                }
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(AbstractC0353x1db10c9d.m2737x9738a56c(it2.next())));
                }
            }
            int i = Build.VERSION.SDK_INT;
    ...
    public static class CallStyle extends Style {
        ...
        public void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (i >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(AbstractC0353x1db10c9d.m2736x75d576dc(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
            ...
            if (i >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.createFromIcon(AbstractC0402xbaf08e36.m3026x1db10c9d(bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON)));
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public static List<CharSequence> getTextsFromContentView(Context context, Notification notification) {
            if (!AbstractC0847x8aff552a.m3383x742e2fda().getName().equals(notification.extras.getString(NotificationCompat.EXTRA_TEMPLATE))) {
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(AbstractC0847x8aff552a.m3384xe698d().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(AbstractC0847x8aff552a.m3383x742e2fda().getName())) {
                    return new DecoratedCustomViewStyle();
                }
            }
            return null;
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (builder.mLargeIcon != null) {
                ...
                remoteViews.setImageViewBitmap(i5, createColoredBitmap(this.mBuilder.mLargeIcon, 0));
                if (z && this.mBuilder.mNotification.icon != 0) {
                    ...
                    remoteViews.setImageViewBitmap(i6, createIconWithBackground);
            ...
            if (charSequence4 != null) {
                ...
                if (this.mBuilder.getWhenIfShowing() == 0) {
                    if (this.mBuilder.mUseChronometer) {
                        ...
                        if (z6 && i3 >= 24) {
                            Api24Impl.setChronometerCountDown(remoteViews, i11, z6);
                        }
                    } else {
                        int i12 = R.id.time;
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m530clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(AbstractC0353x1db10c9d.m2737x9738a56c(it.next())));
                }
            }
        } else {
    ...
    public static class MessagingStyle extends Style {
        ...
        private Message findLatestIncomingMessage() {
            ...
            if (!this.mMessages.isEmpty()) {
                return (Message) AbstractC0362x4440ab85.m2928x75d576dc(1, this.mMessages);
            }
            return null;
        }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i >= 24) {
                ...
                while (it.hasNext()) {
                    Api24Impl.addMessage(AbstractC0847x8aff552a.m3358x75d576dc(createMessagingStyle), it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        Api26Impl.addHistoricMessage(AbstractC0847x8aff552a.m3358x75d576dc(createMessagingStyle), it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(AbstractC0847x8aff552a.m3358x75d576dc(createMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(AbstractC0847x8aff552a.m3358x75d576dc(createMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            person = Person.fromAndroidPerson(AbstractC0353x1db10c9d.m2736x75d576dc(bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
