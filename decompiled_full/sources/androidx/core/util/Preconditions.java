...
public final class Preconditions {
    ...
    public static float checkArgumentFinite(float f, String str) {
        if (!Float.isNaN(f)) {
            ...
            throw new IllegalArgumentException(AbstractC0362x4440ab85.m2931x34271fae(str, " must not be infinite"));
        }
        throw new IllegalArgumentException(AbstractC0362x4440ab85.m2931x34271fae(str, " must not be NaN"));
    }
