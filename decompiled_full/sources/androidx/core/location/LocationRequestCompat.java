...
public final class LocationRequestCompat {
    ...
    public String toString() {
        StringBuilder m3341xc20437a5 = AbstractC0749x8313616e.m3341xc20437a5("Request[");
        if (this.mIntervalMillis != Long.MAX_VALUE) {
            m3341xc20437a5.append("@");
            TimeUtils.formatDuration(this.mIntervalMillis, m3341xc20437a5);
            int i = this.mQuality;
            if (i != 100) {
                if (i != 102) {
                    if (i == 104) {
                        m3341xc20437a5.append(" LOW_POWER");
                    }
                } else {
                    m3341xc20437a5.append(" BALANCED");
                }
            } else {
                m3341xc20437a5.append(" HIGH_ACCURACY");
            }
        } else {
            m3341xc20437a5.append("PASSIVE");
        }
        if (this.mDurationMillis != Long.MAX_VALUE) {
            m3341xc20437a5.append(", duration=");
            TimeUtils.formatDuration(this.mDurationMillis, m3341xc20437a5);
        }
        if (this.mMaxUpdates != Integer.MAX_VALUE) {
            m3341xc20437a5.append(", maxUpdates=");
            m3341xc20437a5.append(this.mMaxUpdates);
        }
        long j = this.mMinUpdateIntervalMillis;
        if (j != -1 && j < this.mIntervalMillis) {
            m3341xc20437a5.append(", minUpdateInterval=");
            TimeUtils.formatDuration(this.mMinUpdateIntervalMillis, m3341xc20437a5);
        }
        if (this.mMinUpdateDistanceMeters > 0.0d) {
            m3341xc20437a5.append(", minUpdateDistance=");
            m3341xc20437a5.append(this.mMinUpdateDistanceMeters);
        }
        if (this.mMaxUpdateDelayMillis / 2 > this.mIntervalMillis) {
            m3341xc20437a5.append(", maxUpdateDelay=");
            TimeUtils.formatDuration(this.mMaxUpdateDelayMillis, m3341xc20437a5);
        }
        m3341xc20437a5.append(']');
    ...
    public LocationRequest toLocationRequest(String str) {
        ...
        return AbstractC0451x42c92da7.m3093x34271fae(Api19Impl.toLocationRequest(this, str));
    }
