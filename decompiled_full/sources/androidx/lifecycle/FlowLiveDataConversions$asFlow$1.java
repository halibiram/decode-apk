    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (r1 != 0) {
                ...
                Observer observer4 = new Observer() { // from class: androidx.lifecycle.뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫
                    @Override // androidx.lifecycle.Observer
                    public final void onChanged(Object obj2) {
                        ProducerScope.this.mo2254trySendJP2dKIU(obj2);
                    }
                };
