...
public final class Version implements Comparable<Version> {
    ...
    public static final class Companion {
        ...
        public final Version parse(@Nullable String versionString) {
            ...
            Integer valueOf3;
            String str;
            if (versionString == null || StringsKt__StringsKt.isBlank(versionString)) {
                return null;
            }
    ...
    public String toString() {
        String str;
        if (!StringsKt__StringsKt.isBlank(this.description)) {
        ...
        sb.append('.');
        return AbstractC0362x4440ab85.m2935x1db10c9d(sb, str, this.patch);
    }
    ...
    private Version(int i, int i2, int i3, String str) {
        ...
        this.bigInteger = AbstractC0919x86d1e2e2.lazy(new Function0<BigInteger>() { // from class: androidx.window.core.Version$bigInteger$2
            {
                super(0);
            }
