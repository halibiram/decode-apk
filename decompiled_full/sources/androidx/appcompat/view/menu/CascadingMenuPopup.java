...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private int getNextMenuPosition(int i) {
        ListView listView = ((CascadingMenuInfo) AbstractC0362x4440ab85.m2928x75d576dc(1, this.mShowingMenus)).getListView();
        int[] iArr = new int[2];
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            cascadingMenuInfo = (CascadingMenuInfo) AbstractC0362x4440ab85.m2928x75d576dc(1, this.mShowingMenus);
    ...
    public ListView getListView() {
        ...
        return ((CascadingMenuInfo) AbstractC0362x4440ab85.m2928x75d576dc(1, this.mShowingMenus)).getListView();
    }
