...
public final class ConcatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final class Config {
        ...
        public static final class Builder {
            ...
            public Builder() {
                Config config2 = Config.DEFAULT;
                this.mIsolateViewTypes = config2.isolateViewTypes;
                this.mStableIdMode = config2.stableIdMode;
            }
    ...
    @SafeVarargs
    public ConcatAdapter(@NonNull Config config2, @NonNull RecyclerView.Adapter<? extends RecyclerView.ViewHolder>... adapterArr) {
        this(config2, (List<? extends RecyclerView.Adapter<? extends RecyclerView.ViewHolder>>) Arrays.asList(adapterArr));
    }
    ...
    public ConcatAdapter(@NonNull Config config2, @NonNull List<? extends RecyclerView.Adapter<? extends RecyclerView.ViewHolder>> list) {
        this.mController = new ConcatAdapterController(this, config2);
