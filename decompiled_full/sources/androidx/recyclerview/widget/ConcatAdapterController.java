...
public class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    public ConcatAdapterController(ConcatAdapter concatAdapter, ConcatAdapter.Config config2) {
        ...
        ConcatAdapter.Config.StableIdMode stableIdMode = config2.stableIdMode;
    ...
    private WrapperAndLocalPosition findWrapperAndLocalPosition(int i) {
        ...
        throw new IllegalArgumentException(AbstractC0362x4440ab85.m2929x9738a56c(i, "Cannot find wrapper for "));
    }
    ...
    public int getLocalAdapterPosition(RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, RecyclerView.ViewHolder viewHolder, int i) {
        ...
        StringBuilder m2937x8c6fc18a = AbstractC0362x4440ab85.m2937x8c6fc18a(countItemsBefore, itemCount, "Detected inconsistent adapter updates. The local position of the view holder maps to ", " which is out of bounds for the adapter with size ", ".Make sure to immediately call notify methods in your adapter when you change the backing dataviewHolder:");
        m2937x8c6fc18a.append(viewHolder);
        m2937x8c6fc18a.append("adapter:");
        m2937x8c6fc18a.append(adapter);
        throw new IllegalStateException(m2937x8c6fc18a.toString());
    }
