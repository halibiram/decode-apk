...
public final class ParcelableArraySerializer implements KSerializer<Parcelable[]> {
    ...
    public Parcelable[] deserialize(@NotNull Decoder decoder) {
        ...
        if (decoder instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m732getParcelableArrayimpl(SavedStateReader.m684constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
        }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull Parcelable[] value) {
        ...
        if (encoder instanceof SavedStateEncoder) {
            ...
            SavedStateWriter.m796putParcelableArrayimpl(SavedStateWriter.m771constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
            return;
        }
