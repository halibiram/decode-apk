...
public class PreferenceInflater {
    ...
    private void rInflate(@NonNull XmlPullParser xmlPullParser, Preference preference, AttributeSet attributeSet) {
    ...
    private static void skipCurrentTag(@NonNull XmlPullParser xmlPullParser) {
        int depth = xmlPullParser.getDepth();
        while (true) {
            int next = xmlPullParser.next();
            if (next != 1) {
