...
public class TransitionInflater {
    ...
    private Object createCustom(AttributeSet attributeSet, Class<?> cls, String str) {
        ...
        throw new InflateException(AbstractC0362x4440ab85.m2931x34271fae(str, " tag must have a 'class' attribute"));
    }
    ...
    */
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private TransitionManager createTransitionManagerFromXml(XmlPullParser xmlPullParser, AttributeSet attributeSet, @NonNull ViewGroup viewGroup) {
        int depth = xmlPullParser.getDepth();
    ...
    private void getTargetIds(XmlPullParser xmlPullParser, AttributeSet attributeSet, @NonNull Transition transition) {
        int depth = xmlPullParser.getDepth();
        while (true) {
            int next = xmlPullParser.next();
            if ((next != 3 || xmlPullParser.getDepth() > depth) && next != 1) {
                                    ...
                                    if (namedString2 != null) {
                                        ...
                                        if (namedString3 != null) {
                                            try {
                                                ...
                                                throw new RuntimeException(AbstractC0362x4440ab85.m2952x5ac5058d("Could not create ", namedString3), e);
                                            }
                                        } else {
    ...
    private void loadTransition(AttributeSet attributeSet, XmlPullParser xmlPullParser, @NonNull ViewGroup viewGroup, TransitionManager transitionManager) {
        ...
        if (namedResourceId >= 0 && (inflateTransition = inflateTransition(namedResourceId)) != null) {
            if (scene != null) {
                ...
                throw new RuntimeException(AbstractC0362x4440ab85.m2929x9738a56c(namedResourceId, "No toScene for transition ID "));
            }
        }
        obtainStyledAttributes.recycle();
    }
