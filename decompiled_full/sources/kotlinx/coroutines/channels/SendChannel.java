...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m2295isSuccessimpl(mo2254trySendJP2dKIU)) {
                return true;
            }
            Throwable m2289exceptionOrNullimpl = ChannelResult.m2289exceptionOrNullimpl(mo2254trySendJP2dKIU);
    ...
    Object mo2254trySendJP2dKIU(E element);
}
