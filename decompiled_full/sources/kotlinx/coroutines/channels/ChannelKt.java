...
public final class ChannelKt {
    ...
    public static final <T> T m2281getOrElseWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, ? extends T> function1) {
        if (obj instanceof ChannelResult.Failed) {
            return function1.invoke(ChannelResult.m2289exceptionOrNullimpl(obj));
        }
        return obj;
    }
    ...
    public static final <T> Object m2282onClosedWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Closed) {
            function1.invoke(ChannelResult.m2289exceptionOrNullimpl(obj));
        }
        return obj;
    }
    ...
    public static final <T> Object m2283onFailureWpGqRn0(@NotNull Object obj, @NotNull Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m2289exceptionOrNullimpl(obj));
        }
        return obj;
    ...
    public static final <T> Object m2284onSuccessWpGqRn0(@NotNull Object obj, @NotNull Function1<? super T, Unit> function1) {
        if (!(obj instanceof ChannelResult.Failed)) {
