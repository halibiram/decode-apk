...
public class ovpncliJNI {
    ...
    public static final native void ClientAPI_OpenVPNClient_connect_attach(long j, ClientAPI_OpenVPNClient clientAPI_OpenVPNClient);

    public static final native void ClientAPI_OpenVPNClient_connect_attachSwigExplicitClientAPI_OpenVPNClient(long j, ClientAPI_OpenVPNClient clientAPI_OpenVPNClient);

    public static final native void ClientAPI_OpenVPNClient_connect_detach(long j, ClientAPI_OpenVPNClient clientAPI_OpenVPNClient);

    public static final native void ClientAPI_OpenVPNClient_connect_detachSwigExplicitClientAPI_OpenVPNClient(long j, ClientAPI_OpenVPNClient clientAPI_OpenVPNClient);

    public static final native void ClientAPI_OpenVPNClient_connect_pre_run(long j, ClientAPI_OpenVPNClient clientAPI_OpenVPNClient);

    public static final native void ClientAPI_OpenVPNClient_connect_pre_runSwigExplicitClientAPI_OpenVPNClient(long j, ClientAPI_OpenVPNClient clientAPI_OpenVPNClient);

    public static final native void ClientAPI_OpenVPNClient_connect_run(long j, ClientAPI_OpenVPNClient clientAPI_OpenVPNClient);

    public static final native void ClientAPI_OpenVPNClient_connect_runSwigExplicitClientAPI_OpenVPNClient(long j, ClientAPI_OpenVPNClient clientAPI_OpenVPNClient);

    public static final native void ClientAPI_OpenVPNClient_connect_session_stop(long j, ClientAPI_OpenVPNClient clientAPI_OpenVPNClient);

    public static final native void ClientAPI_OpenVPNClient_connect_session_stopSwigExplicitClientAPI_OpenVPNClient(long j, ClientAPI_OpenVPNClient clientAPI_OpenVPNClient);
    ...
    public static void SwigDirector_ClientAPI_OpenVPNClient_connect_attach(ClientAPI_OpenVPNClient clientAPI_OpenVPNClient) {
        clientAPI_OpenVPNClient.connect_attach();
    }

    public static void SwigDirector_ClientAPI_OpenVPNClient_connect_detach(ClientAPI_OpenVPNClient clientAPI_OpenVPNClient) {
        clientAPI_OpenVPNClient.connect_detach();
    }

    public static void SwigDirector_ClientAPI_OpenVPNClient_connect_pre_run(ClientAPI_OpenVPNClient clientAPI_OpenVPNClient) {
        clientAPI_OpenVPNClient.connect_pre_run();
    }

    public static void SwigDirector_ClientAPI_OpenVPNClient_connect_run(ClientAPI_OpenVPNClient clientAPI_OpenVPNClient) {
        clientAPI_OpenVPNClient.connect_run();
    }

    public static void SwigDirector_ClientAPI_OpenVPNClient_connect_session_stop(ClientAPI_OpenVPNClient clientAPI_OpenVPNClient) {
        clientAPI_OpenVPNClient.connect_session_stop();
    }
    ...
    public static boolean SwigDirector_ClientAPI_OpenVPNClient_socket_protect(ClientAPI_OpenVPNClient clientAPI_OpenVPNClient, int i) {
        return clientAPI_OpenVPNClient.socket_protect(i);
    }
