...
public final class Z3 extends AbstractC1402i0 implements e4 {
    ...
    final Spliterator P(AbstractC1366b abstractC1366b, Spliterator spliterator) {
        if (EnumC1365a3.ORDERED.n(abstractC1366b.J())) {
            return O(abstractC1366b, spliterator, new C1372c0(13)).spliterator();
        }
        return new k4((j$.util.Z) abstractC1366b.X(spliterator), 0);
    }
    ...
    public final InterfaceC1424m2 R(int i, InterfaceC1424m2 interfaceC1424m2) {
        return new Y3(this, interfaceC1424m2, false);
    }
