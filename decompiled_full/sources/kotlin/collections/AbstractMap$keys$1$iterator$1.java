...
public final class AbstractMap$keys$1$iterator$1<K> implements Iterator<K>, KMappedMarker {
    ...
    public final /* synthetic */ Iterator f1208xfbe0c504;

    public AbstractMap$keys$1$iterator$1(Iterator it) {
        this.f1208xfbe0c504 = it;
    }

    @Override // java.util.Iterator
    public boolean hasNext() {
        return this.f1208xfbe0c504.hasNext();
    }

    @Override // java.util.Iterator
    public K next() {
        return (K) ((Map.Entry) this.f1208xfbe0c504.next()).getKey();
    }
