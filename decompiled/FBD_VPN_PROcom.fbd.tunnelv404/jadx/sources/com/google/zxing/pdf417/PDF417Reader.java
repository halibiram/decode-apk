...
public final class PDF417Reader implements Reader, MultipleBarcodeReader {
    ...
    private static Result[] decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map, boolean z) {
        ...
        for (ResultPoint[] resultPointArr : detect.getPoints()) {
            ...
            result.putMetadata(ResultMetadataType.SYMBOLOGY_IDENTIFIER, new ObfuscatedString(new long[]{-526998735880420548L, 218636671374567241L}).toString() + decode.getSymbologyModifier());
