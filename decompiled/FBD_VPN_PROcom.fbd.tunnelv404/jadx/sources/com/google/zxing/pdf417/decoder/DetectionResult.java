...
final class DetectionResult {
    ...
    public String toString() {
        ...
        for (int i = 0; i < detectionResultColumn.getCodewords().length; i++) {
            try {
                formatter.format(new ObfuscatedString(new long[]{3192901258319584319L, -5528724900405361107L}).toString(), Integer.valueOf(i));
                for (int i2 = 0; i2 < this.barcodeColumnCount + 2; i2++) {
                    ...
                    if (detectionResultColumn2 == null) {
                        formatter.format(new ObfuscatedString(new long[]{4142209417042899725L, 200025481240701128L}).toString(), new Object[0]);
                    } else {
                        Codeword codeword = detectionResultColumn2.getCodewords()[i];
                        if (codeword == null) {
                            formatter.format(new ObfuscatedString(new long[]{-823730207493364012L, -8996273105701206554L}).toString(), new Object[0]);
                        } else {
                            formatter.format(new ObfuscatedString(new long[]{-4350676387312399302L, 105347278730140636L}).toString(), Integer.valueOf(codeword.getRowNumber()), Integer.valueOf(codeword.getValue()));
                        }
                    }
                }
                formatter.format(new ObfuscatedString(new long[]{4590345049331991413L, -5878990778327395065L}).toString(), new Object[0]);
            } catch (Throwable th) {
                try {
                    throw th;
                } catch (Throwable th2) {
