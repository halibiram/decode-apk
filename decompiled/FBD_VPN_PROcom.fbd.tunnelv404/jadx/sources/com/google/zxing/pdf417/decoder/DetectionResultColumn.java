    ...
    public String toString() {
        ...
        try {
            ...
            for (Codeword codeword : this.codewords) {
                if (codeword == null) {
                    formatter.format(new ObfuscatedString(new long[]{-3839786386618484102L, -7459484615327041114L, 4702842782824926632L}).toString(), Integer.valueOf(i));
                    i++;
                } else {
                    formatter.format(new ObfuscatedString(new long[]{849627853565828377L, 4857851172064350301L, -8406039382959176922L}).toString(), Integer.valueOf(i), Integer.valueOf(codeword.getRowNumber()), Integer.valueOf(codeword.getValue()));
                    i++;
                }
            }
