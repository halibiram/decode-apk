        ...
        if (i4 < bitArray.getSize() && bitArray.isRange(i3, i4, false)) {
            ...
            if (sb2.length() >= 8) {
                if (checkChecksum(sb2)) {
                    ...
                    result.putMetadata(ResultMetadataType.SYMBOLOGY_IDENTIFIER, new ObfuscatedString(new long[]{6424881686106048175L, 3383663959956853241L}).toString() + (barcodeFormat == BarcodeFormat.EAN_8 ? 4 : 0));
                    return result;
                }
