    ...
    public BitMatrix encode(String str, BarcodeFormat barcodeFormat, int i, int i2, Map<EncodeHintType, ?> map) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$zxing$BarcodeFormat[barcodeFormat.ordinal()]) {
            ...
            case 13:
                ...
                break;
            default:
                throw new IllegalArgumentException(new ObfuscatedString(new long[]{-5035434098669536514L, 934597638333107280L, -6775618631058710053L, -1968835560536123761L, 5775354098827348522L}).toString() + barcodeFormat);
        }
