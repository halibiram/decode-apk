...
public class QRCodeReader implements Reader {
    ...
    public final Result decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) {
        ...
        result.putMetadata(ResultMetadataType.SYMBOLOGY_IDENTIFIER, new ObfuscatedString(new long[]{-2031186445176823225L, -316697662456496135L}).toString() + decoderResult.getSymbologyModifier());
        return result;
    }
}
