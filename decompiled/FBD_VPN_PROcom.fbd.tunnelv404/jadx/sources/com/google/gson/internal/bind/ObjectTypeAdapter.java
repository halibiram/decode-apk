        ...
        if (i != 3) {
            if (i != 4) {
                if (i != 5) {
                    ...
                    throw new IllegalStateException(new ObfuscatedString(new long[]{-5345639235978152399L, 8454385824173040210L, 460820694752450156L, 2597157900400231161L}).toString() + jsonToken);
                }
