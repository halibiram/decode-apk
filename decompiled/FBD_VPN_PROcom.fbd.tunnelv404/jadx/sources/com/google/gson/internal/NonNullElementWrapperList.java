...
public class NonNullElementWrapperList<E> extends AbstractList<E> implements RandomAccess {
    ...
    private E nonNull(E e) {
        ...
        throw new NullPointerException(new ObfuscatedString(new long[]{1234072002835443713L, -760033328949993808L, -7782892070381559973L, 5827010764575603014L}).toString());
    }
