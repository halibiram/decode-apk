...
public final class NumberTypeAdapter extends TypeAdapter<Number> {
    ...
    public Number read2(JsonReader jsonReader) {
        ...
        if (i != 2 && i != 3) {
            throw new JsonSyntaxException(new ObfuscatedString(new long[]{3816679544889821882L, 7678739452379190268L, 5947785041485908491L, -3996575515844514961L}).toString() + peek + new ObfuscatedString(new long[]{-2297140332431424795L, 4486340681237226010L, -2853796334421575444L}).toString() + jsonReader.getPath());
        }
