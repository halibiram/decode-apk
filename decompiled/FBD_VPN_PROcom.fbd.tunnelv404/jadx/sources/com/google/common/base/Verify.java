...
public final class Verify {
    ...
    public static <T> T verifyNotNull(@CheckForNull T t) {
        return (T) verifyNotNull(t, new ObfuscatedString(new long[]{-8041685882154827263L, -2284561330952890399L, -379341307619788734L, -2920782607217489960L, 188330090522316840L}).toString(), new Object[0]);
    }
