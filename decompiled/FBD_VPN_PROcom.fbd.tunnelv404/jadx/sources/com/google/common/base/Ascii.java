...
public final class Ascii {
    ...
    public static String truncate(CharSequence charSequence, int i, String str) {
        ...
        Preconditions.checkArgument(z, new ObfuscatedString(new long[]{-1524100481655843601L, -8821920596215576456L, 9109566194364275680L, 4693780021669927469L, -1267544066783131607L, -8218791507044051304L, -6240966854375587548L, 3809386765389722684L, 6768304451043916164L, 641653007183190398L}).toString(), i, str.length());
