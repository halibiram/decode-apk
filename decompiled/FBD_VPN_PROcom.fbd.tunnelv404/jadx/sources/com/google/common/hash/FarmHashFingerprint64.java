...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength0to16(byte[] bArr, int i, int i2) {
        ...
        return shiftMix((((bArr[i] & 255) + ((bArr[(i2 >> 1) + i] & 255) << 8)) * K2) ^ ((i2 + ((bArr[(i2 - 1) + i] & 255) << 2)) * K0)) * K2;
    }
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            long load642 = jArr[0] + LittleEndianByteArray.load64(bArr, i8 + 40) + rotateRight2;
            ...
            if (i9 == i4) {
                ...
                long load643 = (jArr[0] * 9) + LittleEndianByteArray.load64(bArr, i6 - 23) + rotateRight5;
                ...
                return hashLength16((shiftMix(load643) * K0) + hashLength16(jArr[0], jArr2[0], j4) + j7, hashLength16(jArr[1], jArr2[1], j4) + rotateRight6, j4);
            }
            i8 = i9;
            shiftMix = j3;
            j2 = load642;
    ...
    private static void weakHashLength32WithSeeds(byte[] bArr, int i, long j, long j2, long[] jArr) {
        ...
        long rotateRight = Long.rotateRight(j4, 44) + Long.rotateRight(j2 + j3 + load644, 21);
        jArr[0] = j4 + load644;
    ...
    public String toString() {
        return new ObfuscatedString(new long[]{3285702984538026404L, 7932358101412798970L, 3128139344908532736L, -7094855948038765682L, 8641007722841700176L}).toString();
    }
}
