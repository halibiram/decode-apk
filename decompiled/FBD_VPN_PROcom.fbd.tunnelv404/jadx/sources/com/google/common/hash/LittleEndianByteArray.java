...
final class LittleEndianByteArray {
        ...
        private static Unsafe getUnsafe() {
            try {
                try {
                    ...
                    throw new RuntimeException(new ObfuscatedString(new long[]{-5318510564759728562L, 4455700090754686249L, -7828463323333919799L, -1088506758930725948L, -878951183913809844L}).toString(), e.getCause());
                }
                ...
                return (Unsafe) AccessController.doPrivileged(new PrivilegedExceptionAction<Unsafe>() { // from class: com.google.common.hash.LittleEndianByteArray.UnsafeByteArray.3
                    ...
                    public Unsafe run() {
                        ...
                        throw new NoSuchFieldError(new ObfuscatedString(new long[]{6475528932196621745L, -6821596144030715701L, -8562269025162868618L}).toString());
                    }
                });
            }
        }
    ...
    static {
        ...
        LittleEndianBytes littleEndianBytes2 = JavaLittleEndianBytes.INSTANCE;
        try {
            if (new ObfuscatedString(new long[]{6889211108432567753L, -7915186843864347378L}).toString().equals(System.getProperty(new ObfuscatedString(new long[]{6336983835815336312L, 6639229260107730790L}).toString()))) {
