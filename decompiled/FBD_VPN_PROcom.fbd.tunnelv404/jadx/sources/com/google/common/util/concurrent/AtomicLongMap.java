...
public final class AtomicLongMap<K> implements Serializable {
    ...
    private Map<K, Long> createAsMap() {
        return DesugarCollections.unmodifiableMap(Maps.transformValues(this.map, new Function<AtomicLong, Long>(this) { // from class: com.google.common.util.concurrent.AtomicLongMap.1
