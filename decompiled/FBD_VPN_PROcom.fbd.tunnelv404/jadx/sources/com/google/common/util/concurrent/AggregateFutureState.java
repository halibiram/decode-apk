...
abstract class AggregateFutureState<OutputT> extends AbstractFuture.TrustedFuture<OutputT> {
    ...
    static {
        ...
        Object[] objArr = 0;
        try {
            synchronizedAtomicHelper = new SafeAtomicHelper(AtomicReferenceFieldUpdater.newUpdater(AggregateFutureState.class, Set.class, new ObfuscatedString(new long[]{-7767017624691688263L, 699197829520784091L, -2384985738918942320L}).toString()), AtomicIntegerFieldUpdater.newUpdater(AggregateFutureState.class, new ObfuscatedString(new long[]{-5054616983931798054L, 4900981666257458016L, -3156026429438174330L}).toString()));
        } catch (Throwable th2) {
        ...
        if (th != null) {
            log.log(Level.SEVERE, new ObfuscatedString(new long[]{-4955791570034501045L, 4684567332462378208L, -5699404576998720444L, 800439628130823576L, 5236662596837001682L}).toString(), th);
        }
    }
