...
public final class ImmutableDoubleArray implements Serializable {
    ...
    public static Builder builder(int i) {
        Preconditions.checkArgument(i >= 0, new ObfuscatedString(new long[]{-7373856543486158250L, 3578455864579636403L, 3907556805287579573L, 3318376224680175472L, -2083476069178477857L}).toString(), i);
    ...
    public String toString() {
        if (isEmpty()) {
            return new ObfuscatedString(new long[]{6533444253079658777L, 8527475338020434335L}).toString();
        }
        ...
        while (true) {
            i++;
            if (i < this.end) {
                sb.append(new ObfuscatedString(new long[]{5408897468370283448L, 1425780472399676010L}).toString());
    ...
    public static final class Builder {
        ...
        private static int expandedCapacity(int i, int i2) {
            ...
            throw new AssertionError(new ObfuscatedString(new long[]{-5848240116405575826L, -5337334396790138220L, 6896563069056129528L, 4605957561325040614L, -5515160890334334893L, 9204135496440091130L, -3767642907599634317L}).toString());
        }
    ...
    public static ImmutableDoubleArray of(double d, double... dArr) {
        Preconditions.checkArgument(dArr.length <= 2147483646, new ObfuscatedString(new long[]{4478542055561772915L, -117206578748030702L, 3405278551124004669L, -6471428306674418193L, 2114337703250722959L, -3777393131851660891L, 8142615758125237352L}).toString());
