...
abstract class Striped64 extends Number {
    ...
    public static final class Cell {
        ...
        static {
            try {
                ...
                UNSAFE = access$000;
                valueOffset = access$000.objectFieldOffset(Cell.class.getDeclaredField(new ObfuscatedString(new long[]{-8620105404150194512L, 4305290302976983714L}).toString()));
            } catch (Exception e) {
                throw new Error(e);
            }
        }
    ...
    static {
        try {
            ...
            UNSAFE = unsafe;
            baseOffset = unsafe.objectFieldOffset(Striped64.class.getDeclaredField(new ObfuscatedString(new long[]{3320314797278595307L, -4769299333782889007L}).toString()));
            busyOffset = unsafe.objectFieldOffset(Striped64.class.getDeclaredField(new ObfuscatedString(new long[]{-6262278636672867233L, 1708523496831892049L}).toString()));
        } catch (Exception e) {
            throw new Error(e);
        }
    }
    ...
    private static Unsafe getUnsafe() {
        try {
            try {
                ...
                throw new RuntimeException(new ObfuscatedString(new long[]{2195043601466450363L, 6141148419300234906L, 2512923558670122347L, -3408712307232716768L, 451212595977720003L}).toString(), e.getCause());
            }
            ...
            return (Unsafe) AccessController.doPrivileged(new PrivilegedExceptionAction<Unsafe>() { // from class: com.google.common.cache.Striped64.1
                ...
                public Unsafe run() {
                    ...
                    throw new NoSuchFieldError(new ObfuscatedString(new long[]{2310085505011958322L, 2966142742108443345L, -2820640568149815316L}).toString());
                }
            });
        }
    }
