...
public abstract class ImmutableSortedMultiset<E> extends ImmutableSortedMultisetFauxverideShim<E> implements SortedMultiset<E> {
    ...
    public static class Builder<E> extends ImmutableMultiset.Builder<E> {
        ...
        public Builder<E> addCopies(E e, int i) {
            ...
            CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{733653407953633684L, 5231562842003688137L, 8720434350792980163L}).toString());
            if (i == 0) {
                return this;
            }
            maintenance();
        ...
        public Builder<E> setCount(E e, int i) {
            Preconditions.checkNotNull(e);
            CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{-5418567323578962977L, -2387500616664223874L}).toString());
            maintenance();
            E[] eArr = this.elements;
            int i2 = this.length;
            eArr[i2] = e;
    ...
    public ImmutableSortedMultiset<E> subMultiset(E e, BoundType boundType, E e2, BoundType boundType2) {
        Preconditions.checkArgument(comparator().compare(e, e2) <= 0, new ObfuscatedString(new long[]{-5913423013636191145L, 978463606608488232L, -8786375504659371641L, -6369868118161296638L, -5971783091927330640L, -6440635348708442922L, -5491143083128733674L}).toString(), e, e2);
