...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public static abstract class ArrayMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V> {
        ...
        public V put(K k, @ParametricNullness V v) {
            ...
            StringBuilder m2938x1aebc6d9 = AbstractC0362x4440ab85.m2938x1aebc6d9(valueOf2.length() + valueOf.length() + AbstractC1320xaf50c7e8.m4356x1378447b(9, keyRole), keyRole);
            m2938x1aebc6d9.append(new ObfuscatedString(new long[]{-1693613564495830323L, -5941441184906845481L}).toString());
            m2938x1aebc6d9.append(valueOf);
            throw new IllegalArgumentException(AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{3496513301675325627L, -4358329144350262134L}), m2938x1aebc6d9, valueOf2));
        }
    ...
    public class Column extends ArrayMap<R, V> {
        ...
        public String getKeyRole() {
            return new ObfuscatedString(new long[]{-1114145752839730777L, -6224453180553568181L}).toString();
        }
    ...
    public class ColumnMap extends ArrayMap<C, Map<R, V>> {
        @Override // com.google.common.collect.ArrayTable.ArrayMap
        public String getKeyRole() {
            return new ObfuscatedString(new long[]{-9060416046786287192L, 4623206653195458488L}).toString();
        }
    ...
    public class Row extends ArrayMap<C, V> {
        ...
        @Override // com.google.common.collect.ArrayTable.ArrayMap
        public String getKeyRole() {
            return new ObfuscatedString(new long[]{-8423159432844489378L, 6274204940805213502L}).toString();
        }
    ...
    public class RowMap extends ArrayMap<R, Map<C, V>> {
        @Override // com.google.common.collect.ArrayTable.ArrayMap
        public String getKeyRole() {
            return new ObfuscatedString(new long[]{4193330908899170410L, 7058024731742886914L}).toString();
        }
    ...
    public V put(R r, C c, @CheckForNull V v) {
        ...
        Preconditions.checkArgument(z, new ObfuscatedString(new long[]{4830433689746612730L, 6362223857103871622L, -5145259596022910457L}).toString(), r, this.rowList);
        Integer num2 = this.columnKeyToIndex.get(c);
        if (num2 != null) {
            z2 = true;
        }
        Preconditions.checkArgument(z2, new ObfuscatedString(new long[]{-902187335611414543L, -548186673036800029L, -8776606773620854227L, -612746322603193431L}).toString(), c, this.columnList);
