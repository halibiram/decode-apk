...
public final class Multimaps {
    ...
    public static class Keys<K, V> extends AbstractMultiset<K> {
        ...
        public Iterator<K> elementIterator() {
            throw new AssertionError(new ObfuscatedString(new long[]{6408289022561687585L, 8065842113286685615L, 2348779037870632727L, -3308586662185310635L}).toString());
        }
        ...
        public int remove(@CheckForNull Object obj, int i) {
            CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{-1125829137325149697L, -407348574462823418L, 7816145112623986586L}).toString());
            if (i == 0) {
                return count(obj);
            }
            Collection collection = (Collection) Maps.safeGet(this.multimap.asMap(), obj);
    ...
    public static class MapMultimap<K, V> extends AbstractMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        ...
        public Collection<Map.Entry<K, V>> createEntries() {
            throw new AssertionError(new ObfuscatedString(new long[]{6575873911793634533L, -7060663968473462578L, -1609426488838322151L}).toString());
        }
    ...
    public static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            if (map == null) {
                Map<K, Collection<V>> unmodifiableMap = DesugarCollections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new Function<Collection<V>, Collection<V>>(this) { // from class: com.google.common.collect.Multimaps.UnmodifiableMultimap.1
                    @Override // com.google.common.base.Function
    ...
    public static <K, V> Collection<Map.Entry<K, V>> unmodifiableEntries(Collection<Map.Entry<K, V>> collection) {
        ...
        return new Maps.UnmodifiableEntries(DesugarCollections.unmodifiableCollection(collection));
    }
