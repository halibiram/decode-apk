...
public class CompactHashSet<E> extends AbstractSet<E> implements Serializable {
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        throw new InvalidObjectException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{5298393356242755730L, -6433262933398105890L, -4161256691561854010L}), new StringBuilder(25), readInt));
    }
    ...
    public int allocArrays() {
        Preconditions.checkState(needsAllocArrays(), new ObfuscatedString(new long[]{3905696276676217910L, 7469800155053301946L, -1353217918390081430L, -4436173827546111030L}).toString());
        int i = this.metadata;
    ...
    public void init(int i) {
        ...
        Preconditions.checkArgument(z, new ObfuscatedString(new long[]{-2090512975729131059L, -7426442921136248638L, -2765023550320730170L, -9111035051293705821L, -5129460415374963181L}).toString());
