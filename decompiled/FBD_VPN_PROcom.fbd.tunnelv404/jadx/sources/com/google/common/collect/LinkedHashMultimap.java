...
public final class LinkedHashMultimap<K, V> extends LinkedHashMultimapGwtSerializationDependencies<K, V> {
        ...
        public Iterator<V> iterator() {
            return new Iterator<V>() { // from class: com.google.common.collect.LinkedHashMultimap.ValueSet.1
                ...
                public void remove() {
                    ...
                    Preconditions.checkState(z, new ObfuscatedString(new long[]{-8230469407818273580L, 1940276987875878534L, -3240834707491862871L, 9144366174115464377L, -2958116208217216589L, -3136983207979927511L, -4951006819166195433L, -8248899896395152482L}).toString());
    ...
    private LinkedHashMultimap(int i, int i2) {
        ...
        CollectPreconditions.checkNonnegative(i2, new ObfuscatedString(new long[]{1903318523167090224L, 7361605451828719823L, 8711555546943147624L, 4302428312632911461L}).toString());
    ...
    public Iterator<Map.Entry<K, V>> entryIterator() {
        return new Iterator<Map.Entry<K, V>>() { // from class: com.google.common.collect.LinkedHashMultimap.1
            ...
            public void remove() {
                ...
                Preconditions.checkState(z, new ObfuscatedString(new long[]{-3252863580128442194L, 8497494767584239195L, 3005666269682422409L, -1338722203018543441L, -674857440058086158L, 2456723927217454338L, 7553986045998926546L, 4535805058753647401L}).toString());
