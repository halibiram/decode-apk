...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        if (readInt >= 0) {
            ...
            for (int i2 = 0; i2 < readInt; i2++) {
                ...
                if (readInt2 > 0) {
                    ...
                    throw new InvalidObjectException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-6979609592243036181L, 6844965980809523808L, 1882950877117834720L, -2742151635157623964L}), new StringBuilder(31), readInt2));
                }
            }
            try {
        ...
        throw new InvalidObjectException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-7689923826719149323L, -4797618042621368488L, -2123173075231674606L, 140684000249339024L}), new StringBuilder(29), readInt));
    }
