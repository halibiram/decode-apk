...
public final class Tables {
    ...
    public static abstract class AbstractCell<R, C, V> implements Table.Cell<R, C, V> {
        ...
        public String toString() {
            ...
            sb.append(new ObfuscatedString(new long[]{-8370618612175238595L, 2398062837788424462L}).toString());
            sb.append(valueOf);
            sb.append(new ObfuscatedString(new long[]{1537058737638475589L, -7051269745312338089L}).toString());
            sb.append(valueOf2);
            return AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{-6428625493651895609L, -7913589437739657884L}), sb, valueOf3);
        }
    }
    ...
    public static final class UnmodifiableRowSortedMap<R, C, V> extends UnmodifiableTable<R, C, V> implements RowSortedTable<R, C, V> {
        ...
        public SortedMap<R, Map<C, V>> rowMap() {
            return DesugarCollections.unmodifiableSortedMap(Maps.transformValues((SortedMap) delegate().rowMap(), Tables.access$000()));
        }
    ...
    public static class UnmodifiableTable<R, C, V> extends ForwardingTable<R, C, V> implements Serializable {
        ...
        public Map<C, Map<R, V>> columnMap() {
            return DesugarCollections.unmodifiableMap(Maps.transformValues(super.columnMap(), Tables.access$000()));
        }
        ...
        public Map<R, Map<C, V>> rowMap() {
            return DesugarCollections.unmodifiableMap(Maps.transformValues(super.rowMap(), Tables.access$000()));
        }
