...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    private void deleteFromTableKToV(int i, int i2) {
        ...
        while (true) {
            ...
            if (i3 != -1) {
                ...
                throw new AssertionError(AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{6261893787763885125L, -5598761178062165176L, -4583895343464435388L, -7026411245167385635L, 3296639877615780959L}), new StringBuilder(valueOf.length() + 32), valueOf));
            }
        }
    }
    ...
    private void deleteFromTableVToK(int i, int i2) {
        ...
        while (true) {
            ...
            if (i3 != -1) {
                ...
                throw new AssertionError(AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{2325441627725372441L, 677259961551151910L, 6402819269914415244L, -8620949467435588201L, 3388274906415296522L, -633273859442276396L}), new StringBuilder(valueOf.length() + 34), valueOf));
            }
        }
    }
    ...
    public void replaceKeyInEntry(int i, @ParametricNullness K k, boolean z) {
        ...
        if (findEntryByKey != -1) {
            if (z) {
                ...
                throw new IllegalArgumentException(AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{-2455605633265142869L, 8651747806210984962L, -6681436516712164434L, 7159141381042988610L, -8610971302803597417L}), new StringBuilder(valueOf.length() + 28), valueOf));
            }
        } else {
            i2 = -2;
        }
    ...
    public void replaceValueInEntry(int i, @ParametricNullness V v, boolean z) {
        ...
        if (findEntryByValue != -1) {
            if (z) {
                ...
                throw new IllegalArgumentException(AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{4690275560377488010L, -5559982776709094440L, -8282874487586687777L, -8298282819168243946L, -7960025621978813557L}), new StringBuilder(valueOf.length() + 30), valueOf));
            }
        }
    ...
    public void init(int i) {
        CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{-9018841240066133696L, -443020409051923188L, 2142216990720814277L}).toString());
        int closedTableSize = Hashing.closedTableSize(i, 1.0d);
        this.size = 0;
    ...
    public K putInverse(@ParametricNullness V v, @ParametricNullness K k, boolean z) {
        ...
        if (z) {
            ...
            Preconditions.checkArgument(z2, new ObfuscatedString(new long[]{-1717261658738255283L, -7862738322724585273L, -4484497266504034734L, -493730792680291183L}).toString(), k);
        }
    ...
    public V put(@ParametricNullness K k, @ParametricNullness V v, boolean z) {
        ...
        if (!z) {
            Preconditions.checkArgument(findEntryByValue == -1, new ObfuscatedString(new long[]{8297142417282889246L, 6292330443678325627L, 3115330877903865994L, -3290715355810161641L, 8842642043709598068L}).toString(), v);
