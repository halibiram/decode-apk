...
public abstract class ImmutableBiMap<K, V> extends ImmutableMap<K, V> implements BiMap<K, V>, Map {
    ...
    public static final class Builder<K, V> extends ImmutableMap.Builder<K, V> {
        ...
        public ImmutableBiMap<K, V> buildKeepingLast() {
            throw new UnsupportedOperationException(new ObfuscatedString(new long[]{-6479693490044931236L, -1972407239479421595L, 2978677917542292567L, 1139759108703959915L}).toString());
        }
    ...
    public static <K, V> Builder<K, V> builderWithExpectedSize(int i) {
        CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{9095101324120402966L, -2317165693534765233L, 3685104513000691389L}).toString());
        return new Builder<>(i);
    }
    ...
    public final ImmutableSet<V> createValues() {
        throw new AssertionError(new ObfuscatedString(new long[]{7095937400488673321L, -6273233648950571602L, 4023775224861830797L, -173061097885372862L}).toString());
    }
