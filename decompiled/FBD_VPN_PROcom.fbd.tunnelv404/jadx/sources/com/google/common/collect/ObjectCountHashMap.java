...
public class ObjectCountHashMap<K> {
    ...
    public void init(int i, float f) {
        ...
        Preconditions.checkArgument(z, new ObfuscatedString(new long[]{-2353649452562588532L, 8026727715296328213L, -5660659604839077205L, -2045043412375849443L, -8501373510905009421L, -765692187939845395L}).toString());
        if (f > 0.0f) {
            z2 = true;
        }
        Preconditions.checkArgument(z2, new ObfuscatedString(new long[]{-7195856558458749869L, 289726000331828218L, 1994432190535762549L, -5154869364773141006L}).toString());
    ...
    public int put(@ParametricNullness K k, int i) {
        CollectPreconditions.checkPositive(i, new ObfuscatedString(new long[]{-6850878004418098333L, -7837605481113841599L}).toString());
        long[] jArr = this.entries;
        Object[] objArr = this.keys;
        int[] iArr = this.values;
        ...
        throw new IllegalStateException(new ObfuscatedString(new long[]{5165269022865672131L, 4875597570941353567L, -4326295251681078639L, -6538216546313389312L, -7544965041827504480L, 7985461967212354053L, 5794742136860306291L, -6394592442131357067L}).toString());
    }
