...
public final class Multisets {
    ...
    public static abstract class AbstractEntry<E> implements Multiset.Entry<E> {
        ...
        public String toString() {
            ...
            int count = getCount();
            if (count != 1) {
                return AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-3298883648310872285L, 525883765045864291L}), AbstractC0362x4440ab85.m2938x1aebc6d9(valueOf.length() + 14, valueOf), count);
            }
            return valueOf;
        }
    }
    ...
    public static final class FilteredMultiset<E> extends ViewMultiset<E> {
        ...
        public int add(@ParametricNullness E e, int i) {
            Preconditions.checkArgument(this.predicate.apply(e), new ObfuscatedString(new long[]{-4259510801594099428L, -2493348556126585008L, 8246081347978696378L, -275125230410588797L, -5664385334347677474L, -7873314908625273791L}).toString(), e, this.predicate);
        ...
        public Iterator<E> elementIterator() {
            throw new AssertionError(new ObfuscatedString(new long[]{-4448497205600030268L, 7040330017457708659L, -5477446732688599089L, 6059904129371711104L}).toString());
        }

        @Override // com.google.common.collect.AbstractMultiset
        public Iterator<Multiset.Entry<E>> entryIterator() {
            throw new AssertionError(new ObfuscatedString(new long[]{-5433083842343249315L, -7533527607873415724L, 9014341405009521431L, -398565548232416778L}).toString());
        }

        @Override // com.google.common.collect.AbstractMultiset, com.google.common.collect.Multiset
        public int remove(@CheckForNull Object obj, int i) {
            CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{-7109511479843576658L, 3638567343302984795L, 9037279317697225888L}).toString());
            if (i == 0) {
                return count(obj);
            }
            if (contains(obj)) {
    ...
    public static class ImmutableEntry<E> extends AbstractEntry<E> implements Serializable {
        ...
        public ImmutableEntry(@ParametricNullness E e, int i) {
            this.element = e;
            this.count = i;
            CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{8958572457855826223L, 3738943009621410421L}).toString());
        }
    ...
    public static class UnmodifiableMultiset<E> extends ForwardingMultiset<E> implements Serializable {
        ...
        public Set<Multiset.Entry<E>> entrySet() {
            ...
            if (set == null) {
                Set<Multiset.Entry<E>> unmodifiableSet = DesugarCollections.unmodifiableSet(this.delegate.entrySet());
    ...
    public static <E> Multiset<E> intersection(final Multiset<E> multiset, final Multiset<?> multiset2) {
        ...
        return new ViewMultiset<E>() { // from class: com.google.common.collect.Multisets.2
            ...
            @Override // com.google.common.collect.AbstractMultiset
            public Iterator<E> elementIterator() {
                throw new AssertionError(new ObfuscatedString(new long[]{-4082412378816887999L, -7213434951560307332L, -1137459680421665536L, -4728471919402109699L}).toString());
            }
    ...
    public static <E> int setCountImpl(Multiset<E> multiset, @ParametricNullness E e, int i) {
        CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{-3859868318433450987L, 7141343688325877526L}).toString());
    ...
    public static <E> Multiset<E> sum(final Multiset<? extends E> multiset, final Multiset<? extends E> multiset2) {
        ...
        return new ViewMultiset<E>() { // from class: com.google.common.collect.Multisets.3
            ...
            @Override // com.google.common.collect.AbstractMultiset
            public Iterator<E> elementIterator() {
                throw new AssertionError(new ObfuscatedString(new long[]{-1435785779600015110L, -8083729369058763615L, -6496914449102032538L, 5955092548543330944L}).toString());
            }
    ...
    public static <E> Multiset<E> union(final Multiset<? extends E> multiset, final Multiset<? extends E> multiset2) {
        ...
        return new ViewMultiset<E>() { // from class: com.google.common.collect.Multisets.1
            ...
            @Override // com.google.common.collect.AbstractMultiset
            public Iterator<E> elementIterator() {
                throw new AssertionError(new ObfuscatedString(new long[]{-246499972155101313L, 3575713571116015767L, 5458497127067617949L, -3514422695119742030L}).toString());
            }
    ...
    public static <E> boolean setCountImpl(Multiset<E> multiset, @ParametricNullness E e, int i, int i2) {
        CollectPreconditions.checkNonnegative(i, new ObfuscatedString(new long[]{-746099451824478181L, 5625967947063131696L}).toString());
        CollectPreconditions.checkNonnegative(i2, new ObfuscatedString(new long[]{4596985887505416687L, -2967187145196712405L}).toString());
