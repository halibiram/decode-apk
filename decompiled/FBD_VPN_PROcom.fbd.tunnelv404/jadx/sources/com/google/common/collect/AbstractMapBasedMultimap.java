...
public abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    public class AsMap extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        public class AsMapIterator implements Iterator<Map.Entry<K, Collection<V>>> {
            ...
            public void remove() {
                ...
                Preconditions.checkState(z, new ObfuscatedString(new long[]{-4197729491328463532L, -3174148825552033653L, 7526637184113024629L, -197808256690086522L, -5635034496578130047L, 2488555579196269716L, 8327505168959830671L, 6093158515292643714L}).toString());
        ...
        public Iterator<K> iterator() {
            ...
            return new Iterator<K>() { // from class: com.google.common.collect.AbstractMapBasedMultimap.KeySet.1
                ...
                public void remove() {
                    ...
                    Preconditions.checkState(z, new ObfuscatedString(new long[]{3447299589712501113L, -6104010860794483355L, 7800690545557674902L, 4829844545977601588L, -860782921845807303L, 1949208516114426577L, -2500856832825919445L, 1025826333769581650L}).toString());
    ...
    public boolean put(@ParametricNullness K k, @ParametricNullness V v) {
        ...
        if (collection == null) {
            ...
            throw new AssertionError(new ObfuscatedString(new long[]{-3866518737306005602L, -6493110587959299393L, -219710298920238266L, -1856063629023204239L, 1843299107443044144L, -3098146610646979333L, 1863918762285426815L}).toString());
        }
        if (collection.add(v)) {
            this.totalSize++;
            return true;
