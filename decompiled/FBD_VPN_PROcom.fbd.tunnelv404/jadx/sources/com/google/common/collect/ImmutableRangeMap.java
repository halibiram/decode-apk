...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    ...
    public static final class Builder<K extends Comparable<?>, V> {
            ...
            for (int i = 0; i < this.entries.size(); i++) {
                ...
                if (i > 0) {
                    ...
                    if (key.isConnected(key2) && !key.intersection(key2).isEmpty()) {
                        ...
                        sb.append(new ObfuscatedString(new long[]{-876221357826136431L, 5986644838772242000L, 2437452541594662178L, 8325272212879053281L, 745515193148326325L}).toString());
                        sb.append(valueOf);
                        throw new IllegalArgumentException(AbstractC0749x8313616e.m3336x1aebc6d9(new ObfuscatedString(new long[]{4025647752792020676L, -6056370042678825366L, -1543431799075051651L, -6785679101275791806L}), sb, valueOf2));
                    }
                }
        ...
        public Builder<K, V> put(Range<K> range, V v) {
            ...
            Preconditions.checkArgument(!range.isEmpty(), new ObfuscatedString(new long[]{7628602796971583233L, 6593681765559549504L, 1950487806301043794L, -2219253274478587971L, -7386266380786835553L, -6133870424889407599L}).toString(), range);
