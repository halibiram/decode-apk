...
public class HashBasedTable<R, C, V> extends StandardTable<R, C, V> {
    ...
    public static <R, C, V> HashBasedTable<R, C, V> create(int i, int i2) {
        CollectPreconditions.checkNonnegative(i2, new ObfuscatedString(new long[]{4791408870591681464L, 1185128014297477354L, -4599451712339189292L, 742766882164149386L}).toString());
