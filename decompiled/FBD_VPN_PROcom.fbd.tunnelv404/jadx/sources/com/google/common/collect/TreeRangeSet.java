...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    public final class SubRangeSet extends TreeRangeSet<C> {
        ...
        */
        ...
        @Override // com.google.common.collect.TreeRangeSet, com.google.common.collect.AbstractRangeSet, com.google.common.collect.RangeSet
        public void add(Range<C> range) {
            Preconditions.checkArgument(this.restriction.encloses(range), new ObfuscatedString(new long[]{-5835039823101645081L, 4593109660810538762L, -7764187245981106576L, 1998508149381145954L, -4806308194598608450L, -8312174932240646825L}).toString(), range, this.restriction);
            TreeRangeSet.this.add(range);
        }
