...
public class Hex {
    ...
    public static byte[] stringToBytes(@NonNull String str) {
        ...
        throw new IllegalArgumentException(new ObfuscatedString(new long[]{-2382223125665524853L, 1059681692549249323L, -6132949148234660217L, 3284991921222039692L, 2733879986910721928L, -7212966883283894152L}).toString());
    }
