...
public class SupportErrorDialogFragment extends DialogFragment {
    ...
    public static SupportErrorDialogFragment newInstance(@NonNull Dialog dialog, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog dialog2 = (Dialog) Preconditions.checkNotNull(dialog, new ObfuscatedString(new long[]{6989346641762482851L, -7070603449288424193L, -8985943163914597012L, -6646970602176132190L, 827963497102905144L}).toString());
