...
public final class ArrayUtils {
    ...
    public static void writeArray(@NonNull StringBuilder sb, @NonNull double[] dArr) {
        ...
        for (int i = 0; i < length; i++) {
            if (i != 0) {
                sb.append(new ObfuscatedString(new long[]{-1628816589306737176L, -7077777406436100339L}).toString());
            }
            sb.append(dArr[i]);
        }
    }
    ...
    public static void writeStringArray(@NonNull StringBuilder sb, @NonNull String[] strArr) {
        ...
        for (int i = 0; i < length; i++) {
            if (i != 0) {
                sb.append(new ObfuscatedString(new long[]{1232987046981743385L, 1927122798704625084L}).toString());
            }
            sb.append(new ObfuscatedString(new long[]{-799629577434920276L, 7564280126730390572L}).toString());
            sb.append(strArr[i]);
            sb.append(new ObfuscatedString(new long[]{3598463071080185385L, 3124498278362703569L}).toString());
        }
    }
    ...
    public static void writeArray(@NonNull StringBuilder sb, @NonNull float[] fArr) {
        ...
        for (int i = 0; i < length; i++) {
            if (i != 0) {
                sb.append(new ObfuscatedString(new long[]{921972658300008059L, 7053645232902093908L}).toString());
            }
            sb.append(fArr[i]);
        }
    }
    ...
    public static void writeArray(@NonNull StringBuilder sb, @NonNull int[] iArr) {
        ...
        for (int i = 0; i < length; i++) {
            if (i != 0) {
                sb.append(new ObfuscatedString(new long[]{4643378708225077056L, -7943734730283112174L}).toString());
            }
            sb.append(iArr[i]);
        }
    }
    ...
    public static void writeArray(@NonNull StringBuilder sb, @NonNull long[] jArr) {
        ...
        for (int i = 0; i < length; i++) {
            if (i != 0) {
                sb.append(new ObfuscatedString(new long[]{-6928778978949568961L, 7307729622582317281L}).toString());
            }
            sb.append(jArr[i]);
        }
    }
    ...
    public static <T> void writeArray(@NonNull StringBuilder sb, @NonNull T[] tArr) {
        ...
        for (int i = 0; i < length; i++) {
            if (i != 0) {
                sb.append(new ObfuscatedString(new long[]{7875673289307335693L, 5281340476000431450L}).toString());
            }
            sb.append(tArr[i]);
        }
    }
    ...
    public static void writeArray(@NonNull StringBuilder sb, @NonNull boolean[] zArr) {
        ...
        for (int i = 0; i < length; i++) {
            if (i != 0) {
                sb.append(new ObfuscatedString(new long[]{-5280853491814792769L, -880367273702306723L}).toString());
            }
            sb.append(zArr[i]);
        }
    }
