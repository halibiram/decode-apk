...
public final class zab implements Runnable {
    ...
    public final void run() {
        ...
        zak zakVar2;
        Map map7;
        Asserts.checkMainThread(new ObfuscatedString(new long[]{-6986608113890135064L, -5564396654055321543L, -2159398143820256681L, -1545144293974656362L, -8650196007297088230L, -8874057875730922459L, -4706118675766940261L, -570095875883795274L}).toString());
        map = this.zaa.zah;
