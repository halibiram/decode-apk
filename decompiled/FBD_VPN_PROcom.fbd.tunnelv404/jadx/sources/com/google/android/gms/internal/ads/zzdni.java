...
public interface zzdni {
    ...
    void zzk(View view, View view2, Map map, Map map2, boolean z, @Nullable ImageView.ScaleType scaleType);

    void zzl(String str);

    void zzm(Bundle bundle);

    void zzo(@Nullable View view, View view2, Map map, Map map2, boolean z, @Nullable ImageView.ScaleType scaleType, int i);
