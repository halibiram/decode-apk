...
public final class zzlx {
    ...
    public final void zzg(@Nullable zzhy zzhyVar) {
        zzek.zzf(!this.zzj);
        this.zzk = zzhyVar;
    ...
    public final void zzh() {
        for (zzlu zzluVar : this.zzf.values()) {
            try {
                ...
                zzff.zzd(new ObfuscatedString(new long[]{534593709825740003L, 7357763796314638342L, 8159246359799297106L}).toString(), new ObfuscatedString(new long[]{1438012779903346410L, -1033695200842280271L, 1877554547137237324L, 3326215389560035401L, -638388260149644799L}).toString(), e);
            }
            zzluVar.zza.zzs(zzluVar.zzc);
            zzluVar.zza.zzr(zzluVar.zzc);
        }
        ...
        if (!list.isEmpty()) {
            ...
            for (int i2 = i; i2 < list.size() + i; i2++) {
                ...
                if (i2 > 0) {
                    ...
                    zzlvVar.zzc(zzlvVar2.zza.zzC().zzc() + zzlvVar2.zzd);
                } else {
                    zzlvVar.zzc(0);
                }
                zzr(i2, zzlvVar.zza.zzC().zzc());
