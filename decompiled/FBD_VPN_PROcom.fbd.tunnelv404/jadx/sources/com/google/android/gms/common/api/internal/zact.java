...
public final class zact extends com.google.android.gms.signin.internal.zac implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public zact(Context context, Handler handler, @NonNull ClientSettings clientSettings) {
        ...
        this.zab = context;
        this.zac = handler;
        this.zaf = (ClientSettings) Preconditions.checkNotNull(clientSettings, new ObfuscatedString(new long[]{-8809688301626543552L, 4898791697970185531L, -184488685304909435L, -7726670272868995037L, 3999948658375450142L}).toString());
    ...
    public static /* bridge */ /* synthetic */ void zad(zact zactVar, com.google.android.gms.signin.internal.zak zakVar) {
        ...
        if (zaa2.isSuccess()) {
            ...
            if (!zaa3.isSuccess()) {
                ...
                Log.wtf(new ObfuscatedString(new long[]{6304772806378737963L, 6190008149877155263L, 6889892689165891889L, -2007613491831981272L}).toString(), new ObfuscatedString(new long[]{6197823831186797717L, -977173577533437074L, 4849041400754299577L, 8245114554017061144L, -9198828235005376686L, 6291180560174195653L, -3759024834189252024L}).toString().concat(valueOf), new Exception());
