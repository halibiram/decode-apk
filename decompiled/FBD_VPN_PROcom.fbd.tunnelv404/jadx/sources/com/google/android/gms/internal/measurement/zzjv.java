...
final class zzjv extends zzim implements RandomAccess, zzkj, zzlq {
    ...
    private final String zzf(int i) {
        ...
        sb.append(new ObfuscatedString(new long[]{8160836599770508719L, 4459997153000981750L}).toString());
        sb.append(i);
        return AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{1323150690613862196L, -1084773207860705669L}), sb, i2);
    }
    ...
    public final /* synthetic */ void add(int i, Object obj) {
        ...
        if (i >= 0 && i <= (i2 = this.zzc)) {
            ...
            if (i2 < fArr.length) {
                ...
                float[] fArr2 = new float[AbstractC0749x8313616e.m3323xfbe0c504(i2, 3, 2, 1)];
    ...
    public final void removeRange(int i, int i2) {
        ...
        throw new IndexOutOfBoundsException(new ObfuscatedString(new long[]{2015189036618425401L, 7345655136440298851L, -9114580025959970779L, -7407806840703006732L}).toString());
    }
    ...
    public final void zze(float f) {
        ...
        float[] fArr = this.zzb;
        if (i == fArr.length) {
            float[] fArr2 = new float[AbstractC0749x8313616e.m3323xfbe0c504(i, 3, 2, 1)];
            System.arraycopy(fArr, 0, fArr2, 0, i);
            this.zzb = fArr2;
        }
