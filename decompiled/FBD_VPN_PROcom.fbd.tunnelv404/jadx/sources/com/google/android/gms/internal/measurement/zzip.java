...
public final class zzip {
    public static int zza(byte[] bArr, int i, zzio zzioVar) {
    ...
    public static int zzc(zzlu zzluVar, byte[] bArr, int i, int i2, int i3, zzio zzioVar) {
    ...
    public static int zzd(zzlu zzluVar, byte[] bArr, int i, int i2, zzio zzioVar) {
        int i3 = i + 1;
        int i4 = bArr[i];
        if (i4 < 0) {
    ...
    public static int zze(zzlu zzluVar, int i, byte[] bArr, int i2, int i3, zzkj zzkjVar, zzio zzioVar) {
    ...
    public static int zzf(byte[] bArr, int i, zzkj zzkjVar, zzio zzioVar) {
    ...
    public static int zzg(byte[] bArr, int i, zzio zzioVar) {
        int zzj = zzj(bArr, i, zzioVar);
        int i2 = zzioVar.zza;
        if (i2 >= 0) {
            if (i2 == 0) {
                zzioVar.zzc = new ObfuscatedString(new long[]{-2836399159787845039L}).toString();
                return zzj;
            }
    ...
    public static int zzh(byte[] bArr, int i, zzio zzioVar) {
        int zzj = zzj(bArr, i, zzioVar);
        int i2 = zzioVar.zza;
        if (i2 >= 0) {
            if (i2 == 0) {
                zzioVar.zzc = new ObfuscatedString(new long[]{1978234410092194909L}).toString();
                return zzj;
            }
    ...
    public static int zzi(int i, byte[] bArr, int i2, int i3, zzmm zzmmVar, zzio zzioVar) {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 != 0) {
                if (i4 != 1) {
                    if (i4 != 2) {
                        ...
                        while (true) {
                            ...
                            i6 = i7;
                            i2 = zzi(i7, bArr, zzj, i3, zze, zzioVar);
                        }
                        if (i2 <= i3 && i6 == i5) {
                            zzmmVar.zzh(i, zze);
                            return i2;
                    ...
                    if (i8 >= 0) {
                        if (i8 <= bArr.length - zzj2) {
                            if (i8 == 0) {
                                ...
                                zzmmVar.zzh(i, zzjb.zzl(bArr, zzj2, i8));
                            }
                            return zzj2 + i8;
                        }
                        throw zzkm.zzf();
