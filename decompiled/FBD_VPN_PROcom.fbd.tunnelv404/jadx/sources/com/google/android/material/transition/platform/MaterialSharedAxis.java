    ...
    private static VisibilityAnimatorProvider createPrimaryAnimatorProvider(int i, boolean z) {
        ...
        if (i != 0) {
            if (i != 1) {
                ...
                throw new IllegalArgumentException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{-4029239969195097464L, 3288224094996893187L, 4071156536327442655L}), new StringBuilder(), i));
            }
            if (z) {
                i3 = 80;
            } else {
