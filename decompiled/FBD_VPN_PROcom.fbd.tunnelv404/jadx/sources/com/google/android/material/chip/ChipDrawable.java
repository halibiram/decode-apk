...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final String NAMESPACE_APP = new ObfuscatedString(new long[]{8566875327801285133L, 3047163188718205681L, 579320261242342992L, 532041816842975290L, 8443162190625343826L, 5261221061945805311L}).toString();
    ...
    private ChipDrawable(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        this.text = new ObfuscatedString(new long[]{2107640189208150002L}).toString();
    ...
    public static ChipDrawable createFromResource(@NonNull Context context, @XmlRes int i) {
        AttributeSet parseDrawableXml = DrawableUtils.parseDrawableXml(context, i, new ObfuscatedString(new long[]{-3221809064761828929L, 7894980679561391157L}).toString());
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i2) {
        ...
        if (attributeSet != null && attributeSet.getAttributeValue(new ObfuscatedString(new long[]{374063915679798651L, 7456257302046394327L, -974944999231145328L, 5276514716438484287L, 5990942382970658487L, -8117992753352155145L}).toString(), new ObfuscatedString(new long[]{-2740238941792674104L, -1313509301360595354L, -8701055506489294870L}).toString()) != null && attributeSet.getAttributeValue(new ObfuscatedString(new long[]{7461357314787635231L, -7389692021579765400L, 8169700247281718752L, 2939669736724252467L, -7003470739374751866L, 9076454368910125266L}).toString(), new ObfuscatedString(new long[]{3199653099947345026L, -1673301399622814880L, 566301386849690109L}).toString()) == null) {
        ...
        if (attributeSet != null && attributeSet.getAttributeValue(new ObfuscatedString(new long[]{445008722925438277L, 2338724201972614674L, 7664893148225544778L, -5819233679933704226L, 3532165506134086475L, -8290933894585182550L}).toString(), new ObfuscatedString(new long[]{-6328870838710171038L, -1462694890076818L, 1459562730299735414L}).toString()) != null && attributeSet.getAttributeValue(new ObfuscatedString(new long[]{-5114730369550977724L, -3023698321757833061L, -6576678746519749153L, 8183585673435463751L, -8818349109483282063L, 5544363085132871918L}).toString(), new ObfuscatedString(new long[]{6501660006445768883L, -7802794504549080154L, 8971043119199913040L}).toString()) == null) {
        ...
        if (attributeSet != null && attributeSet.getAttributeValue(new ObfuscatedString(new long[]{-5346583408666931757L, 4137564250522870777L, 7176507481011982255L, -1213626249106953777L, 4752575310087812304L, -87512903837463108L}).toString(), new ObfuscatedString(new long[]{2731368222180138749L, -8175053694123949030L, -6915230296686252405L, -8355028167914201954L}).toString()) != null && attributeSet.getAttributeValue(new ObfuscatedString(new long[]{6372035027985293390L, -421315519140453159L, 5455223469230629559L, 2076088708924342179L, 5735631225814626065L, -2513057066952802025L}).toString(), new ObfuscatedString(new long[]{-4979303996340210148L, -1904975091979232179L, -8200183522363596642L, 5658909829110299476L}).toString()) == null) {
    ...
    public void setText(@Nullable CharSequence charSequence) {
        if (charSequence == null) {
            charSequence = new ObfuscatedString(new long[]{-1427832479052072619L}).toString();
        }
