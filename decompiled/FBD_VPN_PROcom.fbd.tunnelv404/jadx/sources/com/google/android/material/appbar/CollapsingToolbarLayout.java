    ...
    */
    public CollapsingToolbarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (obtainStyledAttributes.hasValue(i9)) {
            setTitleEllipsize(convertEllipsizeToTruncateAt(obtainStyledAttributes.getInt(i9, -1)));
        }
        int i10 = R.styleable.CollapsingToolbarLayout_expandedTitleTextColor;
        if (obtainStyledAttributes.hasValue(i10)) {
            collapsingTextHelper.setExpandedTextColor(MaterialResources.getColorStateList(context2, obtainStyledAttributes, i10));
        }
        int i11 = R.styleable.CollapsingToolbarLayout_collapsedTitleTextColor;
        if (obtainStyledAttributes.hasValue(i11)) {
            collapsingTextHelper.setCollapsedTextColor(MaterialResources.getColorStateList(context2, obtainStyledAttributes, i11));
        }
        ...
        if (obtainStyledAttributes.hasValue(i12)) {
            collapsingTextHelper.setMaxLines(obtainStyledAttributes.getInt(i12, 1));
        }
        int i13 = R.styleable.CollapsingToolbarLayout_titlePositionInterpolator;
        if (obtainStyledAttributes.hasValue(i13)) {
            collapsingTextHelper.setPositionInterpolator(android.view.animation.AnimationUtils.loadInterpolator(context2, obtainStyledAttributes.getResourceId(i13, 0)));
        }
