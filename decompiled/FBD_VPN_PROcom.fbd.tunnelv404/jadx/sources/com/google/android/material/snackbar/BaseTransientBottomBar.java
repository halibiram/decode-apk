...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public void updateMargins() {
        ...
        ViewGroup.LayoutParams layoutParams = this.view.getLayoutParams();
        if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
            new ObfuscatedString(new long[]{7324332285330621992L, 851601544258350847L, 7144937338697510157L, -2530908046203873743L, 1870356867681872045L, 6966730061822102713L, -5288547275796294153L, 6233461105945712764L, -1212733168612299807L, -6677992981747560983L, 7608743370288649079L}).toString();
            return;
        }
        if (this.view.originalMargins == null) {
            new ObfuscatedString(new long[]{3316907617530792226L, 814921882620432750L, 4404122203185640892L, 6410840364011589802L, 2479999491676141255L, 1436568811263912216L, 2369725232321436609L, -3715062073972115790L, -7435168030292466014L, -7810100557852237388L}).toString();
            return;
        }
        if (this.view.getParent() == null) {
            return;
    ...
    */
    ...
    public BaseTransientBottomBar(@NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull View view, @NonNull com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
            ...
            public void run() {
                ...
                if (baseTransientBottomBar.view != null && baseTransientBottomBar.context != null) {
                    ...
                    if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
                        ...
                        new ObfuscatedString(new long[]{-7158449702866971444L, -7036676471993191151L, -8959286813711616028L, 5804874458095345034L, 2210070312259098539L, -7879731569136791415L, 8573166525120985076L, 5362544538313190126L, -6267569592499180761L, 3453770587999862353L, -1846046360933870436L}).toString();
                        return;
                    }
        ...
        if (viewGroup == null) {
            throw new IllegalArgumentException(new ObfuscatedString(new long[]{-7695227129727555773L, 1482768855001042357L, 2616435980088282159L, -5459808605916377597L, 42790142153787999L, 6814459784160423653L, 6109648880321792375L}).toString());
        }
        if (view == null) {
            throw new IllegalArgumentException(new ObfuscatedString(new long[]{-2212262298254440688L, -162902959282433473L, -4146233294556095477L, 5264207476811082867L, 3501695445366098179L, 7615353641980658251L, -7958564909028656066L}).toString());
        }
        if (contentViewCallback != null) {
            ...
            this.accessibilityManager = (AccessibilityManager) context.getSystemService(new ObfuscatedString(new long[]{5462206997319327835L, -3757556156532500983L, 1442395140398239586L}).toString());
            int i = R.attr.motionDurationLong2;
            this.animationSlideDuration = MotionUtils.resolveThemeDuration(context, i, 250);
            this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context, i, DEFAULT_ANIMATION_FADE_IN_DURATION);
        ...
        throw new IllegalArgumentException(new ObfuscatedString(new long[]{-3111714807336315097L, 942159885627250432L, -2610293120309909480L, 1082597070352519222L, -2318391029096684195L, 1362056243928147009L, 3914535839905214746L}).toString());
    }
    ...
    public B setAnchorView(@IdRes int i) {
        ...
        throw new IllegalArgumentException(AbstractC0749x8313616e.m3333x1db10c9d(new ObfuscatedString(new long[]{6816510158978622135L, 401148323849724003L, 3034733598378148634L, -5073062202780794084L, -860615393543671315L, -2994549155185393199L}), new StringBuilder(), i));
    }
}
