...
public class LinearProgressIndicator extends BaseProgressIndicator<LinearProgressIndicatorSpec> {
    ...
    public void setIndeterminateAnimationType(int i) {
        ...
        if (visibleToUser() && isIndeterminate()) {
            throw new IllegalStateException(new ObfuscatedString(new long[]{-6731801090045630411L, -4785198662885572624L, 3764694415908064031L, 5776846408523664450L, 2444737771305972681L, -3755441490786020909L, 5101172857371601235L, 2659584719768122960L, 390997666932031075L, -2454443346317087319L, -7392898461585965267L, -81848041822441768L, -1841143326110729497L, -1224293607742836540L}).toString());
        }
        S s = this.spec;
