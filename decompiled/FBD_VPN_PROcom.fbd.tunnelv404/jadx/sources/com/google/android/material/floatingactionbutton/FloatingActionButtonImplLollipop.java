...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    private StateListAnimator createDefaultStateListAnimator(float f, float f2, float f3) {
        ...
        arrayList.add(ObjectAnimator.ofFloat(this.view, new ObfuscatedString(new long[]{589546780914147492L, -5979612933704571935L, 5376080036351839083L}).toString(), f).setDuration(0L));
    ...
    private Animator createElevationAnimator(float f, float f2) {
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.play(ObjectAnimator.ofFloat(this.view, new ObfuscatedString(new long[]{4557426757648094252L, 698862052425061685L, -1155949582982686163L}).toString(), f).setDuration(0L)).with(ObjectAnimator.ofFloat(this.view, (Property<FloatingActionButton, Float>) View.TRANSLATION_Z, f2).setDuration(100L));
        animatorSet.setInterpolator(FloatingActionButtonImpl.ELEVATION_ANIM_INTERPOLATOR);
        return animatorSet;
    }
