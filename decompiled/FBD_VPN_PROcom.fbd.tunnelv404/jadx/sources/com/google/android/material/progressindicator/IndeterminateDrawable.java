    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (!getBounds().isEmpty() && isVisible() && canvas.getClipBounds(rect)) {
            ...
            if (i == 0) {
                ...
                DrawingDelegate.ActiveIndicator activeIndicator2 = (DrawingDelegate.ActiveIndicator) AbstractC0362x4440ab85.m2928x75d576dc(1, this.animatorDelegate.activeIndicators);
