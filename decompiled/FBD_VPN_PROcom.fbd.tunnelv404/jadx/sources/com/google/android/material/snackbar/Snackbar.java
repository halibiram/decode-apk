...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private Snackbar(@NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull View view, @NonNull ContentViewCallback contentViewCallback) {
        ...
        this.accessibilityManager = (AccessibilityManager) viewGroup.getContext().getSystemService(new ObfuscatedString(new long[]{1662716611877683618L, -987886469046199951L, -269926273403661840L}).toString());
    }
    ...
    private static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        throw new IllegalArgumentException(new ObfuscatedString(new long[]{-4595972140134302605L, 4671422383389894458L, -2730403181589826932L, -5111851156025578514L, 6284410856522154827L, 5318711340869405385L, 1637077597869611945L, 839390083432555574L, -6990491776400633467L, -2189703123646409541L, 5374741687552436399L}).toString());
    }
    ...
    public Snackbar setAction(@Nullable CharSequence charSequence, @Nullable View.OnClickListener onClickListener) {
        ...
        if (!TextUtils.isEmpty(charSequence) && onClickListener != null) {
            ...
            actionView.setOnClickListener(new ViewOnClickListenerC0382x306fc053(this, onClickListener, 4));
        } else {
