...
public final class IndicatorViewController {
    ...
    public IndicatorViewController(@NonNull TextInputLayout textInputLayout) {
        ...
        this.captionFadeOutAnimationDuration = MotionUtils.resolveThemeDuration(context, i, DEFAULT_CAPTION_FADE_ANIMATION_DURATION);
    ...
    public void hideError() {
        ...
        updateCaptionViewsVisibility(this.captionDisplayed, this.captionToShow, shouldAnimateCaptionView(this.errorView, new ObfuscatedString(new long[]{112139422557895801L}).toString()));
    }
    ...
    public void hideHelperText() {
        ...
        updateCaptionViewsVisibility(i, this.captionToShow, shouldAnimateCaptionView(this.helperTextView, new ObfuscatedString(new long[]{-3657205748671431748L}).toString()));
    }
