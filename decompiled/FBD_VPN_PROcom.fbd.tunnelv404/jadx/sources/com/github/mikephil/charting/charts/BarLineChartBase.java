...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    public void calculateOffsets() {
        if (!this.mCustomViewPortEnabled) {
            ...
            if (this.mXAxis.isEnabled() && this.mXAxis.isDrawLabelsEnabled()) {
                float yOffset = this.mXAxis.getYOffset() + r3.mLabelRotatedHeight;
            ...
            if (this.mLogEnabled) {
                new ObfuscatedString(new long[]{-1288817324574913787L, 4778858210804847092L, -8347031535469619576L}).toString();
                new ObfuscatedString(new long[]{4713566896191008576L, 2811184299327649081L, -8480329189290937912L}).toString();
                new ObfuscatedString(new long[]{-6054209272790983012L, 3843899368142023928L, -3187934911517641112L}).toString();
                new ObfuscatedString(new long[]{1532155640657913520L, -7051624751889133177L, 3748858895018433331L}).toString();
                new ObfuscatedString(new long[]{319353087528858449L, -8206049581337054354L, 5274563025955004205L}).toString();
                new ObfuscatedString(new long[]{-1060670178152283662L, 5912888626332650554L, 6447952421324158446L}).toString();
                new ObfuscatedString(new long[]{370874749812001257L, -2338912407446741769L, 8454081342914535889L}).toString();
    ...
    public void notifyDataSetChanged() {
        if (this.mData == 0) {
            if (this.mLogEnabled) {
                new ObfuscatedString(new long[]{-8777603332819710902L, -2948787203256283309L, 7887152445476643531L}).toString();
                new ObfuscatedString(new long[]{-1230463682495887999L, 120442460391415460L, 776537536420172887L, 3159215558405527263L, 1388165455378465283L}).toString();
                return;
            }
            return;
        }
        if (this.mLogEnabled) {
            new ObfuscatedString(new long[]{1729222048483256627L, 8847843444408701395L, -7569545350822041372L}).toString();
            new ObfuscatedString(new long[]{537418533516911001L, -4582476520007810438L, 8194059209511020058L}).toString();
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mLogEnabled) {
            ...
            new ObfuscatedString(new long[]{774887485960522443L, 2127560623723084235L, 4282729910322885479L}).toString();
            new ObfuscatedString(new long[]{562192506235386531L, -4789831246184259684L, 6036033304597483148L}).toString();
            new ObfuscatedString(new long[]{2830014975924271092L, -1311932100542497179L, 4632751828338457788L}).toString();
            new ObfuscatedString(new long[]{6628847728655334170L, 6960142832979688931L, 6038988171503912264L}).toString();
        }
    }
    ...
    public void prepareValuePxMatrix() {
        if (this.mLogEnabled) {
            new ObfuscatedString(new long[]{-7934179175551422826L, -3718335913792775856L, -4851898155023024642L}).toString();
            new ObfuscatedString(new long[]{8030836366130057706L, -8041188762758536178L, 4260762022936661064L, 8515616822954751000L, 6295880200309308166L, -1576981483439336903L}).toString();
            float f = this.mXAxis.mAxisMinimum;
            new ObfuscatedString(new long[]{8829270740879438550L, 3273724319341868528L}).toString();
            float f2 = this.mXAxis.mAxisMaximum;
            new ObfuscatedString(new long[]{8852290402184636083L, 6917327764838812289L, 5014027275524408261L}).toString();
