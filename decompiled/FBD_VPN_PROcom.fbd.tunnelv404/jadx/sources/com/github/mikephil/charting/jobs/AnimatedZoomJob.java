...
public class AnimatedZoomJob extends AnimatedViewPortJob implements Animator.AnimatorListener {
    ...
    public void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        float m2925xfbe0c504 = AbstractC0362x4440ab85.m2925xfbe0c504(this.yValue, f5, f3, f5);
        Matrix matrix = this.mOnAnimationUpdateMatrixBuffer;
        this.mViewPortHandler.setZoom(f4, m2925xfbe0c504, matrix);
        ...
        float f7 = (this.zoomCenterX - (scaleX / 2.0f)) - f6;
        float f8 = this.phase;
        fArr[0] = (f7 * f8) + f6;
        float f9 = this.zoomOriginY;
        fArr[1] = ((((scaleY / 2.0f) + this.zoomCenterY) - f9) * f8) + f9;
