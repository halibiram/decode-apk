...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public Node<K, V> find(K k, boolean z) {
        ...
        if (node4 != null) {
            ...
            while (true) {
                if (comparable != null) {
                    ...
                    compare = comparator.compare(k, node4.key);
                }
                if (compare == 0) {
                    return node4;
                }
        ...
        if (node == null) {
            if (comparator == NATURAL_ORDER && !(k instanceof Comparable)) {
                ...
                throw new ClassCastException(AbstractC0749x8313616e.m3332x9d12c1f4(new ObfuscatedString(new long[]{2171504737249890797L, 529323142522129336L, -7807934013130034033L, 2294960059027837859L}), sb));
            }
    ...
    public V put(K k, V v) {
        ...
        throw new NullPointerException(new ObfuscatedString(new long[]{5191240285821710709L, -764848971571082146L, 7607742381516258804L}).toString());
    }
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public String toString() {
            return this.key + new ObfuscatedString(new long[]{1022852312170528100L, -5967912138553648650L}).toString() + this.value;
        }
