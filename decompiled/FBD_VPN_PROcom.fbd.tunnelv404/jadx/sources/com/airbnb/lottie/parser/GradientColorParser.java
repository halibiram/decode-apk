...
public class GradientColorParser implements ValueParser<GradientColor> {
    ...
    private int getColorInBetweenOpacityStops(float f, int i, float[] fArr, float[] fArr2) {
        ...
        if (fArr2.length >= 2 && f > fArr[0]) {
            ...
            throw new IllegalArgumentException(new ObfuscatedString(new long[]{-9132579718161974438L, -705607178480788587L, -8470010312270184868L, -8157773252072227898L}).toString());
        }
    ...
    public int getColorInBetweenColorStops(float f, float f2, float[] fArr, int[] iArr) {
        if (iArr.length >= 2 && f != fArr[0]) {
            ...
            throw new IllegalArgumentException(new ObfuscatedString(new long[]{166432703356377090L, -7820085633799959653L, -7165768974982511766L, 8098959912819577742L}).toString());
        }
        return iArr[0];
    }
