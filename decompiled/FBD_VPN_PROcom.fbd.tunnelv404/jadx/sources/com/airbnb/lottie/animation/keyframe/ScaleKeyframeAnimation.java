...
public class ScaleKeyframeAnimation extends KeyframeAnimation<ScaleXY> {
    ...
    public ScaleXY getValue(Keyframe<ScaleXY> keyframe, float f) {
        ...
        throw new IllegalStateException(new ObfuscatedString(new long[]{3200453536238830018L, 6357144175497901988L, -7887166859278580821L, -1938413065752260588L, 6780740277704477053L}).toString());
    }
}
