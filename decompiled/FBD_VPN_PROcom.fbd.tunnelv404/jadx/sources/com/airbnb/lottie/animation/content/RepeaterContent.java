...
public class RepeaterContent implements DrawingContent, PathContent, GreedyContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public void absorbContent(ListIterator<Content> listIterator) {
        ...
        this.contentGroup = new ContentGroup(this.lottieDrawable, this.layer, new ObfuscatedString(new long[]{8664968461619303581L, 7171526514588234112L}).toString(), this.hidden, arrayList, null);
    }
    ...
    public void draw(Canvas canvas, Matrix matrix, int i, @Nullable DropShadow dropShadow) {
        ...
        for (int i2 = ((int) floatValue) - 1; i2 >= 0; i2--) {
            ...
            this.contentGroup.draw(canvas, this.matrix, (int) (MiscUtils.lerp(floatValue3, floatValue4, f / floatValue) * i), dropShadow);
        }
    }
