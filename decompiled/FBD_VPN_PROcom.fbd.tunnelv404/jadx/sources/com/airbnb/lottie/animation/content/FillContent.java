...
public class FillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public void draw(Canvas canvas, Matrix matrix, int i, @Nullable DropShadow dropShadow) {
        ...
        if (L.isTraceEnabled()) {
            L.beginSection(new ObfuscatedString(new long[]{7276630590003091413L, -4625325395947389272L, 4786013388401370001L}).toString());
        }
        ...
        if (L.isTraceEnabled()) {
            L.endSection(new ObfuscatedString(new long[]{3362171702740218734L, -4681842463247207406L, -1434477352389563768L}).toString());
        }
    }
