...
public class LottieValueAnimator extends BaseLottieAnimator implements Choreographer.FrameCallback {
    ...
    private void verifyFrame() {
        ...
        if (f >= this.minFrame && f <= this.maxFrame) {
            ...
            throw new IllegalStateException(String.format(new ObfuscatedString(new long[]{-5612308503473516106L, 311011276267168537L, -340389716754948834L, -8043151481857615433L, 328503169641189136L}).toString(), Float.valueOf(this.minFrame), Float.valueOf(this.maxFrame), Float.valueOf(this.frame)));
        }
    }
    ...
    public void doFrame(long j) {
        ...
        if (this.composition != null && isRunning()) {
            if (L.isTraceEnabled()) {
                L.beginSection(new ObfuscatedString(new long[]{-2397646697527143502L, -6810965475908655743L, -5015951942127222281L, 3881407935912635311L, 5088177307498458566L}).toString());
            }
            ...
            verifyFrame();
            if (L.isTraceEnabled()) {
                L.endSection(new ObfuscatedString(new long[]{8757453859444402793L, 7071186036134722363L, 7214811437850618333L, 6663769558151007818L, 3964680369241040880L}).toString());
            }
        }
    }
    ...
    public void setMinAndMaxFrames(float f, float f2) {
        ...
        throw new IllegalArgumentException(String.format(new ObfuscatedString(new long[]{8875647094145985010L, -7664091719458033209L, -8595443166041996182L, 2461923464738022126L, -9027848918976354157L, 7433607412003506337L}).toString(), Float.valueOf(f), Float.valueOf(f2)));
    }
