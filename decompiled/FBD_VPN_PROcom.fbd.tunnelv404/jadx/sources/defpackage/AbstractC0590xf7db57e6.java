...
/* renamed from: 됴뒛땣딽땣딽뎨되땍됫딞듔땍딃땔뎬땍뒐도둑돰돛됫됫땡딐둑딹돷듨뒷득뒼됐둔땜뒋땔딠디돛돠땹땩됴딌뒋땳돵딎돶뒨땬뎽듽돶땅뎹돠땔땐두뒻드땱딄돸땮뒛땤뒈땠딽땤된딀딹뒵뒾뎠돛뎬됐뎨돛딁뎸땨둥딃되뒘뒨땰됴듼땬땝땻땭뒷둡돠딠뒈땠됫뎡땋땹땠땳땮돰뒤땠땥뎰돷돶뒈뒐뒻땱딄둔뒤땦땰땠, reason: contains not printable characters */
/* loaded from: classes3.dex */
public abstract class AbstractC0590xf7db57e6 extends AbstractC0589xfe44cac1 {
    ...
    public static final boolean m3158x3271d0aa(Iterable iterable, Function1 function1, boolean z) {
    ...
    public static final boolean m3159x1378447b(List list, Function1 function1, boolean z) {
        int i;
        if (!(list instanceof RandomAccess)) {
            ...
            return m3158x3271d0aa(TypeIntrinsics.asMutableIterable(list), function1, z);
        }
    ...
    public static final <T> boolean removeAll(@NotNull Iterable<? extends T> iterable, @NotNull Function1<? super T, Boolean> predicate) {
        ...
        return m3158x3271d0aa(iterable, predicate, true);
    }
    ...
    public static final <T> boolean removeAll(@NotNull List<T> list, @NotNull Function1<? super T, Boolean> predicate) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(predicate, "predicate");
        return m3159x1378447b(list, predicate, true);
    }
