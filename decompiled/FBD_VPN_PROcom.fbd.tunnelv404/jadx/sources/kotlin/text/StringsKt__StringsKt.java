...
import defpackage.C0928x9d59db50;
import defpackage.C1198x2b7f96fc;
...
public abstract class StringsKt__StringsKt extends AbstractC1197x89633db9 {
    @NotNull
    public static final String commonPrefixWith(@NotNull CharSequence charSequence, @NotNull CharSequence other, boolean z) {
        ...
        int i = 0;
        while (i < min && AbstractC0576x6ced6b.equals(charSequence.charAt(i), other.charAt(i), z)) {
            i++;
        }
        int i2 = i - 1;
    ...
    public static final String commonSuffixWith(@NotNull CharSequence charSequence, @NotNull CharSequence other, boolean z) {
        ...
        int i = 0;
        while (i < min && AbstractC0576x6ced6b.equals(charSequence.charAt((length - i) - 1), other.charAt((r1 - i) - 1), z)) {
            i++;
        }
    ...
    public static boolean contains(@NotNull CharSequence charSequence, @NotNull CharSequence other, boolean z) {
        ...
        } else if (m2075x1378447b(charSequence, other, 0, charSequence.length(), z, false) < 0) {
            return false;
        }
        return true;
    }
    ...
    public static final boolean contentEqualsIgnoreCaseImpl(@Nullable CharSequence charSequence, @Nullable CharSequence charSequence2) {
        if ((charSequence instanceof String) && (charSequence2 instanceof String)) {
            return AbstractC1197x89633db9.equals((String) charSequence, (String) charSequence2, true);
        }
        ...
        for (int i = 0; i < length; i++) {
            if (!AbstractC0576x6ced6b.equals(charSequence.charAt(i), charSequence2.charAt(i), true)) {
                return false;
            }
        }
        return true;
    ...
    public static final boolean endsWith(@NotNull CharSequence charSequence, char c, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return charSequence.length() > 0 && AbstractC0576x6ced6b.equals(charSequence.charAt(getLastIndex(charSequence)), c, z);
    }
    ...
    public static final Pair<Integer, String> findAnyOf(@NotNull CharSequence charSequence, @NotNull Collection<String> strings, int i, boolean z) {
        ...
        return m2074x3271d0aa(charSequence, strings, i, z, false);
    }
    ...
    public static final Pair<Integer, String> findLastAnyOf(@NotNull CharSequence charSequence, @NotNull Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(strings, "strings");
        return m2074x3271d0aa(charSequence, strings, i, z, true);
    }
    ...
    public static final int indexOfAny(@NotNull CharSequence charSequence, @NotNull char[] chars, int i, boolean z) {
        ...
        int coerceAtLeast = AbstractC0296x1378447b.coerceAtLeast(i, 0);
        ...
        while (true) {
            ...
            for (char c : chars) {
                if (AbstractC0576x6ced6b.equals(c, charAt, z)) {
    ...
    public static boolean isBlank(@NotNull CharSequence charSequence) {
        ...
        for (int i = 0; i < charSequence.length(); i++) {
            if (!AbstractC0298xfbe0c504.isWhitespace(charSequence.charAt(i))) {
                return false;
            }
        }
        return true;
    ...
    public static final CharIterator iterator(@NotNull final CharSequence charSequence) {
        ...
        return new CharIterator() { // from class: kotlin.text.StringsKt__StringsKt$iterator$1
            ...
            public int f1687xfbe0c504;

            @Override // java.util.Iterator
            public boolean hasNext() {
                if (this.f1687xfbe0c504 < charSequence.length()) {
                    return true;
                }
                return false;
            }
            ...
            public char nextChar() {
                int i = this.f1687xfbe0c504;
                this.f1687xfbe0c504 = i + 1;
    ...
    public static final int lastIndexOfAny(@NotNull CharSequence charSequence, @NotNull char[] chars, int i, boolean z) {
        ...
        for (int coerceAtMost = AbstractC0296x1378447b.coerceAtMost(i, getLastIndex(charSequence)); -1 < coerceAtMost; coerceAtMost--) {
    ...
    public static final Sequence<String> lineSequence(@NotNull final CharSequence charSequence) {
        ...
        return new Sequence<String>() { // from class: kotlin.text.StringsKt__StringsKt$lineSequence$$inlined$Sequence$1
            ...
            public Iterator<String> iterator() {
                return new C0928x9d59db50(charSequence);
            }
        };
    }
    ...
    public static final CharSequence padEnd(@NotNull CharSequence charSequence, int i, char c) {
        ...
        throw new IllegalArgumentException(AbstractC0749x8313616e.m3330x95f25580(i, "Desired length ", " is less than zero."));
    }
    ...
    public static final boolean regionMatchesImpl(@NotNull CharSequence charSequence, int i, @NotNull CharSequence other, int i2, int i3, boolean z) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            if (!AbstractC0576x6ced6b.equals(charSequence.charAt(i + i4), other.charAt(i2 + i4), z)) {
                return false;
            }
        }
        return true;
    ...
    public static final void requireNonNegativeLimit(int i) {
        if (i >= 0) {
            ...
            throw new IllegalArgumentException(AbstractC0362x4440ab85.m2929x9738a56c(i, "Limit must be non-negative, but was ").toString());
        }
    }
    ...
    public static final List<String> split(@NotNull CharSequence charSequence, @NotNull String[] delimiters, boolean z, int i) {
        ...
        if (delimiters.length == 1) {
            ...
            if (str.length() != 0) {
                return m2078x9e171bf9(charSequence, str, i, z);
            }
        }
        Iterable asIterable = SequencesKt___SequencesKt.asIterable(m2077x9738a56c(charSequence, delimiters, z, i));
        ArrayList arrayList = new ArrayList(AbstractC0587xb7546d05.collectionSizeOrDefault(asIterable, 10));
    ...
    public static final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, @NotNull String[] delimiters, boolean z, int i) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        return SequencesKt___SequencesKt.map(m2077x9738a56c(charSequence, delimiters, z, i), new C1198x2b7f96fc(charSequence, 1));
    }
    ...
    public static final boolean startsWith(@NotNull CharSequence charSequence, char c, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return charSequence.length() > 0 && AbstractC0576x6ced6b.equals(charSequence.charAt(0), c, z);
    }
    ...
    public static final boolean toBooleanStrict(@NotNull String str) {
        ...
        throw new IllegalArgumentException(AbstractC0362x4440ab85.m2952x5ac5058d("The string doesn't represent a boolean value: ", str));
    }
    ...
    public static final CharSequence trim(@NotNull CharSequence charSequence, @NotNull Function1<? super Character, Boolean> predicate) {
        ...
        boolean z = false;
        while (i <= length) {
            boolean booleanValue = ((Boolean) AbstractC0749x8313616e.m3328x9e171bf9(charSequence, !z ? i : length, predicate)).booleanValue();
            if (z) {
                if (!booleanValue) {
                    break;
                }
    ...
    public static final Pair m2074x3271d0aa(CharSequence charSequence, Collection collection, int i, boolean z, boolean z2) {
        ...
        if (!z2) {
            downTo = new IntRange(AbstractC0296x1378447b.coerceAtLeast(i, 0), charSequence.length());
        } else {
            downTo = AbstractC0296x1378447b.downTo(AbstractC0296x1378447b.coerceAtMost(i, getLastIndex(charSequence)), 0);
        }
                ...
                while (true) {
                    ...
                    while (true) {
                        if (it.hasNext()) {
                            ...
                            if (AbstractC1197x89633db9.regionMatches(str2, 0, (String) charSequence, first, str2.length(), z)) {
                                break;
                            }
                        } else {
                            obj2 = null;
    ...
    public static final int m2075x1378447b(CharSequence charSequence, CharSequence charSequence2, int i, int i2, boolean z, boolean z2) {
        IntProgression downTo;
        if (!z2) {
            downTo = new IntRange(AbstractC0296x1378447b.coerceAtLeast(i, 0), AbstractC0296x1378447b.coerceAtMost(i2, charSequence.length()));
        } else {
            downTo = AbstractC0296x1378447b.downTo(AbstractC0296x1378447b.coerceAtMost(i, getLastIndex(charSequence)), AbstractC0296x1378447b.coerceAtLeast(i2, 0));
        }
        if ((charSequence instanceof String) && (charSequence2 instanceof String)) {
            int first = downTo.getFirst();
            int last = downTo.getLast();
            ...
            while (true) {
                ...
                if (AbstractC1197x89633db9.regionMatches(str, 0, (String) charSequence, first, str.length(), z)) {
                    return first;
                }
                if (first != last) {
                    first += step;
    ...
    public static C0673x1fb1a953 m2076x75d576dc(CharSequence charSequence, char[] cArr, boolean z, int i) {
        requireNonNegativeLimit(i);
        return new C0673x1fb1a953(charSequence, 0, i, new C0647x74ef1090(1, cArr, z));
    }
    ...
    public static C0673x1fb1a953 m2077x9738a56c(CharSequence charSequence, String[] strArr, boolean z, int i) {
        requireNonNegativeLimit(i);
        return new C0673x1fb1a953(charSequence, 0, i, new C0647x74ef1090(2, ArraysKt___ArraysJvmKt.asList(strArr), z));
    }
    ...
    public static final List m2078x9e171bf9(CharSequence charSequence, String str, int i, boolean z) {
        boolean z2;
        requireNonNegativeLimit(i);
        int i2 = 0;
        ...
        if (indexOf != -1 && i != 1) {
            ...
            int i3 = 10;
            if (z2) {
                i3 = AbstractC0296x1378447b.coerceAtMost(i, 10);
            }
        ...
        return AbstractC0586x968d4673.listOf(charSequence.toString());
    }
    ...
    public static final boolean endsWith(@NotNull CharSequence charSequence, @NotNull CharSequence suffix, boolean z) {
        ...
        if (!z && (charSequence instanceof String) && (suffix instanceof String)) {
            return AbstractC1197x89633db9.endsWith$default((String) charSequence, (String) suffix, false, 2, null);
        }
    ...
    public static final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, @NotNull char[] delimiters, boolean z, int i) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        return SequencesKt___SequencesKt.map(m2076x75d576dc(charSequence, delimiters, z, i), new C1198x2b7f96fc(charSequence, 0));
    }
    ...
    public static final boolean startsWith(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, boolean z) {
        ...
        if (!z && (charSequence instanceof String) && (prefix instanceof String)) {
            return AbstractC1197x89633db9.startsWith$default((String) charSequence, (String) prefix, false, 2, null);
        }
    ...
    public static final int indexOf(@NotNull CharSequence charSequence, @NotNull String string, int i, boolean z) {
        ...
        return m2075x1378447b(charSequence, string, i, charSequence.length(), z, false);
    }
    ...
    public static final int lastIndexOf(@NotNull CharSequence charSequence, @NotNull String string, int i, boolean z) {
        ...
        return m2075x1378447b(charSequence, string, i, 0, z, true);
    }
    ...
    public static final boolean startsWith(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, int i, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(prefix, "prefix");
        if (!z && (charSequence instanceof String) && (prefix instanceof String)) {
            return AbstractC1197x89633db9.startsWith$default((String) charSequence, (String) prefix, i, false, 4, null);
        }
    ...
    public static final int indexOfAny(@NotNull CharSequence charSequence, @NotNull Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(strings, "strings");
        Pair m2074x3271d0aa = m2074x3271d0aa(charSequence, strings, i, z, false);
        if (m2074x3271d0aa != null) {
            return ((Number) m2074x3271d0aa.getFirst()).intValue();
        }
        return -1;
    }
    ...
    public static final int lastIndexOfAny(@NotNull CharSequence charSequence, @NotNull Collection<String> strings, int i, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(strings, "strings");
        Pair m2074x3271d0aa = m2074x3271d0aa(charSequence, strings, i, z, true);
        if (m2074x3271d0aa != null) {
            return ((Number) m2074x3271d0aa.getFirst()).intValue();
        }
        return -1;
    ...
    public static final List<String> split(@NotNull CharSequence charSequence, @NotNull char[] delimiters, boolean z, int i) {
        ...
        Intrinsics.checkNotNullParameter(delimiters, "delimiters");
        if (delimiters.length == 1) {
            return m2078x9e171bf9(charSequence, String.valueOf(delimiters[0]), i, z);
        }
        Iterable asIterable = SequencesKt___SequencesKt.asIterable(m2076x75d576dc(charSequence, delimiters, z, i));
        ArrayList arrayList = new ArrayList(AbstractC0587xb7546d05.collectionSizeOrDefault(asIterable, 10));
        Iterator it = asIterable.iterator();
        while (it.hasNext()) {
            arrayList.add(substring(charSequence, (IntRange) it.next()));
    ...
    public static CharSequence trim(@NotNull CharSequence charSequence) {
        ...
        boolean z = false;
        while (i <= length) {
            boolean isWhitespace = AbstractC0298xfbe0c504.isWhitespace(charSequence.charAt(!z ? i : length));
            if (z) {
                if (!isWhitespace) {
                    break;
                }
    ...
    public static final CharSequence trimEnd(@NotNull CharSequence charSequence) {
        ...
        if (length >= 0) {
            while (true) {
                int i = length - 1;
                if (!AbstractC0298xfbe0c504.isWhitespace(charSequence.charAt(length))) {
                    return charSequence.subSequence(0, length + 1);
                }
                if (i < 0) {
                    break;
