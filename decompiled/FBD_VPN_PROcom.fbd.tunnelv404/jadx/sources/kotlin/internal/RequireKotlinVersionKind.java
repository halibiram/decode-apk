...
public final class RequireKotlinVersionKind {
    ...
    public static final /* synthetic */ RequireKotlinVersionKind[] f1371xfbe0c504;

    /* renamed from: 뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫, reason: contains not printable characters */
    public static final /* synthetic */ EnumEntries f1372x3271d0aa;
    ...
    static {
        ...
        API_VERSION = r5;
        RequireKotlinVersionKind[] requireKotlinVersionKindArr = {r3, r4, r5};
        f1371xfbe0c504 = requireKotlinVersionKindArr;
        f1372x3271d0aa = EnumEntriesKt.enumEntries(requireKotlinVersionKindArr);
    }

    @NotNull
    public static EnumEntries<RequireKotlinVersionKind> getEntries() {
        return f1372x3271d0aa;
    }
    ...
    public static RequireKotlinVersionKind[] values() {
        return (RequireKotlinVersionKind[]) f1371xfbe0c504.clone();
    }
}
