...
public final class AnnotationRetention {
    ...
    public static final /* synthetic */ AnnotationRetention[] f1199xfbe0c504;

    /* renamed from: 뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫, reason: contains not printable characters */
    public static final /* synthetic */ EnumEntries f1200x3271d0aa;
    ...
    static {
        ...
        RUNTIME = r5;
        AnnotationRetention[] annotationRetentionArr = {r3, r4, r5};
        f1199xfbe0c504 = annotationRetentionArr;
        f1200x3271d0aa = EnumEntriesKt.enumEntries(annotationRetentionArr);
    }

    @NotNull
    public static EnumEntries<AnnotationRetention> getEntries() {
        return f1200x3271d0aa;
    }
    ...
    public static AnnotationRetention[] values() {
        return (AnnotationRetention[]) f1199xfbe0c504.clone();
    }
}
