...
public final class BasicTrustRootIndex implements TrustRootIndex {
    ...
    public final LinkedHashMap f3452xfbe0c504;
    ...
    public BasicTrustRootIndex(@NotNull X509Certificate... caCerts) {
        ...
        this.f3452xfbe0c504 = linkedHashMap;
    }

    public boolean equals(@Nullable Object other) {
        if (other != this && (!(other instanceof BasicTrustRootIndex) || !Intrinsics.areEqual(((BasicTrustRootIndex) other).f3452xfbe0c504, this.f3452xfbe0c504))) {
            return false;
        }
        return true;
    }
    ...
    public X509Certificate findByIssuerAndSignature(@NotNull X509Certificate cert) {
        ...
        Set set = (Set) this.f3452xfbe0c504.get(cert.getIssuerX500Principal());
        Object obj = null;
        if (set == null) {
            return null;
        }
    ...
    public int hashCode() {
        return this.f3452xfbe0c504.hashCode();
    }
}
