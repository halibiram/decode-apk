                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        for (int i8 = 0; i8 < i7; i8++) {
                            if ((j & 255) < 128) {
                                ...
                                m2941xad53da1a.append((CharSequence) function1.invoke(Integer.valueOf(i9)));
                                i5++;
                                i6 = 8;
                            }
                            j >>= i6;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((j & 255) < 128) {
                            ...
                            m2941xad53da1a.append(transform.invoke(Integer.valueOf(i5)));
                            i2++;
                        }
                        j >>= 8;
                    }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i6 = 0; i6 < i5; i6++) {
                        if ((j & 255) < 128) {
                            ...
                            m2941xad53da1a.append(function1.invoke(Integer.valueOf(i7)));
                            i3++;
                            i4 = 8;
                        }
                        j >>= i4;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((j & 255) < 128) {
                            ...
                            m2941xad53da1a.append(function1.invoke(Integer.valueOf(i5)));
                            i2++;
                        }
                        j >>= 8;
                    }
