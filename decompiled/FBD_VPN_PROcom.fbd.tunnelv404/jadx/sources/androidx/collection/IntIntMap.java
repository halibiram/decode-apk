...
public abstract class IntIntMap {
    ...
    public final int get(int key) {
        ...
        throw new NoSuchElementException(AbstractC0362x4440ab85.m2929x9738a56c(key, "Cannot find value for key "));
    }
                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i8 < i7) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                m2942x952a0a9e.append((CharSequence) function2.invoke(valueOf, Integer.valueOf(i11)));
                                i5++;
                            } else {
                                jArr2 = jArr3;
                            }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            m2942x952a0a9e.append(transform.invoke(Integer.valueOf(i7), Integer.valueOf(i8)));
                            i2++;
                        }
                        j >>= 8;
                        i5++;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            m2942x952a0a9e.append(function2.invoke(Integer.valueOf(i7), Integer.valueOf(i8)));
                            i3++;
                        }
                        j >>= 8;
                        i5++;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((j & 255) < 128) {
                            ...
                            m2942x952a0a9e.append(function2.invoke(Integer.valueOf(i6), Integer.valueOf(i7)));
                            i2++;
                        }
                        j >>= 8;
                    }
