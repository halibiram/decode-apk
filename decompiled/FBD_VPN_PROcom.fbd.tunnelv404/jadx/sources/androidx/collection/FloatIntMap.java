                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            m2942x952a0a9e.append(transform.invoke(Float.valueOf(f), Integer.valueOf(i7)));
                            i2++;
                        }
                        j >>= 8;
                        i5++;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            m2942x952a0a9e.append(function2.invoke(Float.valueOf(f), Integer.valueOf(i7)));
                            i3++;
                        }
                        j >>= 8;
                        i5++;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i4 = 0; i4 < i3; i4++) {
                        if ((j & 255) < 128) {
                            ...
                            m2942x952a0a9e.append(function2.invoke(Float.valueOf(f), Integer.valueOf(i6)));
                            i2++;
                        }
                        j >>= 8;
                    }
