                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i8 < i7) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                m2942x952a0a9e.append((CharSequence) function2.invoke(valueOf, Float.valueOf(f2)));
                                i5++;
                            } else {
                                jArr2 = jArr3;
                            }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            m2942x952a0a9e.append(transform.invoke(Float.valueOf(f), Float.valueOf(f2)));
                            i2++;
                        }
                        j >>= 8;
                        i5++;
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            m2942x952a0a9e.append(function2.invoke(Float.valueOf(f), Float.valueOf(f2)));
                            i3++;
                        }
                        j >>= 8;
                        i5++;
