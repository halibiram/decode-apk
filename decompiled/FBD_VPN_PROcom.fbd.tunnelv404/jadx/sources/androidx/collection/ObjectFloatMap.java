                    ...
                    if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i8 < i7) {
                            if ((j & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                m2942x952a0a9e.append((CharSequence) function2.invoke(obj2, Float.valueOf(f)));
                                i5++;
                            } else {
                                jArr2 = jArr3;
                            }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((j & 255) < 128) {
                            ...
                            m2942x952a0a9e.append(transform.invoke(obj, Float.valueOf(f)));
                            i2++;
                        } else {
                            objArr2 = objArr3;
                        }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i5 = 0; i5 < i4; i5++) {
                        if ((j & 255) < 128) {
                            ...
                            m2942x952a0a9e.append(function2.invoke(obj, Float.valueOf(f)));
                            i3++;
                        }
                        j >>= 8;
                    }
