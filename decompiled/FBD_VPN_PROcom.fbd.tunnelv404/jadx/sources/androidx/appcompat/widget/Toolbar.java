...
import defpackage.RunnableC1242xab769ac2;
...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public static class Api33Impl {
        ...
        public static OnBackInvokedCallback newOnBackInvokedCallback(@NonNull Runnable runnable) {
            ...
            return new C0966xdf2a8a46(runnable, 2);
        }
    ...
    */
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            if (z2) {
                i7 = layoutChildRight(this.mNavButtonView, i26, iArr, i5);
                i6 = paddingLeft;
                ...
                if (!shouldLayout) {
                    ...
                    i8 = paddingRight;
                    i9 = ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + this.mTitleTextView.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
                } else {
                    i8 = paddingRight;
                    i9 = 0;
                }
                if (!shouldLayout2) {
                    ...
                    i10 = width;
                    i9 += this.mSubtitleTextView.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams2).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams2).bottomMargin;
                } else {
                    i10 = width;
                }
                if (shouldLayout && !shouldLayout2) {
                    ...
                    if (i11 == 48) {
                        if (i11 != 80) {
                            ...
                            int i28 = ((ViewGroup.MarginLayoutParams) layoutParams3).topMargin;
                            i14 = i5;
                            ...
                            if (i27 < i28 + i29) {
                                ...
                                int i30 = (((height - paddingBottom) - i9) - i27) - paddingTop2;
                                int i31 = ((ViewGroup.MarginLayoutParams) layoutParams3).bottomMargin;
                                int i32 = this.mTitleMarginBottom;
                                if (i30 < i31 + i32) {
                                    i27 = Math.max(0, i27 - ((((ViewGroup.MarginLayoutParams) layoutParams4).bottomMargin + i32) - i30));
                                }
                            }
                    ...
                    if (!z2) {
                        ...
                        if (shouldLayout2) {
                            int i34 = paddingTop + ((ViewGroup.MarginLayoutParams) ((LayoutParams) this.mSubtitleTextView.getLayoutParams())).topMargin;
                            this.mSubtitleTextView.layout(min - this.mSubtitleTextView.getMeasuredWidth(), i34, min, this.mSubtitleTextView.getMeasuredHeight() + i34);
                        ...
                        for (i23 = 0; i23 < size; i23++) {
                            i22 = layoutChildLeft(this.mTempViews.get(i23), i22, iArr, i14);
                        }
                        int i37 = i14;
                        addCustomViewsWithGravity(this.mTempViews, 5);
                        size2 = this.mTempViews.size();
                        for (i24 = 0; i24 < size2; i24++) {
                            min = layoutChildRight(this.mTempViews.get(i24), min, iArr, i37);
                        }
                        addCustomViewsWithGravity(this.mTempViews, 1);
                        int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
                        i25 = ((((i10 - i12) - i8) / 2) + i12) - (viewListMeasuredWidth / 2);
                        int i38 = viewListMeasuredWidth + i25;
                        if (i25 >= i22) {
                            if (i38 > min) {
                                i22 = i25 - (i38 - min);
                            } else {
                        ...
                        while (i16 < size3) {
                            i22 = layoutChildLeft(this.mTempViews.get(i16), i22, iArr, i37);
                            i16++;
                        }
                ...
                i25 = ((((i10 - i12) - i8) / 2) + i12) - (viewListMeasuredWidth2 / 2);
                int i382 = viewListMeasuredWidth2 + i25;
                if (i25 >= i22) {
                }
                size3 = this.mTempViews.size();
                while (i16 < size3) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (z && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = Api33Impl.newOnBackInvokedCallback(new RunnableC1242xab769ac2(this, 0));
                }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new RunnableC1242xab769ac2(this, 1));
