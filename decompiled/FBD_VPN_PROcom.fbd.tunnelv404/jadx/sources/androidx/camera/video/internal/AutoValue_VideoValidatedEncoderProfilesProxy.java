...
final class AutoValue_VideoValidatedEncoderProfilesProxy extends VideoValidatedEncoderProfilesProxy {
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = (((((((this.defaultDurationSeconds ^ 1000003) * 1000003) ^ this.recommendedFileFormat) * 1000003) ^ this.audioProfiles.hashCode()) * 1000003) ^ this.videoProfiles.hashCode()) * 1000003;
        ...
        return ((hashCode2 ^ hashCode) * 1000003) ^ this.defaultVideoProfile.hashCode();
    }
