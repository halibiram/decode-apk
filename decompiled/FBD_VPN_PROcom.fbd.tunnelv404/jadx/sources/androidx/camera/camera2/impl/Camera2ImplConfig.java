...
public final class Camera2ImplConfig extends CaptureRequestOptions {
    ...
    public static final class Builder implements ExtendableBuilder<Camera2ImplConfig> {
        ...
        @NonNull
        public Builder insertAllOptions(@NonNull Config config2) {
            insertAllOptions(config2, Config.OptionPriority.OPTIONAL);
            return this;
        }
        ...
        @NonNull
        public Builder insertAllOptions(@NonNull Config config2, @NonNull Config.OptionPriority optionPriority) {
            for (Config.Option<?> option : config2.listOptions()) {
                this.mMutableOptionsBundle.insertOption(option, optionPriority, config2.retrieveOption(option));
            }
            return this;
        }
    }

    public Camera2ImplConfig(@NonNull Config config2) {
        super(config2);
    }
