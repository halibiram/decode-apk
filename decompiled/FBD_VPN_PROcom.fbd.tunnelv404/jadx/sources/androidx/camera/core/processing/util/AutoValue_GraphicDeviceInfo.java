...
final class AutoValue_GraphicDeviceInfo extends GraphicDeviceInfo {
    ...
    public static final class Builder extends GraphicDeviceInfo.Builder {
        ...
        public GraphicDeviceInfo build() {
            ...
            if (this.eglVersion == null) {
                str = AbstractC0362x4440ab85.m2931x34271fae(str, " eglVersion");
            }
            if (this.glExtensions == null) {
                str = AbstractC0362x4440ab85.m2931x34271fae(str, " glExtensions");
            }
            if (this.eglExtensions == null) {
                str = AbstractC0362x4440ab85.m2931x34271fae(str, " eglExtensions");
            }
            if (str.isEmpty()) {
    ...
    public String toString() {
        ...
        return AbstractC0362x4440ab85.m2936xd2bcb0cf(sb, this.eglExtensions, "}");
    }
