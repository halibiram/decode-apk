...
public final class ImageWriterCompat {
    ...
    public static void close(@NonNull ImageWriter imageWriter) {
        ...
        throw new RuntimeException(AbstractC0749x8313616e.m3330x95f25580(i, "Unable to call close() on API ", ". Version 23 or higher required."));
    }
    ...
    public static Image dequeueInputImage(@NonNull ImageWriter imageWriter) {
        ...
        throw new RuntimeException(AbstractC0749x8313616e.m3330x95f25580(i, "Unable to call dequeueInputImage() on API ", ". Version 23 or higher required."));
    }
    ...
    public static ImageWriter newInstance(@NonNull Surface surface, @IntRange(from = 1) int i, int i2) {
        ...
        throw new RuntimeException(AbstractC0749x8313616e.m3330x95f25580(i3, "Unable to call newInstance(Surface, int, int) on API ", ". Version 26 or higher required."));
    }
    ...
    public static void queueInputImage(@NonNull ImageWriter imageWriter, @NonNull Image image) {
        ...
        throw new RuntimeException(AbstractC0749x8313616e.m3330x95f25580(i, "Unable to call queueInputImage() on API ", ". Version 23 or higher required."));
    }
    ...
    public static ImageWriter newInstance(@NonNull Surface surface, @IntRange(from = 1) int i) {
        ...
        throw new RuntimeException(AbstractC0749x8313616e.m3330x95f25580(i2, "Unable to call newInstance(Surface, int) on API ", ". Version 23 or higher required."));
    }
}
