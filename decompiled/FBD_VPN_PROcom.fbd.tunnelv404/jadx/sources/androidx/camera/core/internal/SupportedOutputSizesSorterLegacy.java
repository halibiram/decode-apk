        ...
        if (!arrayList2.isEmpty()) {
            ...
            if (targetAspectRatioByLegacyApi == null) {
                ...
                if (targetSize != null) {
                    ...
                    while (it2.hasNext()) {
                        SupportedOutputSizesSorter.sortSupportedSizesByFallbackRuleClosestHigherThenLower(groupSizesByAspectRatio.get(it2.next()), targetSize, true);
                    }
                }
                ...
                while (it3.hasNext()) {
                    for (Size size4 : groupSizesByAspectRatio.get((Rational) it3.next())) {
