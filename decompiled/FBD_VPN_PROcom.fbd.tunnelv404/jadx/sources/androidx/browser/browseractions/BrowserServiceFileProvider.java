...
public final class BrowserServiceFileProvider extends FileProvider {
    ...
    private static Uri generateUri(Context context, String str) {
        return new Uri.Builder().scheme(CONTENT_SCHEME).authority(context.getPackageName() + AUTHORITY_SUFFIX).path(AbstractC0362x4440ab85.m2932x95f25580(FILE_SUB_DIR_NAME, str, FILE_EXTENSION)).build();
    }
    ...
    public static ResolvableFuture<Uri> saveBitmap(@NonNull Context context, @NonNull Bitmap bitmap, @NonNull String str, int i) {
        StringBuilder m2943xc20437a5 = AbstractC0362x4440ab85.m2943xc20437a5(str, "_");
        m2943xc20437a5.append(Integer.toString(i));
