            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                ...
                if (event == Lifecycle.Event.INSTANCE.upTo(Lifecycle.State.this)) {
                    ...
                    try {
                        ...
                        m1764constructorimpl = Result.m1764constructorimpl(function02.invoke());
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        m1764constructorimpl = Result.m1764constructorimpl(ResultKt.createFailure(th));
                    }
                    continuation2.resumeWith(m1764constructorimpl);
                    return;
                }
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ...
                    continuation3.resumeWith(Result.m1764constructorimpl(ResultKt.createFailure(new LifecycleDestroyedException())));
                }
            }
        };
        if (z) {
