...
public class FlexBuffers {
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.bb, (i * this.byteWidth) + this.end, this.byteWidth, Unsigned.byteToUnsignedInt(this.bb.get((int) ((size * this.byteWidth) + this.end + j))));
        }
