...
public class EmojiCompat {
    ...
    private EmojiCompat(@NonNull Config config2) {
        this.mReplaceAll = config2.mReplaceAll;
        this.mUseEmojiAsDefaultStyle = config2.mUseEmojiAsDefaultStyle;
        this.mEmojiAsDefaultStyleExceptions = config2.mEmojiAsDefaultStyleExceptions;
        this.mEmojiSpanIndicatorEnabled = config2.mEmojiSpanIndicatorEnabled;
        this.mEmojiSpanIndicatorColor = config2.mEmojiSpanIndicatorColor;
        this.mMetadataLoader = config2.mMetadataLoader;
        this.mMetadataLoadStrategy = config2.mMetadataLoadStrategy;
        this.mGlyphChecker = config2.mGlyphChecker;
        ArraySet arraySet = new ArraySet();
        this.mInitCallbacks = arraySet;
        SpanFactory spanFactory = config2.mSpanFactory;
        this.mSpanFactory = spanFactory == null ? new DefaultSpanFactory() : spanFactory;
        Set<InitCallback> set = config2.mInitCallbacks;
        if (set != null && !set.isEmpty()) {
            arraySet.addAll(config2.mInitCallbacks);
        }
    ...
    @NonNull
    public static EmojiCompat reset(@NonNull Config config2) {
        EmojiCompat emojiCompat;
        synchronized (INSTANCE_LOCK) {
            emojiCompat = new EmojiCompat(config2);
    ...
    @NonNull
    public static EmojiCompat init(@NonNull Config config2) {
