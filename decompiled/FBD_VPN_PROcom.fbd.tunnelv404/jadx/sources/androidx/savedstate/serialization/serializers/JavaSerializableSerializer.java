...
public abstract class JavaSerializableSerializer<T extends Serializable> implements KSerializer<T> {
    ...
    public final T deserialize(@NotNull Decoder decoder) {
        ...
        if (decoder instanceof SavedStateDecoder) {
            ...
            T t = (T) SavedStateReader.m722getJavaSerializableimpl(SavedStateReader.m684constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Serializable.class));
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull T value) {
        ...
        if (encoder instanceof SavedStateEncoder) {
            ...
            SavedStateWriter.m791putJavaSerializableimpl(SavedStateWriter.m771constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
            return;
        }
