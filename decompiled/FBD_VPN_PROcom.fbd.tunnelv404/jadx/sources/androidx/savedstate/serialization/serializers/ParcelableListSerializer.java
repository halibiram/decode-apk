...
public final class ParcelableListSerializer implements KSerializer<List<? extends Parcelable>> {
    ...
    public List<Parcelable> deserialize(@NotNull Decoder decoder) {
        ...
        if (decoder instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m736getParcelableListimpl(SavedStateReader.m684constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey(), Reflection.getOrCreateKotlinClass(Parcelable.class));
        }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull List<? extends Parcelable> value) {
        ...
        if (encoder instanceof SavedStateEncoder) {
            ...
            SavedStateWriter.m797putParcelableListimpl(SavedStateWriter.m771constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
            return;
        }
