...
public final class SizeFSerializer implements KSerializer<SizeF> {
    ...
    public SizeF deserialize(@NotNull Decoder decoder) {
        ...
        if (decoder instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m748getSizeFimpl(SavedStateReader.m684constructorimpl(savedStateDecoder.getSavedState()), savedStateDecoder.getKey());
        }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull SizeF value) {
        ...
        if (encoder instanceof SavedStateEncoder) {
            ...
            SavedStateWriter.m802putSizeFimpl(SavedStateWriter.m771constructorimpl(savedStateEncoder.getSavedState()), savedStateEncoder.getKey(), value);
            return;
        }
