...
import defpackage.RunnableC1059xfdc67e8f;
...
public final class QueryInterceptorStatement implements SupportSQLiteStatement {
    ...
    public void execute() {
        this.queryCallbackExecutor.execute(new RunnableC1059xfdc67e8f(this, 3));
        this.delegate.execute();
    }

    @Override // androidx.sqlite.db.SupportSQLiteStatement
    public long executeInsert() {
        this.queryCallbackExecutor.execute(new RunnableC1059xfdc67e8f(this, 1));
        return this.delegate.executeInsert();
    }

    @Override // androidx.sqlite.db.SupportSQLiteStatement
    public int executeUpdateDelete() {
        this.queryCallbackExecutor.execute(new RunnableC1059xfdc67e8f(this, 4));
        return this.delegate.executeUpdateDelete();
    }

    @Override // androidx.sqlite.db.SupportSQLiteStatement
    public long simpleQueryForLong() {
        this.queryCallbackExecutor.execute(new RunnableC1059xfdc67e8f(this, 0));
    ...
    public String simpleQueryForString() {
        this.queryCallbackExecutor.execute(new RunnableC1059xfdc67e8f(this, 2));
