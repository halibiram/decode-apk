...
public final class AmbiguousColumnResolver {
    ...
    private final <T> void dfs(List<? extends List<? extends T>> content, List<T> current, int depth, Function1<? super List<? extends T>, Unit> block) {
        ...
        while (it.hasNext()) {
            ...
            AbstractC0590xf7db57e6.removeLast(current);
        }
    }
    ...
    public static final int[][] resolve(@NotNull String[] resultColumns, @NotNull String[][] mappings) {
        ...
        for (String[] strArr2 : mappings) {
            AbstractC0590xf7db57e6.addAll(createSetBuilder, strArr2);
        }
        Set build = AbstractC1144x81de89fe.build(createSetBuilder);
        ...
        List<ResultColumn> build2 = AbstractC0586x968d4673.build(createListBuilder);
        ...
        while (i8 < length6) {
            ...
            if (((List) arrayList.get(i9)).isEmpty()) {
                ...
                for (String str4 : strArr3) {
                    List createListBuilder2 = AbstractC0586x968d4673.createListBuilder();
                    ...
                    List build3 = AbstractC0586x968d4673.build(createListBuilder2);
                    if (!build3.isEmpty()) {
                        arrayList2.add(build3);
                    } else {
                        throw new IllegalStateException(AbstractC0362x4440ab85.m2932x95f25580("Column ", str4, " not found in result").toString());
                    }
                }
        ...
        ArrayList arrayList3 = new ArrayList(AbstractC0587xb7546d05.collectionSizeOrDefault(matches, 10));
