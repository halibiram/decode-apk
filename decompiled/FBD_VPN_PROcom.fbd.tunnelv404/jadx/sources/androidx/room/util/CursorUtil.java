        ...
        if (columnNames.length == mapping.length) {
            return new CursorWrapper(cursor) { // from class: androidx.room.util.CursorUtil$wrapMappedColumns$2
                ...
                public int getColumnIndex(@NotNull String columnName) {
                    ...
                    while (i < length) {
                        int i3 = i2 + 1;
                        if (AbstractC1197x89633db9.equals(strArr[i], columnName, true)) {
                            return iArr[i2];
                        }
                        i++;
                        i2 = i3;
    ...
    public static final int findColumnIndexBySuffix(@NotNull String[] columnNames, @NotNull String name) {
        ...
        while (i < length) {
            ...
            if (str3.length() >= name.length() + 2) {
                if (AbstractC1197x89633db9.endsWith$default(str3, str, false, 2, null)) {
                    return i2;
                }
                if (str3.charAt(0) == '`' && AbstractC1197x89633db9.endsWith$default(str3, str2, false, 2, null)) {
                    return i2;
                }
            }
            i++;
