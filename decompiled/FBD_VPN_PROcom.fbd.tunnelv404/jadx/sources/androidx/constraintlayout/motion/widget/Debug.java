...
public class Debug {
    public static void dumpLayoutParams(ViewGroup viewGroup, String str) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            StringBuilder m2943xc20437a5 = AbstractC0362x4440ab85.m2943xc20437a5(str2, "     ");
            m2943xc20437a5.append(getName(childAt));
    ...
    public static void dumpPoc(Object obj) {
        ...
        m2943xc20437a5.append(cls.getName());
        ...
        StringBuilder m2943xc20437a52 = AbstractC0362x4440ab85.m2943xc20437a5(str, "------------- ");
        m2943xc20437a52.append(cls.getSimpleName());
        m2943xc20437a52.append(" --------------------");
        printStream2.println(m2943xc20437a52.toString());
    }
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams layoutParams, String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + str + "  ";
        PrintStream printStream = System.out;
        StringBuilder m3342x4440ab85 = AbstractC0749x8313616e.m3342x4440ab85(" >>>>>>>>>>>>>>>>>>. dump ", str2, "  ");
        m3342x4440ab85.append(layoutParams.getClass().getName());
        printStream.println(m3342x4440ab85.toString());
        for (Field field : layoutParams.getClass().getFields()) {
            try {
                Object obj = field.get(layoutParams);
