    ...
    public class WriteXmlEngine {
        ...
        private void writeEnum(String str, int i, String[] strArr, int i2) {
            if (i != i2) {
                ...
                StringBuilder m3342x4440ab85 = AbstractC0749x8313616e.m3342x4440ab85(SPACE, str, "=\"");
                m3342x4440ab85.append(strArr[i]);
                m3342x4440ab85.append("\"");
                writer.write(m3342x4440ab85.toString());
            }
        }

        public String getName(int i) {
            if (this.mIdMap.containsKey(Integer.valueOf(i))) {
                return AbstractC0362x4440ab85.m2936xd2bcb0cf(new StringBuilder("@+id/"), this.mIdMap.get(Integer.valueOf(i)), "");
            }
            if (i == 0) {
        ...
        switch (i2) {
            case 1:
                if (i4 == 1) {
                    ...
                    throw new IllegalArgumentException(AbstractC0362x4440ab85.m2936xd2bcb0cf(new StringBuilder("Left to "), sideToString(i4), " undefined"));
                }
            ...
            case 2:
                if (i4 == 1) {
                    ...
                    throw new IllegalArgumentException(AbstractC0362x4440ab85.m2936xd2bcb0cf(new StringBuilder("right to "), sideToString(i4), " undefined"));
                }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(AbstractC0362x4440ab85.m2936xd2bcb0cf(sb, sideToString(i4), " unknown"));
        }
    }
    ...
    */
    ...
    public void clone(ConstraintSet constraintSet) {
        ...
        for (Integer num : constraintSet.mConstraints.keySet()) {
            Constraint constraint = constraintSet.mConstraints.get(num);
            if (constraint != null) {
                this.mConstraints.put(num, constraint.m526clone());
            }
        }
    }
    ...
    public class WriteJsonEngine {
        ...
        public String getName(int i) {
            if (this.mIdMap.containsKey(Integer.valueOf(i))) {
                return AbstractC0362x4440ab85.m2936xd2bcb0cf(new StringBuilder("'"), this.mIdMap.get(Integer.valueOf(i)), "'");
            }
            if (i == 0) {
                return "'parent'";
            }
