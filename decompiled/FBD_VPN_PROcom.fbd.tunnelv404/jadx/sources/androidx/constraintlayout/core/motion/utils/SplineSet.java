...
public abstract class SplineSet {
    ...
    public void setProperty(TypedValues typedValues, float f) {
        typedValues.setValue(AbstractC1253xe48bb159.m4014xfbe0c504(this.mType), get(f));
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.mCount; i++) {
            ...
            m2943xc20437a5.append(this.mTimePoints[i]);
            m2943xc20437a5.append(" , ");
            m2943xc20437a5.append(decimalFormat.format(this.mValues[i]));
            m2943xc20437a5.append("] ");
