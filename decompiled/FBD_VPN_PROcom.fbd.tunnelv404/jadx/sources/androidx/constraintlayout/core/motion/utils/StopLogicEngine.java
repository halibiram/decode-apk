...
public class StopLogicEngine implements StopEngine {
    ...
    public String debug(String str, float f) {
        String str2;
        StringBuilder m2943xc20437a5 = AbstractC0362x4440ab85.m2943xc20437a5(AbstractC0362x4440ab85.m2936xd2bcb0cf(AbstractC0362x4440ab85.m2943xc20437a5(str, " ===== "), this.mType, "\n"), str);
        if (this.mBackwards) {
            str2 = "backwards";
        } else {
            str2 = "forward ";
        }
        m2943xc20437a5.append(str2);
        m2943xc20437a5.append(" time = ");
        m2943xc20437a5.append(f);
        m2943xc20437a5.append("  stages ");
        String str3 = AbstractC0362x4440ab85.m2935x1db10c9d(m2943xc20437a5, "\n", this.mNumberOfStages) + str + " dur " + this.mStage1Duration + " vel " + this.mStage1Velocity + " pos " + this.mStage1EndPosition + "\n";
        ...
        float f2 = this.mStage1Duration;
        if (f <= f2) {
            return AbstractC0362x4440ab85.m2953x742e2fda(str3, str, "stage 0\n");
        }
        int i = this.mNumberOfStages;
        if (i == 1) {
            return AbstractC0362x4440ab85.m2953x742e2fda(str3, str, "end stage 0\n");
        }
        float f3 = f - f2;
        float f4 = this.mStage2Duration;
        if (f3 < f4) {
            return AbstractC0362x4440ab85.m2953x742e2fda(str3, str, " stage 1\n");
        }
        if (i == 2) {
            return AbstractC0362x4440ab85.m2953x742e2fda(str3, str, "end stage 1\n");
        }
        if (f3 - f4 < this.mStage3Duration) {
            return AbstractC0362x4440ab85.m2953x742e2fda(str3, str, " stage 2\n");
        }
        return AbstractC0362x4440ab85.m2953x742e2fda(str3, str, " end stage 2\n");
    }
