...
public class LinearSystem {
    ...
    private void displayRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            ...
            m3341xc20437a5.append(this.mRows[i]);
            str = AbstractC0362x4440ab85.m2931x34271fae(m3341xc20437a5.toString(), "\n");
        }
        StringBuilder m3341xc20437a52 = AbstractC0749x8313616e.m3341xc20437a5(str);
        m3341xc20437a52.append(this.mGoal);
        m3341xc20437a52.append("\n");
        System.out.println(m3341xc20437a52.toString());
    }
    ...
    private void displaySolverVariables() {
        ...
        sb.append("x");
        System.out.println(AbstractC0362x4440ab85.m2935x1db10c9d(sb, ")\n", this.mNumColumns));
    }
    ...
    private String getDisplaySize(int i) {
        ...
        int i4 = i3 / 1024;
        if (i4 > 0) {
            return AbstractC0749x8313616e.m3330x95f25580(i4, "", " Mb");
        }
        if (i3 > 0) {
            return AbstractC0749x8313616e.m3330x95f25580(i3, "", " Kb");
        }
        return AbstractC0749x8313616e.m3330x95f25580(i2, "", " bytes");
    }
    ...
    */
    ...
    public void displayReadableRows() {
        displaySolverVariables();
        String m2935x1db10c9d = AbstractC0362x4440ab85.m2935x1db10c9d(new StringBuilder(" num vars "), "\n", this.mVariablesID);
        for (int i = 0; i < this.mVariablesID + 1; i++) {
            SolverVariable solverVariable = this.mCache.mIndexedVariables[i];
            if (solverVariable != null && solverVariable.isFinalValue) {
                m2935x1db10c9d = m2935x1db10c9d + " $[" + i + "] => " + solverVariable + " = " + solverVariable.computedValue + "\n";
            }
        }
        String m2931x34271fae = AbstractC0362x4440ab85.m2931x34271fae(m2935x1db10c9d, "\n");
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            ...
            if (solverVariable2 != null && solverVariable2.mIsSynonym) {
                m2931x34271fae = m2931x34271fae + " ~[" + i2 + "] => " + solverVariable2 + " = " + solverVariableArr[solverVariable2.mSynonym] + " + " + solverVariable2.mSynonymDelta + "\n";
            }
        }
        String m2931x34271fae2 = AbstractC0362x4440ab85.m2931x34271fae(m2931x34271fae, "\n\n #  ");
        for (int i3 = 0; i3 < this.mNumRows; i3++) {
            StringBuilder m3341xc20437a5 = AbstractC0749x8313616e.m3341xc20437a5(m2931x34271fae2);
            m3341xc20437a5.append(this.mRows[i3].toReadableString());
            m2931x34271fae2 = AbstractC0362x4440ab85.m2931x34271fae(m3341xc20437a5.toString(), "\n #  ");
        }
        if (this.mGoal != null) {
            StringBuilder m2943xc20437a5 = AbstractC0362x4440ab85.m2943xc20437a5(m2931x34271fae2, "Goal: ");
            m2943xc20437a5.append(this.mGoal);
            m2943xc20437a5.append("\n");
            m2931x34271fae2 = m2943xc20437a5.toString();
        }
        System.out.println(m2931x34271fae2);
    }
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            if (this.mRows[i].mVariable.mType == SolverVariable.Type.UNRESTRICTED) {
                StringBuilder m3341xc20437a5 = AbstractC0749x8313616e.m3341xc20437a5(str);
                m3341xc20437a5.append(this.mRows[i].toReadableString());
                str = AbstractC0362x4440ab85.m2931x34271fae(m3341xc20437a5.toString(), "\n");
            }
        }
        StringBuilder m3341xc20437a52 = AbstractC0749x8313616e.m3341xc20437a5(str);
