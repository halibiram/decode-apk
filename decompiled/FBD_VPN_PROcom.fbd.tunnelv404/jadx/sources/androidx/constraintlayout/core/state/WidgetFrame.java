...
public class WidgetFrame {
    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        int i24 = (int) (((i8 - i7) * f5) + i7);
        widgetFrame.left = i24;
        int i25 = (int) ((f5 * (i17 - i23)) + i23);
        widgetFrame.top = i25;
        float f10 = 1.0f - f;
        widgetFrame.right = i24 + ((int) ((i20 * f) + (i3 * f10)));
        widgetFrame.bottom = i25 + ((int) ((i21 * f) + (f10 * i4)));
    ...
    public void logv(String str) {
        ...
        StringBuilder m2943xc20437a5 = AbstractC0362x4440ab85.m2943xc20437a5(".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName(), " ");
        m2943xc20437a5.append(hashCode() % 1000);
        String sb = m2943xc20437a5.toString();
        if (this.widget != null) {
            StringBuilder m2943xc20437a52 = AbstractC0362x4440ab85.m2943xc20437a5(sb, "/");
            m2943xc20437a52.append(this.widget.hashCode() % 1000);
            m2931x34271fae = m2943xc20437a52.toString();
        } else {
            m2931x34271fae = AbstractC0362x4440ab85.m2931x34271fae(sb, "/NULL");
        }
        System.out.println(m2931x34271fae + " " + str);
    }
    ...
    public void printCustomAttributes() {
        ...
        if (hashMap != null) {
            for (String str : hashMap.keySet()) {
                ...
                StringBuilder m3341xc20437a5 = AbstractC0749x8313616e.m3341xc20437a5(m2931x34271fae);
                m3341xc20437a5.append(this.mCustom.get(str).toString());
                printStream.println(m3341xc20437a5.toString());
            }
        }
    }
    ...
    private static float interpolate(float f, float f2, float f3, float f4) {
        ...
        return AbstractC0362x4440ab85.m2925xfbe0c504(f2, f, f4, f);
    }
}
