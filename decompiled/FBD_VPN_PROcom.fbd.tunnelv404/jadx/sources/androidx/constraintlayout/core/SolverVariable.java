...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    private static String getUniqueName(Type type, String str) {
        if (str != null) {
            ...
            m3341xc20437a5.append(sUniqueErrorId);
    ...
    public String strengthsToString() {
        ...
        for (int i = 0; i < this.mStrengthVector.length; i++) {
            StringBuilder m3341xc20437a5 = AbstractC0749x8313616e.m3341xc20437a5(str);
            m3341xc20437a5.append(this.mStrengthVector[i]);
            ...
            if (i < fArr.length - 1) {
                str = AbstractC0362x4440ab85.m2931x34271fae(sb, ", ");
            } else {
                str = AbstractC0362x4440ab85.m2931x34271fae(sb, "] ");
            }
        }
        if (z) {
            str = AbstractC0362x4440ab85.m2931x34271fae(str, " (-)");
        }
        if (z2) {
