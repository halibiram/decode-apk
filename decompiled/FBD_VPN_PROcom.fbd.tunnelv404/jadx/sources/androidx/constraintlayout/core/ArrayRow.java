...
public class ArrayRow implements LinearSystem.Row {
    ...
    public int sizeInBytes() {
        ...
        return this.variables.sizeInBytes() + i + 8;
    }
    ...
    */
    public String toReadableString() {
        ...
        if (this.mConstantValue != 0.0f) {
            ...
            m3341xc20437a5.append(this.mConstantValue);
                ...
                if (variableValue != 0.0f) {
                    ...
                    if (!z) {
                        ...
                        if (variableValue == 1.0f) {
                            m2931x34271fae = AbstractC0362x4440ab85.m2931x34271fae(m2931x34271fae, solverVariable);
                        } else {
                            m2931x34271fae = m2931x34271fae + variableValue + " " + solverVariable;
                        }
                        z = true;
        ...
        if (!z) {
            return AbstractC0362x4440ab85.m2931x34271fae(m2931x34271fae, GLUtils.VERSION_UNKNOWN);
        }
