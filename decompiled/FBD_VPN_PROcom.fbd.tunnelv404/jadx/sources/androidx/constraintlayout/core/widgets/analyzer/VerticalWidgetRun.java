                ...
                if (i3 == 3 && constraintWidget2.mHorizontalRun.mDimension.resolved) {
                    ...
                    if (dimensionRatioSide != -1) {
                        if (dimensionRatioSide != 0) {
                            ...
                            i = (int) ((this.mWidget.getDimensionRatio() * r7.mHorizontalRun.mDimension.value) + 0.5f);
                        }
        ...
        if (dependencyNode.readyToSolve) {
            ...
            if (dependencyNode2.readyToSolve) {
                ...
                if (this.mDimension.resolved && this.start.mTargets.size() > 0 && this.end.mTargets.size() > 0) {
                    ...
                    this.start.resolve((int) ((((i10 - i9) - this.mDimension.value) * verticalBiasPercent) + i9 + 0.5f));
