...
public interface SystemIdInfoDao {
    ...
    public static final class DefaultImpls {
        ...
        public static SystemIdInfo getSystemIdInfo(@NotNull SystemIdInfoDao systemIdInfoDao, @NotNull WorkGenerationalId id) {
            SystemIdInfo m3961xfbe0c504;
            Intrinsics.checkNotNullParameter(id, "id");
            m3961xfbe0c504 = AbstractC1220xce36e9ad.m3961xfbe0c504(systemIdInfoDao, id);
            return m3961xfbe0c504;
        }

        @Deprecated
        public static void removeSystemIdInfo(@NotNull SystemIdInfoDao systemIdInfoDao, @NotNull WorkGenerationalId id) {
            Intrinsics.checkNotNullParameter(id, "id");
            AbstractC1220xce36e9ad.m3962x3271d0aa(systemIdInfoDao, id);
        }
    }

    @Nullable
    SystemIdInfo getSystemIdInfo(@NotNull WorkGenerationalId id);
    ...
    void removeSystemIdInfo(@NotNull WorkGenerationalId id);
