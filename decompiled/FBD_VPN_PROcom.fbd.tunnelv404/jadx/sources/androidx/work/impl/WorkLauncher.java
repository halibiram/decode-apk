...
public interface WorkLauncher {
    void startWork(@NotNull StartStopToken workSpecId);

    void startWork(@NotNull StartStopToken workSpecId, @Nullable WorkerParameters.RuntimeExtras runtimeExtras);

    void stopWork(@NotNull StartStopToken workSpecId);

    void stopWork(@NotNull StartStopToken workSpecId, int reason);

    void stopWorkWithReason(@NotNull StartStopToken workSpecId, int reason);
}
