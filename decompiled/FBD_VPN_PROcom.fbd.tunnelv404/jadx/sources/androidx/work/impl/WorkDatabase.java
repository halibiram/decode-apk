    ...
    public static final class Companion {
        ...
        public final WorkDatabase create(@NotNull Context context, @NotNull Executor queryExecutor, @NotNull Clock clock, boolean useTestDatabase) {
            ...
            if (useTestDatabase) {
                ...
                openHelperFactory = Room.databaseBuilder(context, WorkDatabase.class, WorkDatabasePathHelperKt.WORK_DATABASE_NAME).openHelperFactory(new C0914xf9eefc47(context));
            }
