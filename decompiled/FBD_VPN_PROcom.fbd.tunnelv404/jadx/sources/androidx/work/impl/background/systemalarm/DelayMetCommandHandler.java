...
import defpackage.RunnableC0672x1cecb811;
...
public class DelayMetCommandHandler implements OnConstraintsStateChangedListener, WorkTimer.TimeLimitExceededListener {
    ...
    public void handleProcessWork() {
        ...
        StringBuilder m2943xc20437a5 = AbstractC0362x4440ab85.m2943xc20437a5(workSpecId, " (");
        m2943xc20437a5.append(this.mStartId);
        m2943xc20437a5.append(")");
        this.mWakeLock = WakeLocks.newWakeLock(context, m2943xc20437a5.toString());
        Logger logger = Logger.get();
        String str = TAG;
        ...
        if (workSpec == null) {
            this.mSerialExecutor.execute(new RunnableC0672x1cecb811(this, 0));
            return;
        }
        ...
        if (!hasConstraints) {
            ...
            this.mSerialExecutor.execute(new RunnableC0672x1cecb811(this, 1));
            return;
        }
