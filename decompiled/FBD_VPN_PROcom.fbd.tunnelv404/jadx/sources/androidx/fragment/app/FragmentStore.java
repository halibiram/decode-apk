        ...
        if (!this.mActive.isEmpty()) {
            ...
            for (FragmentStateManager fragmentStateManager : this.mActive.values()) {
                ...
                if (fragmentStateManager != null) {
                    ...
                    fragment.dump(m2931x34271fae, fileDescriptor, printWriter, strArr);
                } else {
        ...
        if (list != null) {
            for (String str : list) {
                ...
                if (findActiveFragment != null) {
                    ...
                    throw new IllegalStateException(AbstractC0362x4440ab85.m2932x95f25580("No instantiated fragment for (", str, ")"));
                }
            }
        }
    }
