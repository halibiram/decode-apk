            ...
            if (transitionName != null) {
                if (this.mSharedElementSourceNames == null) {
                    ...
                    if (this.mSharedElementSourceNames.contains(transitionName)) {
                        throw new IllegalArgumentException(AbstractC0362x4440ab85.m2932x95f25580("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                    }
                } else {
                    throw new IllegalArgumentException(AbstractC0362x4440ab85.m2932x95f25580("A shared element with the target name '", str, "' has already been added to the transaction."));
                }
