...
import defpackage.C0833xe1b1f9be;
...
public final class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public void execPerConnectionSQL(@NotNull String sql, @Nullable Object[] bindArgs) {
        ...
        throw new UnsupportedOperationException(AbstractC0362x4440ab85.m2929x9738a56c(i, "execPerConnectionSQL is not supported on a SDK version lower than 30, current version is: "));
    }
    ...
    public void m818setMaximumSize(long j) {
    ...
    public Cursor query(@NotNull final SupportSQLiteQuery query) {
        Intrinsics.checkNotNullParameter(query, "query");
        Cursor rawQueryWithFactory = this.delegate.rawQueryWithFactory(new C0833xe1b1f9be(new Function4<SQLiteDatabase, SQLiteCursorDriver, String, SQLiteQuery, SQLiteCursor>() { // from class: androidx.sqlite.db.framework.FrameworkSQLiteDatabase$query$cursorFactory$1
            {
                super(4);
            }
        ...
        }, 1), query.getQuery(), EMPTY_STRING_ARRAY, null);
    ...
    public Cursor query(@NotNull SupportSQLiteQuery query, @Nullable CancellationSignal cancellationSignal) {
        ...
        return SupportSQLiteCompat.Api16Impl.rawQueryWithFactory(sQLiteDatabase, query2, strArr, null, cancellationSignal, new C0833xe1b1f9be(query, 0));
    }
}
