...
public class TransitionSet extends Transition {
    ...
    public TransitionSet setOrdering(int i) {
        if (i != 0) {
            if (i == 1) {
                ...
                throw new AndroidRuntimeException(AbstractC0362x4440ab85.m2929x9738a56c(i, "Invalid parameter for TransitionSet ordering: "));
            }
        } else {
            this.mPlayTogether = true;
        }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            StringBuilder m2943xc20437a5 = AbstractC0362x4440ab85.m2943xc20437a5(transition, "\n");
            m2943xc20437a5.append(this.mTransitions.get(i).toString(str + "  "));
            transition = m2943xc20437a5.toString();
        }
        return transition;
    }
    ...
    public Transition mo833clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo833clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo833clone());
        }
