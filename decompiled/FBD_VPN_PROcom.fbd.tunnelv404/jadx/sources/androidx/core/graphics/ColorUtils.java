...
public final class ColorUtils {
    ...
    public static void LABToXYZ(@FloatRange(from = 0.0d, to = 100.0d) double d, @FloatRange(from = -128.0d, to = 127.0d) double d2, @FloatRange(from = -128.0d, to = 127.0d) double d3, double[] dArr) {
        double d4;
    ...
    public static void RGBToHSL(@IntRange(from = 0, to = 255) int i, @IntRange(from = 0, to = 255) int i2, @IntRange(from = 0, to = 255) int i3, float[] fArr) {
        float f;
        float abs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = 0, to = 255) int i, @IntRange(from = 0, to = 255) int i2, @IntRange(from = 0, to = 255) int i3, double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = 0, to = 255) int i, @IntRange(from = 0, to = 255) int i2, @IntRange(from = 0, to = 255) int i3, double[] dArr) {
        double pow;
        double pow2;
        double pow3;
        if (dArr.length == 3) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, to = 95.047d) double d, @FloatRange(from = 0.0d, to = 100.0d) double d2, @FloatRange(from = 0.0d, to = 108.883d) double d3, double[] dArr) {
        if (dArr.length == 3) {
    ...
    public static void blendHSL(float[] fArr, float[] fArr2, @FloatRange(from = 0.0d, to = 1.0d) float f, float[] fArr3) {
        if (fArr3.length == 3) {
            float f2 = 1.0f - f;
    ...
    public static void blendLAB(double[] dArr, double[] dArr2, @FloatRange(from = 0.0d, to = 1.0d) double d, double[] dArr3) {
        if (dArr3.length == 3) {
            double d2 = 1.0d - d;
    ...
    public static void colorToM3HCT(@ColorInt int i, @Size(3) float[] fArr) {
