...
public final class DrawableKt {
    @NotNull
    public static final Bitmap toBitmap(@NotNull Drawable drawable, @Px int i, @Px int i2, @Nullable Bitmap.Config config2) {
    ...
    public static /* synthetic */ Bitmap toBitmap$default(Drawable drawable, int i, int i2, Bitmap.Config config2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        return toBitmap(drawable, i, i2, config2);
    }

    @Nullable
    public static final Bitmap toBitmapOrNull(@NotNull Drawable drawable, @Px int i, @Px int i2, @Nullable Bitmap.Config config2) {
    ...
    public static /* synthetic */ Bitmap toBitmapOrNull$default(Drawable drawable, int i, int i2, Bitmap.Config config2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = drawable.getIntrinsicWidth();
        }
        if ((i3 & 2) != 0) {
        ...
        return toBitmapOrNull(drawable, i, i2, config2);
    }
