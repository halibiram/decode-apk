...
public final class LinkifyCompat {
    ...
    private static final Comparator<LinkSpec> COMPARATOR = new Object();
    ...
    private static String makeUrl(String str, String[] strArr, Matcher matcher, Linkify.TransformFilter transformFilter) {
            ...
            if (i < length) {
                ...
                if (str.regionMatches(true, 0, str2, 0, str2.length())) {
                    ...
                    if (!str.regionMatches(false, 0, str2, 0, str2.length())) {
                        ...
                        m3341xc20437a5.append(str.substring(str2.length()));
        ...
        if (!z && strArr.length > 0) {
            return AbstractC0362x4440ab85.m2936xd2bcb0cf(new StringBuilder(), strArr[0], str);
        }
        return str;
    }
