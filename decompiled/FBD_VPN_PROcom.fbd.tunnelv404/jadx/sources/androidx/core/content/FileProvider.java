...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                throw new IllegalArgumentException(AbstractC0362x4440ab85.m2952x5ac5058d("Failed to find configured root that contains ", canonicalPath));
            } catch (IOException unused) {
    ...
    public static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, ProviderInfo providerInfo, int i) {
        ...
        throw new IllegalArgumentException(AbstractC0362x4440ab85.m2952x5ac5058d("Couldn't find meta-data for provider with authority ", str));
    }
    ...
    private static int modeToMode(String str) {
        ...
        if (!"w".equals(str) && !"wt".equals(str)) {
            ...
            throw new IllegalArgumentException(AbstractC0362x4440ab85.m2952x5ac5058d("Invalid mode: ", str));
        }
        return 738197504;
    }
