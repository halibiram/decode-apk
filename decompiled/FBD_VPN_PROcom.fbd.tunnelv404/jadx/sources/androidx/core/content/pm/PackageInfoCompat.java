        ...
        for (byte[] bArr2 : keySet) {
            if (bArr2 != null) {
                ...
                if (num != null) {
                    ...
                    throw new IllegalArgumentException(AbstractC0362x4440ab85.m2952x5ac5058d("Type must be specified for cert when verifying ", str));
                }
            } else {
                throw new IllegalArgumentException(AbstractC0362x4440ab85.m2952x5ac5058d("Cert byte array cannot be null when verifying ", str));
            }
        }
