...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public String toString() {
            ...
            sb.append(this.id);
            sb.append(", tag:");
            return AbstractC0362x4440ab85.m2936xd2bcb0cf(sb, this.tag, "]");
        }
    }
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                ...
                if (!collection.contains(Api26Impl.getId(m3562x3271d0aa)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(m3562x3271d0aa)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(m3562x3271d0aa));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (i >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup m3564x75d576dc = AbstractC1005xc1f7307f.m3564x75d576dc(it.next());
                if (Api26Impl.getId(m3564x75d576dc).equals(str)) {
                    return m3564x75d576dc;
                }
            }
        }
        return null;
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(m3564x75d576dc));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(m3564x75d576dc, notificationChannels));
                    }
                }
                return arrayList;
            }
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(AbstractC1005xc1f7307f.m3562x3271d0aa(it.next())));
                }
                return arrayList;
            }
        }
