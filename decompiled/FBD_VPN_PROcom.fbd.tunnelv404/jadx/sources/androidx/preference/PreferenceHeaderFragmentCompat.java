...
public abstract class PreferenceHeaderFragmentCompat extends Fragment implements PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
    ...
    public static final void m646onViewCreated$lambda10(PreferenceHeaderFragmentCompat this$0) {
        boolean z;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (childFragmentManager.findFragmentById(i) == null) {
            ...
            Intrinsics.checkNotNullExpressionValue(beginTransaction, "beginTransaction()");
            beginTransaction.setReorderingAllowed(true);
            beginTransaction.add(i, onCreatePreferenceHeader);
            beginTransaction.commit();
        }
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getChildFragmentManager().addOnBackStackChangedListener(new FragmentManager.OnBackStackChangedListener() { // from class: 딹땰뒼땹땁딻딜땨돼듨돼땟뎸땋뒝뒾둥듬듬돠두땡돷돠딄딌듰돵딄돝딐뒵딻땔뎬땯뎻딁땟땬둣득듻땫뒋땯땳듸뎹됴딅뒨뒝땥듟딝듽듸땦땤땠돠땟딤돷돷딄땦듰땱듐두뒙뎸된듐됨뒀딟드둬땠둠땵돤딀딞둑뒹뒨둬돨됐든땪땻딜뒼땧땥딹딃딀뎹뒐돴땻듽뎽듟땃땬뒉듸듟득돼디땰돤뒾딸딐딤뒀딁될딄둣뒝
            @Override // androidx.fragment.app.FragmentManager.OnBackStackChangedListener
            public final void onBackStackChanged() {
                PreferenceHeaderFragmentCompat.m646onViewCreated$lambda10(PreferenceHeaderFragmentCompat.this);
            }
        });
