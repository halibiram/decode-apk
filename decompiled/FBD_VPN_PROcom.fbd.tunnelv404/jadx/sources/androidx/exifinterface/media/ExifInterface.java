...
public class ExifInterface {
    ...
    public static class ExifAttribute {
        ...
        public String toString() {
            ...
            return AbstractC0362x4440ab85.m2935x1db10c9d(sb, ")", this.bytes.length);
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:32:0x011d A[LOOP:0: B:9:0x0024->B:32:0x011d, LOOP_END] */
    ...
    */
                                                        ...
                                                        switch (readByte3) {
                                                            ...
                                                            case -53:
                                                                ...
                                                                if (i2 != 4) {
                                                                    ...
                                                                    str = TAG_THUMBNAIL_IMAGE_LENGTH;
                                                                }
                                                                hashMap.put(str, ExifAttribute.createULong(byteOrderedDataInputStream.readUnsignedShort(), this.mExifByteOrder));
                                                                HashMap<String, ExifAttribute> hashMap2 = this.mAttributes[i2];
                                                                if (i2 != 4) {
                                                                    str2 = TAG_IMAGE_WIDTH;
                                                                } else {
                                                                    str2 = TAG_THUMBNAIL_IMAGE_WIDTH;
                                                                }
                                                                hashMap2.put(str2, ExifAttribute.createULong(byteOrderedDataInputStream.readUnsignedShort(), this.mExifByteOrder));
    ...
    private void parseTiffHeaders(ByteOrderedDataInputStream byteOrderedDataInputStream) {
        ...
        throw new IOException(AbstractC0362x4440ab85.m2929x9738a56c(readInt, "Invalid first Ifd offset: "));
    }
    ...
    */
    private void readImageFileDirectory(SeekableByteOrderedDataInputStream seekableByteOrderedDataInputStream, int i) {
            ...
            if (exifTag != null && readUnsignedShort3 > 0) {
                if (readUnsignedShort3 < IFD_FORMAT_BYTES_PER_FORMAT.length) {
                    if (!exifTag.isFormatCompatible(readUnsignedShort3)) {
                        if (z3) {
                            String str2 = IFD_FORMAT_NAMES[readUnsignedShort3];
                        }
                    } else {
                        ...
                        z = z3;
                        long j5 = r9[readUnsignedShort3] * readInt;
                        ...
                        if (z2) {
                            ...
                            if (num != null) {
                                if (readUnsignedShort3 != 3) {
                                    ...
                                    j4 = j3;
                                    if (!z) {
                                        String.format("Offset: %d, tagName: %s", Long.valueOf(j4), exifTag.name);
                                    }
                                    if (j4 <= 0 && (seekableByteOrderedDataInputStream.length() == -1 || j4 < seekableByteOrderedDataInputStream.length())) {
                                        ...
                                        new StringBuilder("Skip jump into the IFD since its offset is invalid: ").append(j4);
        ...
        long j6 = readInt3;
        if (j6 > 0 && !this.mAttributesOffsets.contains(Integer.valueOf(readInt3))) {
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) {
        ...
        if (i7 != 4) {
            ...
            throw new IllegalStateException(AbstractC0749x8313616e.m3330x95f25580(i4, "Size of exif data (", " bytes) exceeds the max size of a JPEG APP1 segment (65536 bytes)"));
        }
    ...
    */
        ...
        if (l != null) {
            if (l.longValue() >= 0) {
                ...
                for (int length = l2.length(); length < 3; length++) {
                    l2 = AbstractC0362x4440ab85.m2952x5ac5058d("0", l2);
                }
        ...
        public void skipFully(int i) {
            ...
            while (i2 < i) {
                ...
                if (skip <= 0) {
                    ...
                    if (skip == -1) {
                        throw new EOFException(AbstractC0749x8313616e.m3330x95f25580(i, "Reached EOF while skipping ", " bytes."));
                    }
                }
                i2 += skip;
            }
    ...
    public double[] getLatLong() {
        ...
        try {
            ...
            StringBuilder m2944x4440ab85 = AbstractC0362x4440ab85.m2944x4440ab85("latValue=", attribute, ", latRef=", attribute2, ", lngValue=");
            m2944x4440ab85.append(attribute3);
            m2944x4440ab85.append(", lngRef=");
            m2944x4440ab85.append(attribute4);
            return null;
        }
    }
