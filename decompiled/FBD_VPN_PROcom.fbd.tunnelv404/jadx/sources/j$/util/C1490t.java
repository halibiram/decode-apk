...
public class C1490t implements java.util.Map, Serializable, Map {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C1490t(java.util.Map map) {
        map.getClass();
        this.a = map;
    }
    ...
    public final java.util.Set entrySet() {
        if (this.c == null) {
            this.c = new C1355m(this.a.entrySet());
        }
        return this.c;
    }
    ...
    public final Object getOrDefault(Object obj, Object obj2) {
        return AbstractC1344b.t(this.a, obj, obj2);
    }
