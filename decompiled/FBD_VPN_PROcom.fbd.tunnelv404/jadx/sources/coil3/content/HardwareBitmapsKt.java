...
import defpackage.C0882x4b6137d;
import defpackage.C0926x623fbac5;
...
@Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u0019\u0010\u0003\u001a\u00020\u00022\b\u0010\u0001\u001a\u0004\u0018\u00010\u0000H\u0000¢\u0006\u0004\b\u0003\u0010\u0004¨\u0006\u0005"}, d2 = {"Lcoil3/util/Logger;", "logger", "Lcoil3/util/HardwareBitmapService;", "HardwareBitmapService", "(Lcoil3/util/Logger;)Lcoil3/util/HardwareBitmapService;", "coil-core_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
/* loaded from: classes.dex */
public final class HardwareBitmapsKt {

    /* renamed from: 뎠둠땪듼뎠딅땲둔듽됫딞돰둡딞듼뎨뎨듔땡딝땨땃땀뒻딤딹돝되땳땲딸뒾뎨땱땥돶뒛뒷들뒨땋돠뎡둔된돤든됫딹돳돴돛땍땸뒵둑돳땨땝득땮땠땨딀딄뒨뒀땀땋듽됫딹땵딨뒵듸땵뎬뒻돤땨두듰땫땻뒋돶두땣뎡뎡듐땫땰뒉뎹땩땱둑딄돳듸뒤뎻땮딜땻됨뎸뒼딃됫돸땮땮돨뒨땡땲딨돷되땋둘돠땪뒷뒙땅뎸, reason: contains not printable characters */
    public static final boolean f885xfbe0c504;
    ...
    static {
        ...
        if (i != 26) {
            ...
            if (str2 != null) {
                if (AbstractC1197x89633db9.startsWith$default(StringsKt__StringsKt.removePrefix(str2, (CharSequence) "SAMSUNG-"), "SM-", false, 2, null)) {
                    z = true;
                } else {
    ...
    public static final HardwareBitmapService HardwareBitmapService(@Nullable Logger logger) {
        int i = Build.VERSION.SDK_INT;
        if (i >= 26 && !f885xfbe0c504) {
            if (i != 26 && i != 27) {
                return new C0882x4b6137d(true);
            }
            return new C0926x623fbac5(logger);
        }
        return new C0882x4b6137d(false);
    }
}
