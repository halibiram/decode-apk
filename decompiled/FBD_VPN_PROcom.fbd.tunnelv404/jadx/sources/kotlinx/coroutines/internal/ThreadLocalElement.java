...
public final class ThreadLocalElement<T> implements ThreadContextElement<T> {
    ...
    public void restoreThreadContext(@NotNull CoroutineContext context, T oldState) {
        this.f2424x3271d0aa.set(oldState);
    }

    @NotNull
    public String toString() {
        return "ThreadLocal(value=" + this.f2423xfbe0c504 + ", threadLocal = " + this.f2424x3271d0aa + ')';
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.ThreadContextElement
    public T updateThreadContext(@NotNull CoroutineContext context) {
        ThreadLocal threadLocal = this.f2424x3271d0aa;
        T t = (T) threadLocal.get();
        threadLocal.set(this.f2423xfbe0c504);
        return t;
    }
}
