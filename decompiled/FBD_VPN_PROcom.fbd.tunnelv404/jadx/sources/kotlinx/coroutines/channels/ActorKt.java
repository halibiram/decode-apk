...
import defpackage.C0392x4aa4fbad;
...
public final class ActorKt {
    ...
    public static final <E> SendChannel<E> actor(@NotNull CoroutineScope coroutineScope, @NotNull CoroutineContext coroutineContext, int i, @NotNull CoroutineStart coroutineStart, @Nullable Function1<? super Throwable, Unit> function1, @NotNull Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        C0392x4aa4fbad c0392x4aa4fbad;
        CoroutineContext newCoroutineContext = CoroutineContextKt.newCoroutineContext(coroutineScope, coroutineContext);
        Channel Channel$default = ChannelKt.Channel$default(i, null, null, 6, null);
        if (coroutineStart.isLazy()) {
            c0392x4aa4fbad = new C0392x4aa4fbad(newCoroutineContext, Channel$default, false);
            c0392x4aa4fbad.f5058x9738a56c = IntrinsicsKt__IntrinsicsJvmKt.createCoroutineUnintercepted(function2, c0392x4aa4fbad, c0392x4aa4fbad);
        } else {
            c0392x4aa4fbad = new C0392x4aa4fbad(newCoroutineContext, Channel$default, true);
        }
        if (function1 != null) {
            c0392x4aa4fbad.invokeOnCompletion(function1);
        }
        c0392x4aa4fbad.start(coroutineStart, c0392x4aa4fbad, function2);
        return c0392x4aa4fbad;
    }
