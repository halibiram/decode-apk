...
public final class SupervisorKt {
    ...
    public static final <R> Object supervisorScope(@NotNull Function2<? super CoroutineScope, ? super Continuation<? super R>, ? extends Object> function2, @NotNull Continuation<? super R> continuation) {
        C0747x97189ced c0747x97189ced = new C0747x97189ced(continuation.getContext(), continuation, 1);
    ...
    public static /* synthetic */ Job m2248SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return SupervisorJob(job);
