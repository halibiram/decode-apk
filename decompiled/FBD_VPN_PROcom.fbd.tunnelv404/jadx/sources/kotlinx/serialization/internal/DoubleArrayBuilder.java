...
public final class DoubleArrayBuilder extends PrimitiveArrayBuilder<double[]> {
    ...
    public DoubleArrayBuilder(@NotNull double[] bufferWithData) {
        ...
        this.f2572xfbe0c504 = bufferWithData;
    ...
    public final void append$kotlinx_serialization_core(double c) {
        ...
        double[] dArr = this.f2572xfbe0c504;
    ...
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        ...
        if (dArr.length < requiredCapacity) {
            double[] copyOf = Arrays.copyOf(dArr, AbstractC0296x1378447b.coerceAtLeast(requiredCapacity, dArr.length * 2));
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
            this.f2572xfbe0c504 = copyOf;
        }
    }
    ...
    public double[] build$kotlinx_serialization_core() {
        double[] copyOf = Arrays.copyOf(this.f2572xfbe0c504, getPosition());
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
        return copyOf;
    }
}
