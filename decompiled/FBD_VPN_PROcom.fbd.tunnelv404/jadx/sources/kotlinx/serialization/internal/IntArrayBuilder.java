...
public final class IntArrayBuilder extends PrimitiveArrayBuilder<int[]> {
    ...
    public IntArrayBuilder(@NotNull int[] bufferWithData) {
        ...
        this.f2593xfbe0c504 = bufferWithData;
    ...
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        ...
        if (iArr.length < requiredCapacity) {
            int[] copyOf = Arrays.copyOf(iArr, AbstractC0296x1378447b.coerceAtLeast(requiredCapacity, iArr.length * 2));
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
            this.f2593xfbe0c504 = copyOf;
        }
    }
    ...
    public int[] build$kotlinx_serialization_core() {
        int[] copyOf = Arrays.copyOf(this.f2593xfbe0c504, getPosition());
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
        return copyOf;
    }
}
