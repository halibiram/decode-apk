...
public final class BooleanArrayBuilder extends PrimitiveArrayBuilder<boolean[]> {
    ...
    public BooleanArrayBuilder(@NotNull boolean[] bufferWithData) {
        ...
        this.f2558xfbe0c504 = bufferWithData;
    ...
    public final void append$kotlinx_serialization_core(boolean c) {
        ...
        boolean[] zArr = this.f2558xfbe0c504;
    ...
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        ...
        if (zArr.length < requiredCapacity) {
            boolean[] copyOf = Arrays.copyOf(zArr, AbstractC0296x1378447b.coerceAtLeast(requiredCapacity, zArr.length * 2));
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
            this.f2558xfbe0c504 = copyOf;
        }
    }
    ...
    public boolean[] build$kotlinx_serialization_core() {
        boolean[] copyOf = Arrays.copyOf(this.f2558xfbe0c504, getPosition());
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
        return copyOf;
    }
}
