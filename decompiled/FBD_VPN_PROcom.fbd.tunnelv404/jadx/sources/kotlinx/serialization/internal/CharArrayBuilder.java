...
public final class CharArrayBuilder extends PrimitiveArrayBuilder<char[]> {
    ...
    public CharArrayBuilder(@NotNull char[] bufferWithData) {
        ...
        this.f2565xfbe0c504 = bufferWithData;
    ...
    public void ensureCapacity$kotlinx_serialization_core(int requiredCapacity) {
        ...
        if (cArr.length < requiredCapacity) {
            char[] copyOf = Arrays.copyOf(cArr, AbstractC0296x1378447b.coerceAtLeast(requiredCapacity, cArr.length * 2));
            Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
            this.f2565xfbe0c504 = copyOf;
        }
    }
    ...
    public char[] build$kotlinx_serialization_core() {
        char[] copyOf = Arrays.copyOf(this.f2565xfbe0c504, getPosition());
        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(...)");
        return copyOf;
    }
}
