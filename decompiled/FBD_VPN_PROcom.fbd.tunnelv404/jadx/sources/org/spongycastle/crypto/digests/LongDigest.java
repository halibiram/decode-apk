...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    public void processBlock() {
        ...
        while (i3 < 10) {
            ...
            long[] jArr3 = K;
            int i4 = i2 + 1;
            long j17 = Sum1 + jArr3[i2] + this.W[i2] + j13;
            long j18 = j9 + j17;
            long Sum0 = Sum0(j14) + Maj(j14, j10, j11) + j17;
            int i5 = i2 + 2;
            long Sum12 = Sum1(j18) + Ch(j18, j16, j8) + jArr3[i4] + this.W[i4] + j15;
            long j19 = j11 + Sum12;
            long j20 = j14;
            long Sum02 = Sum0(Sum0) + Maj(Sum0, j14, j10) + Sum12;
            int i6 = i2 + 3;
            long Sum13 = Sum1(j19) + Ch(j19, j18, j16) + jArr3[i5] + this.W[i5] + j8;
            long j21 = j10 + Sum13;
            long Sum03 = Sum0(Sum02) + Maj(Sum02, Sum0, j20) + Sum13;
            int i7 = i2 + 4;
            long Sum14 = Sum1(j21) + Ch(j21, j19, j18) + jArr3[i6] + this.W[i6] + j16;
            long j22 = j20 + Sum14;
            long Sum04 = Sum0(Sum03) + Maj(Sum03, Sum02, Sum0) + Sum14;
            int i8 = i2 + 5;
            long Sum15 = Sum1(j22) + Ch(j22, j21, j19) + jArr3[i7] + this.W[i7] + j18;
            long j23 = Sum0 + Sum15;
            long Sum05 = Sum0(Sum04) + Maj(Sum04, Sum03, Sum02) + Sum15;
            int i9 = i2 + 6;
            long Sum16 = Sum1(j23) + Ch(j23, j22, j21) + jArr3[i8] + this.W[i8] + j19;
            long j24 = Sum02 + Sum16;
            long Sum06 = Sum0(Sum05) + Maj(Sum05, Sum04, Sum03) + Sum16;
            int i10 = i2 + 7;
            long Sum17 = Sum1(j24) + Ch(j24, j23, j22) + jArr3[i9] + this.W[i9] + j21;
            long j25 = Sum03 + Sum17;
            long Sum07 = Sum0(Sum06) + Maj(Sum06, Sum05, Sum04) + Sum17;
            i2 += 8;
            long Sum18 = Sum1(j25) + Ch(j25, j24, j23) + jArr3[i10] + this.W[i10] + j22;
