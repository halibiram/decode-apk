...
public final class CipherSource implements Source {
    ...
    public void close() {
        this.f3586x9e171bf9 = true;
        this.f3581xfbe0c504.close();
    }
    ...
    public long read(@NotNull Buffer sink, long byteCount) {
        ...
        if (byteCount >= 0) {
            if (!this.f3586x9e171bf9) {
                if (byteCount == 0) {
                    return 0L;
                }
                while (true) {
                    buffer = this.f3584x75d576dc;
                    if (buffer.size() != 0 || this.f3585x9738a56c) {
                        break;
                    }
                    BufferedSource bufferedSource = this.f3581xfbe0c504;
                    boolean exhausted = bufferedSource.exhausted();
                    Cipher cipher = this.cipher;
                    if (exhausted) {
                        this.f3585x9738a56c = true;
    ...
    public Timeout getF3649xfbe0c504() {
        return this.f3581xfbe0c504.getF3649xfbe0c504();
    }
}
