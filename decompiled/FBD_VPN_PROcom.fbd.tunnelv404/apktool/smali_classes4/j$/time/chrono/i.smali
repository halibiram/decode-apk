...
.method public static d(Lj$/time/chrono/k;Lj$/time/chrono/k;)I
    ...
    invoke-virtual {v1}, Lj$/time/l;->H()I
    ...
    .line 583
    invoke-interface {p0}, Lj$/time/chrono/k;->q()Lj$/time/z;

    move-result-object v0

    invoke-virtual {v0}, Lj$/time/z;->i()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p1}, Lj$/time/chrono/k;->q()Lj$/time/z;

    move-result-object v1

    invoke-virtual {v1}, Lj$/time/z;->i()Ljava/lang/String;
...
.method public static e(Lj$/time/chrono/k;Lj$/time/temporal/q;)I
    ...
    .line 203
    :cond_0
    invoke-interface {p0}, Lj$/time/chrono/k;->g()Lj$/time/A;

    move-result-object p0

    invoke-virtual {p0}, Lj$/time/A;->I()I
...
.method public static n(Lj$/time/chrono/e;Lj$/time/A;)J
    .locals 4
...
.method public static o(Lj$/time/chrono/k;)J
    ...
    invoke-virtual {v2}, Lj$/time/l;->T()I
