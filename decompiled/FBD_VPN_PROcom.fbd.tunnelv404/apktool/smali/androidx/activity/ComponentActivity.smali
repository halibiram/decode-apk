...
.method public constructor <init>()V
    ...
    new-instance v2, L둠딤돝뎽땃뒷땱뒘딠뒤듽둡됨돶뒀뎬된둠딀뒐돠뒛뒷드듐돤땰뎠뒹될땡땱땤뒨땹듔땜딻듐딄딨뎹디땟땳돵딝됫돴땃딌드땭듨듸뒉딝둡돶땁땐됩땣땭됨땰땨뒐듼뒙땵돝땤둣땻둑돷땸딸득돴돠땤딃땳득땪딞딤땁되두뒘땁듽도돰뎠듽된땵땅둬됐땠딅땩뒙돵돠둘뎽돛듼딎듔둥듽듸딄됴땵딽돶땪뎽뒹둣되듬;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, L둠딤돝뎽땃뒷땱뒘딠뒤듽둡됨돶뒀뎬된둠딀뒐돠뒛뒷드듐돤땰뎠뒹될땡땱땤뒨땹듔땜딻듐딄딨뎹디땟땳돵딝됫돴땃딌드땭듨듸뒉딝둡돶땁땐됩땣땭됨땰땨뒐듼뒙땵돝땤둣땻둑돷땸딸득돴돠땤딃땳득땪딞딤땁되두뒘땁듽도돰뎠듽된땵땅둬됐땠딅땩뒙돵돠둘뎽돛듼딎듔둥듽듸딄됴땵딽돶땪뎽뒹둣되듬;-><init>(Landroidx/activity/ComponentActivity;I)V
...
.method private final addObserverForBackInvoker(Landroidx/activity/OnBackPressedDispatcher;)V
    ...
    .line 5
    new-instance v1, L둡됫뎠듼땔딎뒷뎨두딄땳돤돰뒛뎻돷딀뎠딄둠될듽딹뒵땋딎뒘디땨땰땥땣둘뎰디뒵둘됩돵땧뒉되뒬둔딄땔될뒝땨땟땲돝뒐뎻땸두뒘땪듟뒹듐둑돠땁둬돵땩땅둥뎠딄땵땝뒬땳듔됫딝돼돛뎡뎻뎰딝딸듽땬돶땭뎽딝딠둠뒾돝둑딝뒛땣돵된됫뎸돷땜두땳땪딃뒨땸땰돵딻돰딀뎠뎠듟땹돛둣딝됐뒻뒼땹뒉듻돛;
    ...
    .line 8
    invoke-direct {v1, p1, p0, v2}, L둡됫뎠듼땔딎뒷뎨두딄땳돤돰뒛뎻돷딀뎠딄둠될듽딹뒵땋딎뒘디땨땰땥땣둘뎰디뒵둘됩돵땧뒉되뒬둔딄땔될뒝땨땟땲돝뒐뎻땸두뒘땪듟뒹듐둑돠땁둬돵땩땅둥뎠딄땵땝뒬땳듔됫딝돼돛뎡뎻뎰딝딸듽땬돶땭뎽딝딠둠뒾돝둑딝뒛땣돵된됫뎸돷땜두땳땪딃뒨땸땰돵딻돰딀뎠뎠듟땹돛둣딝됐뒻뒼땹뒉듻돛;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public static synthetic 뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫(Landroidx/activity/ComponentActivity;Landroid/content/Context;)V
    .locals 0
...
.method public static synthetic 뎠땄뒐돸듌돛뒐뒀듸딐딃땁듔뎡듌딀둬뒀되땳땳뒤뒼둠땮땄땤두땍뎻땧딻도듼뒬땡뒀듻딠돷뎸둑돵둬딹땐됫땅뎡딟될땯땔땋딟땳딃돳뒝디뒨듟돶딜땳딟땄뒀돝땮도도딄땯듰땮뎡뎡듟듻땄뒀뒻땭둑듨들들땸듟되둬뒝돰듔됩딨듌딜듻돝드뒾둑뎡듰땅딃딤땅뒨뒈뒹될듸돵둘뒐땭땁듸땮뒉땪딟든땻땱듻뒉(Landroidx/activity/ComponentActivity;)V
    .locals 0
...
.method public static synthetic 뎠땻땝뎹딽두딽둠땅땫땵뒈뒾땍뒤되뒵둠땯됫둡땁도뎹뎠땦뎽듽뒛땄땤딃돶땩딝딎듸딅뎬둑땀땝딻두뒘뒛돵땋듼둘듼땄딄돛딎딄돴딐뒐딝돠뎰땃뒘돸딨땟딐됨뒬둔땬따땹뎹뎽딽돼딤땠땣뒤됴됨든땵땻뒀뒝돰돸듬땮뎠뒀돷돵땍듐디듐듻땩득듻돴딜땋뒛땸돸딁딁땜땰땨땫뒼땔뒼둬됴땸뒋둬땥딠뒾땪됨(Landroidx/activity/ComponentActivity;Landroidx/lifecycle/LifecycleOwner;Landroidx/lifecycle/Lifecycle$Event;)V
    .locals 0
...
.method public static synthetic 뎡디돳듬딁됫땥뒾땥딌딨따땍뒛땐든딜뒋돵돷땹뒘땦됐땔딄둘땯땧두땔땭된돵뒾뒹땟딠땪뒹도뒐돤돵듌땦둠돵돴땫둥듔듻딄딽뎠뎸땀땱득땯뎰두뒹디땅들뒀뒙딽뎡됫딞뒻듟딠뒾뒛딟듬득땬딌돨땳뒼딅뒷듰듽돶두뎨돰뎬돨딞뒐뒹딃드딁듌땫뒝땹땧됩땜딻됨땡드딐딨돤딌땨뒈뒼따딽뒹뎰딐뒷뒝딟땲뒨(Landroidx/activity/ComponentActivity;Landroidx/lifecycle/LifecycleOwner;Landroidx/lifecycle/Lifecycle$Event;)V
    .locals 0
...
.method public static synthetic 뎡딞득땤뒀땝딹땮뒀딝땰듼뎽뒤뎽듸딃됴땰딌돼뒷딠듰뎰딀둬듔뒤둣땭땥딻둘뎨땯딽뒻딀뒋뎰땔득뒀둣땳땹뒼땄땠득딜돴땄뒬땟뒻돶땮뒉딌뒬뒙듼따딅듽뒤돸듌땨땯디뎽될딁돳둥돨딐둣둘돴뒨듽딹도땐땐뎡딽땟듸돝뎽따땯둣되땄뒉뒉딄듼딁도뎹돤뒼뒉땬땄딸뒵든뒉땨땃땄딨됩도딐득둑듔딽땵뒛돤(Landroidx/activity/ComponentActivity;)Landroid/os/Bundle;
    .locals 0
