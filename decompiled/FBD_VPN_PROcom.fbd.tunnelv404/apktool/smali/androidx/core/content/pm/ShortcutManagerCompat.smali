...
.method public static addDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    .line 48
    :cond_1
    invoke-static {}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎠땄뒐돸듌돛뒐뒀듸딐딃땁듔뎡듌딀둬뒀되땳땳뒤뒼둠땮땄땤두땍뎻땧딻도듼뒬땡뒀듻딠돷뎸둑돵둬딹땐됫땅뎡딟될땯땔땋딟땳딃돳뒝디뒨듟돶딜땳딟땄뒀돝땮도도딄땯듰땮뎡뎡듟듻땄뒀뒻땭둑듨들들땸듟되둬뒝돰듔됩딨듌딜듻돝드뒾둑뎡듰땅딃딤땅뒨뒈뒹될듸돵둘뒐땭땁듸땮뒉땪딟든땻땱듻뒉()Ljava/lang/Class;
    ...
    .line 52
    invoke-static {p0, v3}, L딹뒋둔둔듌들됐두뒛둣땥뒤땃딌돸딻듸땫돛듨도땱뎽땦땧딸딸땀땥듻됴뎹뒹뒛돤듟돠돷딝땱뒉돳됴뒨득뒷듐땥땹땭득됩땃뒤땩뒾뒝디뒀땦딹돼돵됴듔딞될돨땦둘둔둣딽뎸땁딽딃뒾땭돠땐딹땯뒉뎽땅든뎨땜뒹땪될디딀뎽돸땄딐딅땟돴땹돸뎽듐땤땝딻땲딁땻돸땅딟땄딝딤땩땅뒻둘딀둡뎠두땫돴뒷뒉둑;->뎨될듼뒵돸딅딟도딹뒀됩땰둠땐둥돨두뒙땬딸딃땩땣듬땜땫뒤됩땤땃뎹돶뒬도뎻뒵듰됨돼될뎰딎둬딟딅딨땬땧뒉듼되됫딌되딅듻땀뎸도땄돠땠따땄땩둔딄딤두득땔땲딞땰뒾돨뎽딝된땵땭뒉땦딤뒐땵땳듽뒈땻돼딽들땧도뒻둥둡땰딝뒉딸뒛뒝둑듐땤득딝뒘땃따디뎡둥땥되땟땄돛땲둣땰뒋딟땯듟뎡둑뎠(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 56
    invoke-static {v3}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
    ...
    .line 60
    invoke-static {v3, v2}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎬뒐듨땧뒾땹됐따딤뎬딎땔딠돵땩딎딟듌됨듟듔둔땐땋땰땜땪디뒹듬땝땵땵땠뒹둡땡땠둠뒝뒻땦땝뒀뎸뒨돝둥뒋딀된됐땲땄듌딟디두딹듽뒐땦둠드뒷땹땝땠듻땻듸둘뎬돵뒾땭딜돠돼땭뒛돠듼뒉둣땁땯딟딞땀땜땄딃됴딞땣듨땁뎨됫돴됨돨땬됫땄뒛뒹땩땫딀땥뒘됩땱땜딄뒹듸뒾땐둠뒈돰딄땋도딽둡듽(Landroid/content/pm/ShortcutManager;Ljava/util/ArrayList;)Z
...
.method public static createShortcutResultIntent(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Landroid/content/Intent;
    ...
    .line 15
    invoke-static {p0}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
...
.method public static disableShortcuts(Landroid/content/Context;Ljava/util/List;Ljava/lang/CharSequence;)V
    ...
    .line 15
    invoke-static {v0}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
    ...
    .line 19
    invoke-static {v0, p1, p2}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎨돶땰딎땵딃됨드땭두뒹듟땭땧될땤돝땡땟땡득땫땟듌둑듔뒐둔뒨딽땪돵둥뒬돝뒼뒹땻딹둡듔든땐땰땜땠돳땔될땪두땃딄되돸든돵뎬둘땨딀둡땲뎽땬듬딝딃땜뒼됨땤딝돴듽돰듻땲됫듸든둬듰듰듸뒈땳땠뎰딽둬딽뒼딎땃돸돳딠뒷뒛땯듬뎬땅땀되될딅땩땵됨땐땧뎰뎨땥됩뒋됐딟따됐땮뎡돛듰딸뎬뒙돷(Landroid/content/pm/ShortcutManager;Ljava/util/List;Ljava/lang/CharSequence;)V
...
.method public static enableShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    .line 47
    invoke-static {p0, v2}, L딹뒋둔둔듌들됐두뒛둣땥뒤땃딌돸딻듸땫돛듨도땱뎽땦땧딸딸땀땥듻됴뎹뒹뒛돤듟돠돷딝땱뒉돳됴뒨득뒷듐땥땹땭득됩땃뒤땩뒾뒝디뒀땦딹돼돵됴듔딞될돨땦둘둔둣딽뎸땁딽딃뒾땭돠땐딹땯뒉뎽땅든뎨땜뒹땪될디딀뎽돸땄딐딅땟돴땹돸뎽듐땤땝딻땲딁땻돸땅딟땄딝딤땩땅뒻둘딀둡뎠두땫돴뒷뒉둑;->뎨될듼뒵돸딅딟도딹뒀됩땰둠땐둥돨두뒙땬딸딃땩땣듬땜땫뒤됩땤땃뎹돶뒬도뎻뒵듰됨돼될뎰딎둬딟딅딨땬땧뒉듼되됫딌되딅듻땀뎸도땄돠땠따땄땩둔딄딤두득땔땲딞땰뒾돨뎽딝된땵땭뒉땦딤뒐땵땳듽뒈땻돼딽들땧도뒻둥둡땰딝뒉딸뒛뒝둑듐땤득딝뒘땃따디뎡둥땥되땟땄돛땲둣땰뒋딟땯듟뎡둑뎠(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 51
    invoke-static {v2}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
    ...
    .line 55
    invoke-static {v2, v1}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎡땝뒻땥되딤돳뎽딀딅돼땫돛듼뎽뒝됩뒨땣땬뒤땦땜둠딞돰뒘뎸땰될땦듬땭땬두딄딹뎡돠뒝드된땵땱땡딹딸뒛듔뒹디둡딄돸딨돳뒾뒉뎬듸돼돰뒐듬돼둡됐돳둑뒉땟뒀됨뒾땀땥땥돼듬땃된딟딝돵땜딄뒼딞될땄딄딟따땀땄돝될돷딻든땝디땅딹듻돴딐돝둘땄듟도땠딸돤돠땸돳듌뒘뒨든딎딝뒷땧됨딹땣땋(Landroid/content/pm/ShortcutManager;Ljava/util/ArrayList;)V
...
.method public static getDynamicShortcuts(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 46
    invoke-static {v2}, L뒙돝뎡딸됩땵딤딀뒛돷듽돴됨둑둘땵뎸뎹뒐둬딞딁땋듸듔돶딐돰된돨됴둘따땍땄돵딃듰땧딌뎬뒬돷듻뒀뎽둬돳된돸듟뒹뒤뒼뒵딅뒾땹땅듐득뎻딻돰땠돤둡딸돶딐땀땋뎬딃뎻땵땵땧뒹돸딠듽땱돷딎딤땃딞뒻될돶돴됴뒙뒤뒼땨된뒘딹둑땠듐돳뒈땩둥듔땤땔돵뒘땪디돛돤땵듸듰듨땩땮뎡듔땩땡땫딤디딅;->뎡땣땮땻둔땀딨뎸됴뎨땮듽뒼따땠듬돰듟뒉돤뒹딄딟땠돶딜딤듔드돵땃뎹듽딅둔땹듔딽듟뒛듌뎰돛든돼뎨딝돝되딠듟된돶뒋뎸뒉둔되뎬됨뒾될땩딐땀됐듼돛뒛땹딜딄뎨딹듰딜뎨듻땍딠뎸딤뒨땝듰따듐딄딤땯땮딹됨땨땧뒹땧됩땻땬듟뒹뒷돼될땐뎸도돰딨돵듟득뎽뒨듸뒘따뒛뒝뒙땐뎬돵뎰디딜땝됨두(Ljava/lang/Object;)Landroid/content/pm/ShortcutInfo;
...
.method public static pushDynamicShortcut(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Z
    ...
    .line 72
    invoke-static {p0, v1}, L딹뒋둔둔듌들됐두뒛둣땥뒤땃딌돸딻듸땫돛듨도땱뎽땦땧딸딸땀땥듻됴뎹뒹뒛돤듟돠돷딝땱뒉돳됴뒨득뒷듐땥땹땭득됩땃뒤땩뒾뒝디뒀땦딹돼돵됴듔딞될돨땦둘둔둣딽뎸땁딽딃뒾땭돠땐딹땯뒉뎽땅든뎨땜뒹땪될디딀뎽돸땄딐딅땟돴땹돸뎽듐땤땝딻땲딁땻돸땅딟땄딝딤땩땅뒻둘딀둡뎠두땫돴뒷뒉둑;->뎨될듼뒵돸딅딟도딹뒀됩땰둠땐둥돨두뒙땬딸딃땩땣듬땜땫뒤됩땤땃뎹돶뒬도뎻뒵듰됨돼될뎰딎둬딟딅딨땬땧뒉듼되됫딌되딅듻땀뎸도땄돠땠따땄땩둔딄딤두득땔땲딞땰뒾돨뎽딝된땵땭뒉땦딤뒐땵땳듽뒈땻돼딽들땧도뒻둥둡땰딝뒉딸뒛뒝둑듐땤득딝뒘땃따디뎡둥땥되땟땄돛땲둣땰뒋딟땯듟뎡둑뎠(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 76
    invoke-static {v1}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
    ...
    .line 84
    invoke-static {v1, v4}, L땸딀딄땳둘땮땲듼땸딟땔땀뒈딽딃땱땍뎹돵땣땧땲딜돛딐둑딄뎠듌뒾돳뒀듸도뎡딜땭땡뒘딟돝뎠둠땸땵듻땧딜듸뒻뎹됫땍땨디뒻듽딠듸땧땝땣딞땅땟땹든따뒷뎠땻뎬득땱땣든땠뒈뒘뒐듻땡뒙됴둡땄돴돼땵딅땱돴됐땍뒈듼뎬돼땲뒀딌뒙듼딐딻딁드됩뎰땄뎸뒐뒘딽듐뒷땃딸딌땩뒝땱뒝땹듻딟땹땐땳됩;->뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫(Landroid/content/pm/ShortcutManager;Landroid/content/pm/ShortcutInfo;)V
    ...
    .line 133
    invoke-static {v1, v4}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎡땣땮땻둔땀딨뎸됴뎨땮듽뒼따땠듬돰듟뒉돤뒹딄딟땠돶딜딤듔드돵땃뎹듽딅둔땹듔딽듟뒛듌뎰돛든돼뎨딝돝되딠듟된돶뒋뎸뒉둔되뎬됨뒾될땩딐땀됐듼돛뒛땹딜딄뎨딹듰딜뎨듻땍딠뎸딤뒨땝듰따듐딄딤땯땮딹됨땨땧뒹땧됩땻땬듟뒹뒷돼될땐뎸도돰딨돵듟득뎽뒨듸뒘따뒛뒝뒙땐뎬돵뎰디딜땝됨두(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
...
.method public static removeDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    .line 19
    invoke-static {v0, p1}, L땟됴돛딁듨돝땨듐딄땟둥듼딨디뎹두땋딽뎠듻땝뒻도돳도뒐땔된둬됨돰땸딄뒉될땭땃땤땻두된됴두두땥땁땝든뒀땄땮뒤뒝땻뎹땮듽뎰땥땄뒬됩됩뒬땻뒵땍뒈뎡됐땲딝딀딠둬뒻둣둔땔땐땄뒉땩둥듨두돰뒝됩딝딎땫뎬딃듰땰뒝뎰딃땮땝딻듻뒀땣땀딄땔돼돝땠둣돝될됫뎸땮땠듽도딠듨도돼딅됨땜뎬땻든;->뎡땣땮땻둔땀딨뎸됴뎨땮듽뒼따땠듬돰듟뒉돤뒹딄딟땠돶딜딤듔드돵땃뎹듽딅둔땹듔딽듟뒛듌뎰돛든돼뎨딝돝되딠듟된돶뒋뎸뒉둔되뎬됨뒾될땩딐땀됐듼돛뒛땹딜딄뎨딹듰딜뎨듻땍딠뎸딤뒨땝듰따듐딄딤땯땮딹됨땨땧뒹땧됩땻땬듟뒹뒷돼될땐뎸도돰딨돵듟득뎽뒨듸뒘따뒛뒝뒙땐뎬돵뎰디딜땝됨두(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
