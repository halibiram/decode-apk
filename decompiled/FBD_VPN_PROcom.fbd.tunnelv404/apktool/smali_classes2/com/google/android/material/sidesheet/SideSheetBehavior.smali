...
.method private calculateCurrentOffset(ILandroid/view/View;)I
    ...
    .array-data 8
        0xd698229a6ce7355L
        0x7c5d3d197677e764L    # 1.139760073165594E291
        0x37a2874e80579575L    # 1.0634861309831778E-40
        -0x4f7099b42f0bb0a0L    # -8.677510063603773E-75
    .end array-data
.end method
...
.method public static from(Landroid/view/View;)Lcom/google/android/material/sidesheet/SideSheetBehavior;
    ...
    :array_0
    .array-data 8
        -0x2420175880e61feeL    # -3.623836827626201E134
        0x63a5514b7ef927daL    # 1.029781295859998E172
        0x6a1e1c155aa52067L    # 1.4750391092139508E203
        0x65262d179757804eL    # 1.7972703762071604E179
        -0x7f00c1917aacbe0fL    # -7.118840533365293E-304
        0x2da0c58c5c033fb8L    # 6.586696812309442E-89
        -0x26a4ab04756a6f54L
        0x19b3b8c21665c71eL    # 7.252158266336225E-185
    .end array-data
    ...
    :array_1
    .array-data 8
        0x341a9a284ec2cb79L    # 1.0594928466791949E-57
        0x1c99afeeec701435L    # 6.646911637316178E-171
        -0x23b3b6af048ca3e0L    # -4.111929006628075E136
        -0x5005846698fa2bf1L    # -1.4294375408002509E-77
        0x65f2762cbc521e1dL    # 1.2257084812717327E183
        0x269fa3bced62bcb9L
        -0x731c627be7597340L
    .end array-data
.end method
...
.method private getCoplanarFinishAnimatorUpdateListener()Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    .line 24
    new-instance v3, L땟됴땐뒘땅뒷딨들딠땰뎻뒹딐두딌딜뎽땋땍뎻뎽땸딽뒨뒀땯땧돨딌듌뎡뎹땪딀땥뒾돷드드땜땹뒷딄딝듼뒋돳둘딎뒉뒾뒈됐뒝듰뒷땝뎹듨뎠뒀뒈둑뒤듬뎻둘둡둠땡돤땍땤딎땠뎬듰땹땹뒀둬듬뒨됫땔듌땭땻땳돳됩듌땱둣디됴뒝둥땪뒨따땃두듰딌딁딀뎻됴땳드듸뒨둣뒼땍뎸딤딤돼딁딅딃뎽둑듐땳둔딨땋;

    .line 25
    .line 26
    invoke-direct {v3, p0, v2, v1, v0}, L땟됴땐뒘땅뒷딨들딠땰뎻뒹딐두딌딜뎽땋땍뎻뎽땸딽뒨뒀땯땧돨딌듌뎡뎹땪딀땥뒾돷드드땜땹뒷딄딝듼뒋돳둘딎뒉뒾뒈됐뒝듰뒷땝뎹듨뎠뒀뒈둑뒤듬뎻둘둡둠땡돤땍땤딎땠뎬듰땹땹뒀둬듬뒨됫땔듌땭땻땳돳됩듌땱둣디됴뒝둥땪뒨따땃두듰딌딁딀뎻됴땳드듸뒨둣뒼땍뎸딤딤돼딁딅딃뎽둑듐땳둔딨땋;-><init>(Lcom/google/android/material/sidesheet/SideSheetBehavior;Landroid/view/ViewGroup$MarginLayoutParams;ILandroid/view/View;)V
...
.method private setSheetEdge(I)V
    ...
    :array_0
    .array-data 8
        -0x23902b53d0359cabL    # -1.8508658751120132E137
        -0x53be3e256ef4c299L    # -1.662673135434105E-95
        -0x431601336b6827f0L    # -2.886059075036819E-15
        0x7c25d354a18040d8L
        0x78bd5e806a163f0eL    # 3.971983287524299E273
        0x412ff8873b71b72aL    # 1047619.6161019553
    .end array-data

    :array_1
    .array-data 8
        -0x28742fc95f2ced63L    # -5.3510797914701114E113
        -0x16b7af052c30aa2cL    # -1.4541363536964505E199
        0x8e506e42a71b4cL
    .end array-data
    ...
    .array-data 8
        -0x555dc50806f91786L
        -0x4c98c97c63221c86L    # -4.514203626713727E-61
    .end array-data

    :array_3
    .array-data 8
        -0x6f72084d48e53ee6L
        0x2cc3d8f7708d2060L    # 4.757488201659949E-93
    .end array-data
.end method
...
.method public static synthetic 뎠딎딃듼뒉됨뎹땨듻땀딝땦뒬돰돷땩득딞든둣듼돸됐땃둠딜딸뒵들돴듰땃득땋뎠돸딤땀딝뎹딨두땨뒷딎딎딐뒀뎬듰딜땭듔듨돴듼둥득뎹돶들드뎻딁둘됐돨둠뒈땅돨땜딝들딀둑뒹뎹두땬듐돶듬땬도뎸둠둠뒨됐땝딎딀땸땪득뒵땬뒐땰땝뒵땲듬듽돵뒀땋뒬땳뒋듰땟돰되땋둔땱듔땀땣되뒘돼뒻딁둥뒘된땫(Lcom/google/android/material/sidesheet/SideSheetBehavior;I)V
    .locals 0
...
.method public getOuterEdgeOffsetForState(I)I
    ...
    :array_0
    .array-data 8
        0x2ec7b1f64fe611b3L    # 2.439444495072523E-83
        -0x76f237905e7f1b2bL    # -4.618294142372498E-265
        0x7152fbe4397d87d1L    # 7.726151151447534E237
        -0x3f5b6bc2422195cdL    # -2634.120589209045
        -0x124c5e9f3df1f198L    # -2.7718237323769107E220
        -0x3c925f2b83b7b4f7L    # -6.6716870425860168E16
    .end array-data
.end method
...
.method public setState(I)V
    ...
    :array_0
    .array-data 8
        -0x5ecf19f4ec4ae685L    # -8.259866808718903E-149
        -0x6999267d858dd9e3L    # -9.328512537219888E-201
    .end array-data
    ...
    :array_1
    .array-data 8
        -0x7183f66a520ef277L    # -6.727625552589391E-239
        -0x3f36a563762d1192L    # -12981.222956053181
    .end array-data
    ...
    :array_2
    .array-data 8
        -0x16cb60b08aa96d52L    # -6.166154273243166E198
        0x754628419daf7404L    # 8.317296820736139E256
    .end array-data
    ...
    :array_3
    .array-data 8
        -0x4ca623f320952b01L    # -2.5144454381118273E-61
        -0x5404e1a310b49c2eL    # -7.935033404815649E-97
        -0x1fab70076a71791cL    # -1.1027861335402024E156
        -0x5075f611883dca15L    # -1.0980245235280707E-79
        0x455930e29adfac04L    # 1.2181599682212666E26
    .end array-data
.end method
