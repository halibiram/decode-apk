...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/view/View;Lcom/google/android/material/snackbar/ContentViewCallback;)V
    ...
    .line 3
    iput-boolean v1, p0, Lcom/google/android/material/snackbar/BaseTransientBottomBar;->anchorViewLayoutListenerEnabled:Z
    ...
    iput-object v2, p0, Lcom/google/android/material/snackbar/BaseTransientBottomBar;->bottomMarginGestureInsetRunnable:Ljava/lang/Runnable;
    ...
    iput-object v2, p0, Lcom/google/android/material/snackbar/BaseTransientBottomBar;->managerCallback:Lcom/google/android/material/snackbar/SnackbarManager$Callback;
    ...
    :array_0
    .array-data 8
        0x4bcda852f4df205bL    # 1.4544003437269222E57
        -0x3425856a7db3a9f7L    # -2.5970374457951253E57
        0x14046abcf12fcf62L
    .end array-data

    :array_1
    .array-data 8
        -0x2b2f0821759aa8d9L    # -3.711379403575917E100
        0xd13396c986f5700L
        -0x24399fc353b7d7e8L
        0xf06284cb53d9036L    # 2.722153503467072E-236
        -0x202c945b8bc29aa3L    # -4.0685318834135335E153
        0x12e6feeff770a441L
        0x3653399b3615f11aL    # 5.261718247863019E-47
    .end array-data

    :array_2
    .array-data 8
        -0x1eb388d6d571f8f0L    # -5.0024884447172957E160
        -0x242bf60dce3adc1L
        -0x398a6136b5e9e3f5L    # -2.740693421286456E31
        0x490e38cf2747ac73L    # 8.424639182876156E43
        0x309885746ca64903L    # 1.3553289400441961E-74
        0x69af2bca1d3c024bL    # 1.1929949232833686E201
        -0x6e72809e548ac3c2L
    .end array-data

    :array_3
    .array-data 8
        -0x6acaf04dad5c18bdL    # -1.640017421421528E-206
        0x1493da6ae6598db5L
        0x244f72a952b68c2fL    # 8.653335358792793E-134
        -0x4bc522fff14431fdL    # -4.2795677464891203E-57
        0x98056856f70a5fL
        0x5e91d311b3112ee5L    # 3.56118861710205E147
        0x54c9d5494df18977L    # 2.8251787797955464E100
    .end array-data
.end method
...
.method private updateMargins()V
    ...
    :array_0
    .array-data 8
        0x65a54168540e8628L    # 4.4100010299153384E181
        0xbd17f17afb16effL
        0x6327eaa76f7d6d0dL    # 4.513020762857187E169
        -0x231f97756d28e9cfL    # -2.442492865678927E139
        0x19f4d7a95d63e8adL
        0x60aecc1474f10cb9L    # 5.285411456469149E157
        -0x4964b1ba37b2aa09L    # -1.1957346487109506E-45
        0x5681b3d97d1b987cL    # 5.196895352880543E108
        -0x10d47e643a78541fL    # -3.2580568100432253E227
        -0x5cacff3c419d7217L    # -1.595746388433827E-138
        0x6997afc84d29d377L    # 4.532739644339607E200
    .end array-data
    ...
    :array_1
    .array-data 8
        0x2e0805e787b5c922L    # 6.038091114706916E-87
        0xb4f2f227548916eL
        0x3d1e95cf4c4a75bcL    # 2.7165109598770598E-14
        0x58f7e15850a590aaL    # 3.8540489088828517E120
        0x226aba65e88176c7L    # 6.849524762245335E-143
        0x13efb7b8faca6918L
        0x20e2f48b1fcc9bc1L    # 2.895353799411921E-150
        -0x338e8d45e5a2494eL    # -1.7523812238958892E60
        -0x672f05ee2aec595eL    # -3.81030244273811E-189
        -0x6c630d13e2dcde4cL    # -3.359041671814446E-214
    .end array-data
.end method
...
.method public onAttachedToWindow()V
    ...
    .line 19
    invoke-static {v0}, L뎽둣딜땝뒾딀뒋땨딄듸돵뒀땍든땸땹딁딝돛둘땤뎽딨두듟땵뒝땱딹땠딠딹돠땄듟딞돵득둘들땦뒈뒉뒉땰돳뒤땬뒈듰둡땁둡뎸땸됐땵뎽딹되돼땱둬땭딟땠든땰딞득뒤되뒉땐뒹뒬도드뎽뎹땫딐뒻듻뒼딀딸땩둔땹땭땨딽뎹땱딹땡둥땟듸뒷딸돴돛됫둘딀뒨뒀뎰듼땻듼땰뒛된딞딁돤됩돼땨들돼듔땻땃땔땭돰;->뎰돼땰땮땣땅땜될딝딀땰득땩둡따됴뎠뒉뎰땸딜둬땩뒼뒻뒙돰돛돷돝뒉돤딤듸딁땯뎡땰땻땁돷듽듸땜땟딝돰듬디뒛듸땸듼둠땧듨듌뒵뎹뒻든돵될든듌듬돠땣딎뒼듽땠듻딤땱드땰땦득땐뒘땄될땧뒾듨땝디땦든딁딅뒘뒉됐뒋땸땋돛든돷땻돠됫뒼될돳돛땄땃땦드둑땱뒀뒹딌땡딀듐뒀돰땋땨뒼뒉따뎻됩뒻(Landroid/graphics/Insets;)I
...
.method public setAnchorView(I)Lcom/google/android/material/snackbar/BaseTransientBottomBar;
    ...
    :array_0
    .array-data 8
        0x5e991bdfc9c322b7L    # 5.016551719823946E147
        0x5912a46714e6063L
        0x2a1d8a210745c31aL    # 8.049810415070415E-106
        -0x46672331f835bce4L    # -3.06454204169064E-31
        -0xbf1852404674e13L
        -0x298ec69741457e2fL    # -2.5282434516128215E108
    .end array-data
.end method
